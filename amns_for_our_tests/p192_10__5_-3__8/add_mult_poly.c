...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2257021984539646740UL) + ((((uint64_t)op[1] * 5827114865875436080UL) + ((uint64_t)op[2] * 7667584631139487150UL) + ((uint64_t)op[3] * 18052666318422608104UL) + ((uint64_t)op[4] * 12238765475845336765UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 12238765475845336765UL) + ((uint64_t)op[1] * 2257021984539646740UL) + ((((uint64_t)op[2] * 5827114865875436080UL) + ((uint64_t)op[3] * 7667584631139487150UL) + ((uint64_t)op[4] * 18052666318422608104UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 18052666318422608104UL) + ((uint64_t)op[1] * 12238765475845336765UL) + ((uint64_t)op[2] * 2257021984539646740UL) + ((((uint64_t)op[3] * 5827114865875436080UL) + ((uint64_t)op[4] * 7667584631139487150UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 7667584631139487150UL) + ((uint64_t)op[1] * 18052666318422608104UL) + ((uint64_t)op[2] * 12238765475845336765UL) + ((uint64_t)op[3] * 2257021984539646740UL) + ((uint64_t)op[4] * 965399476083243376UL);
	tmp_q[4] = ((uint64_t)op[0] * 5827114865875436080UL) + ((uint64_t)op[1] * 7667584631139487150UL) + ((uint64_t)op[2] * 18052666318422608104UL) + ((uint64_t)op[3] * 12238765475845336765UL) + ((uint64_t)op[4] * 2257021984539646740UL);
