...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10045988444339870179UL) + ((((uint64_t)op[1] * 4733409949146951344UL) + ((uint64_t)op[2] * 6019104280479369534UL) + ((uint64_t)op[3] * 3801435950956238112UL) + ((uint64_t)op[4] * 17823294847365963992UL) + ((uint64_t)op[5] * 15643987463610631353UL) + ((uint64_t)op[6] * 6584717599468945075UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 6584717599468945075UL) + ((uint64_t)op[1] * 10045988444339870179UL) + ((((uint64_t)op[2] * 4733409949146951344UL) + ((uint64_t)op[3] * 6019104280479369534UL) + ((uint64_t)op[4] * 3801435950956238112UL) + ((uint64_t)op[5] * 17823294847365963992UL) + ((uint64_t)op[6] * 15643987463610631353UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 15643987463610631353UL) + ((uint64_t)op[1] * 6584717599468945075UL) + ((uint64_t)op[2] * 10045988444339870179UL) + ((((uint64_t)op[3] * 4733409949146951344UL) + ((uint64_t)op[4] * 6019104280479369534UL) + ((uint64_t)op[5] * 3801435950956238112UL) + ((uint64_t)op[6] * 17823294847365963992UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 17823294847365963992UL) + ((uint64_t)op[1] * 15643987463610631353UL) + ((uint64_t)op[2] * 6584717599468945075UL) + ((uint64_t)op[3] * 10045988444339870179UL) + ((((uint64_t)op[4] * 4733409949146951344UL) + ((uint64_t)op[5] * 6019104280479369534UL) + ((uint64_t)op[6] * 3801435950956238112UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 3801435950956238112UL) + ((uint64_t)op[1] * 17823294847365963992UL) + ((uint64_t)op[2] * 15643987463610631353UL) + ((uint64_t)op[3] * 6584717599468945075UL) + ((uint64_t)op[4] * 10045988444339870179UL) + ((((uint64_t)op[5] * 4733409949146951344UL) + ((uint64_t)op[6] * 6019104280479369534UL)) * 18446744073709551611);
	tmp_q[5] = ((uint64_t)op[0] * 6019104280479369534UL) + ((uint64_t)op[1] * 3801435950956238112UL) + ((uint64_t)op[2] * 17823294847365963992UL) + ((uint64_t)op[3] * 15643987463610631353UL) + ((uint64_t)op[4] * 6584717599468945075UL) + ((uint64_t)op[5] * 10045988444339870179UL) + ((uint64_t)op[6] * 13226438401684346512UL);
	tmp_q[6] = ((uint64_t)op[0] * 4733409949146951344UL) + ((uint64_t)op[1] * 6019104280479369534UL) + ((uint64_t)op[2] * 3801435950956238112UL) + ((uint64_t)op[3] * 17823294847365963992UL) + ((uint64_t)op[4] * 15643987463610631353UL) + ((uint64_t)op[5] * 6584717599468945075UL) + ((uint64_t)op[6] * 10045988444339870179UL);
