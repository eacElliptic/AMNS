...
void init_data(){
	...
	mpz_set_str (modul_p, "74659880179844503606408960884101733344957408294557642653652397950085941886851", 10);

	mpz_set_str (gama_pow[0], "42934166947978576033500269966115346023214935533645195098865695455435467239387", 10);
