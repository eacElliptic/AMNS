...
void init_data(){
	...
	mpz_set_str (modul_p, "5820797693572657917394631942376120321793740475267593917417", 10);

	mpz_set_str (gama_pow[0], "5692164913535807110348724997729577764680767502342016465968", 10);
