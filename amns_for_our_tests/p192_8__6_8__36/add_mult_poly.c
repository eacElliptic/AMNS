...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6946792695687252997UL) + ((((uint64_t)op[1] * 12569413876983351304UL) + ((uint64_t)op[2] * 5249559051471307753UL) + ((uint64_t)op[3] * 6826532954814190826UL) + ((uint64_t)op[4] * 1128185883452418683UL) + ((uint64_t)op[5] * 8192503701286449806UL)) * 8);
	tmp_q[1] = ((uint64_t)op[0] * 8192503701286449806UL) + ((uint64_t)op[1] * 6946792695687252997UL) + ((((uint64_t)op[2] * 12569413876983351304UL) + ((uint64_t)op[3] * 5249559051471307753UL) + ((uint64_t)op[4] * 6826532954814190826UL) + ((uint64_t)op[5] * 1128185883452418683UL)) * 8);
	tmp_q[2] = ((uint64_t)op[0] * 1128185883452418683UL) + ((uint64_t)op[1] * 8192503701286449806UL) + ((uint64_t)op[2] * 6946792695687252997UL) + ((((uint64_t)op[3] * 12569413876983351304UL) + ((uint64_t)op[4] * 5249559051471307753UL) + ((uint64_t)op[5] * 6826532954814190826UL)) * 8);
	tmp_q[3] = ((uint64_t)op[0] * 6826532954814190826UL) + ((uint64_t)op[1] * 1128185883452418683UL) + ((uint64_t)op[2] * 8192503701286449806UL) + ((uint64_t)op[3] * 6946792695687252997UL) + ((((uint64_t)op[4] * 12569413876983351304UL) + ((uint64_t)op[5] * 5249559051471307753UL)) * 8);
	tmp_q[4] = ((uint64_t)op[0] * 5249559051471307753UL) + ((uint64_t)op[1] * 6826532954814190826UL) + ((uint64_t)op[2] * 1128185883452418683UL) + ((uint64_t)op[3] * 8192503701286449806UL) + ((uint64_t)op[4] * 6946792695687252997UL) + ((uint64_t)op[5] * 8321590647319052352UL);
	tmp_q[5] = ((uint64_t)op[0] * 12569413876983351304UL) + ((uint64_t)op[1] * 5249559051471307753UL) + ((uint64_t)op[2] * 6826532954814190826UL) + ((uint64_t)op[3] * 1128185883452418683UL) + ((uint64_t)op[4] * 8192503701286449806UL) + ((uint64_t)op[5] * 6946792695687252997UL);
