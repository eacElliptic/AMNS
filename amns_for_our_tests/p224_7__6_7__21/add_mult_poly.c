...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 5039662094746711911UL) + ((((uint64_t)op[1] * 10986109415375475812UL) + ((uint64_t)op[2] * 16547613509314173759UL) + ((uint64_t)op[3] * 2453682614845333233UL) + ((uint64_t)op[4] * 5072311544865901722UL) + ((uint64_t)op[5] * 15016408498134717160UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 15016408498134717160UL) + ((uint64_t)op[1] * 5039662094746711911UL) + ((((uint64_t)op[2] * 10986109415375475812UL) + ((uint64_t)op[3] * 16547613509314173759UL) + ((uint64_t)op[4] * 2453682614845333233UL) + ((uint64_t)op[5] * 5072311544865901722UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 5072311544865901722UL) + ((uint64_t)op[1] * 15016408498134717160UL) + ((uint64_t)op[2] * 5039662094746711911UL) + ((((uint64_t)op[3] * 10986109415375475812UL) + ((uint64_t)op[4] * 16547613509314173759UL) + ((uint64_t)op[5] * 2453682614845333233UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 2453682614845333233UL) + ((uint64_t)op[1] * 5072311544865901722UL) + ((uint64_t)op[2] * 15016408498134717160UL) + ((uint64_t)op[3] * 5039662094746711911UL) + ((((uint64_t)op[4] * 10986109415375475812UL) + ((uint64_t)op[5] * 16547613509314173759UL)) * 7);
	tmp_q[4] = ((uint64_t)op[0] * 16547613509314173759UL) + ((uint64_t)op[1] * 2453682614845333233UL) + ((uint64_t)op[2] * 5072311544865901722UL) + ((uint64_t)op[3] * 15016408498134717160UL) + ((uint64_t)op[4] * 5039662094746711911UL) + ((uint64_t)op[5] * 3115789612790124220UL);
	tmp_q[5] = ((uint64_t)op[0] * 10986109415375475812UL) + ((uint64_t)op[1] * 16547613509314173759UL) + ((uint64_t)op[2] * 2453682614845333233UL) + ((uint64_t)op[3] * 5072311544865901722UL) + ((uint64_t)op[4] * 15016408498134717160UL) + ((uint64_t)op[5] * 5039662094746711911UL);
