...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15764380364789318012UL) + ((((uint64_t)op[1] * 2799292338058914730UL) + ((uint64_t)op[2] * 8615960799283241125UL) + ((uint64_t)op[3] * 14451809841555972328UL)) * 18446744073709551615);
	tmp_q[1] = ((uint64_t)op[0] * 14451809841555972328UL) + ((uint64_t)op[1] * 15764380364789318012UL) + ((((uint64_t)op[2] * 2799292338058914730UL) + ((uint64_t)op[3] * 8615960799283241125UL)) * 18446744073709551615);
	tmp_q[2] = ((uint64_t)op[0] * 8615960799283241125UL) + ((uint64_t)op[1] * 14451809841555972328UL) + ((uint64_t)op[2] * 15764380364789318012UL) + ((uint64_t)op[3] * 15647451735650636886UL);
	tmp_q[3] = ((uint64_t)op[0] * 2799292338058914730UL) + ((uint64_t)op[1] * 8615960799283241125UL) + ((uint64_t)op[2] * 14451809841555972328UL) + ((uint64_t)op[3] * 15764380364789318012UL);
