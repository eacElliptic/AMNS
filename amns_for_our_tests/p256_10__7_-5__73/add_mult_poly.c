...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3729025387245575658UL) + ((((uint64_t)op[1] * 1766858154768292620UL) + ((uint64_t)op[2] * 7604311160199262103UL) + ((uint64_t)op[3] * 2312767378934400501UL) + ((uint64_t)op[4] * 15870398967219228644UL) + ((uint64_t)op[5] * 7293484046771382890UL) + ((uint64_t)op[6] * 10855793733293822429UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 10855793733293822429UL) + ((uint64_t)op[1] * 3729025387245575658UL) + ((((uint64_t)op[2] * 1766858154768292620UL) + ((uint64_t)op[3] * 7604311160199262103UL) + ((uint64_t)op[4] * 2312767378934400501UL) + ((uint64_t)op[5] * 15870398967219228644UL) + ((uint64_t)op[6] * 7293484046771382890UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 7293484046771382890UL) + ((uint64_t)op[1] * 10855793733293822429UL) + ((uint64_t)op[2] * 3729025387245575658UL) + ((((uint64_t)op[3] * 1766858154768292620UL) + ((uint64_t)op[4] * 7604311160199262103UL) + ((uint64_t)op[5] * 2312767378934400501UL) + ((uint64_t)op[6] * 15870398967219228644UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 15870398967219228644UL) + ((uint64_t)op[1] * 7293484046771382890UL) + ((uint64_t)op[2] * 10855793733293822429UL) + ((uint64_t)op[3] * 3729025387245575658UL) + ((((uint64_t)op[4] * 1766858154768292620UL) + ((uint64_t)op[5] * 7604311160199262103UL) + ((uint64_t)op[6] * 2312767378934400501UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 2312767378934400501UL) + ((uint64_t)op[1] * 15870398967219228644UL) + ((uint64_t)op[2] * 7293484046771382890UL) + ((uint64_t)op[3] * 10855793733293822429UL) + ((uint64_t)op[4] * 3729025387245575658UL) + ((((uint64_t)op[5] * 1766858154768292620UL) + ((uint64_t)op[6] * 7604311160199262103UL)) * 18446744073709551611);
	tmp_q[5] = ((uint64_t)op[0] * 7604311160199262103UL) + ((uint64_t)op[1] * 2312767378934400501UL) + ((uint64_t)op[2] * 15870398967219228644UL) + ((uint64_t)op[3] * 7293484046771382890UL) + ((uint64_t)op[4] * 10855793733293822429UL) + ((uint64_t)op[5] * 3729025387245575658UL) + ((uint64_t)op[6] * 9612453299868088516UL);
	tmp_q[6] = ((uint64_t)op[0] * 1766858154768292620UL) + ((uint64_t)op[1] * 7604311160199262103UL) + ((uint64_t)op[2] * 2312767378934400501UL) + ((uint64_t)op[3] * 15870398967219228644UL) + ((uint64_t)op[4] * 7293484046771382890UL) + ((uint64_t)op[5] * 10855793733293822429UL) + ((uint64_t)op[6] * 3729025387245575658UL);
