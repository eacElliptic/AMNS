...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13153262108447135899UL) + ((((uint64_t)op[1] * 13320613389425779527UL) + ((uint64_t)op[2] * 2339845287364739218UL) + ((uint64_t)op[3] * 11908359487529214972UL) + ((uint64_t)op[4] * 8300902418486935353UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 8300902418486935353UL) + ((uint64_t)op[1] * 13153262108447135899UL) + ((((uint64_t)op[2] * 13320613389425779527UL) + ((uint64_t)op[3] * 2339845287364739218UL) + ((uint64_t)op[4] * 11908359487529214972UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 11908359487529214972UL) + ((uint64_t)op[1] * 8300902418486935353UL) + ((uint64_t)op[2] * 13153262108447135899UL) + ((((uint64_t)op[3] * 13320613389425779527UL) + ((uint64_t)op[4] * 2339845287364739218UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 2339845287364739218UL) + ((uint64_t)op[1] * 11908359487529214972UL) + ((uint64_t)op[2] * 8300902418486935353UL) + ((uint64_t)op[3] * 13153262108447135899UL) + ((uint64_t)op[4] * 12310040031993080918UL);
	tmp_q[4] = ((uint64_t)op[0] * 13320613389425779527UL) + ((uint64_t)op[1] * 2339845287364739218UL) + ((uint64_t)op[2] * 11908359487529214972UL) + ((uint64_t)op[3] * 8300902418486935353UL) + ((uint64_t)op[4] * 13153262108447135899UL);
