...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9308000454732092363UL) + ((((uint64_t)op[1] * 9324754700691716704UL) + ((uint64_t)op[2] * 4920657205531689044UL) + ((uint64_t)op[3] * 17539165994719966075UL) + ((uint64_t)op[4] * 859750842212597749UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 859750842212597749UL) + ((uint64_t)op[1] * 9308000454732092363UL) + ((((uint64_t)op[2] * 9324754700691716704UL) + ((uint64_t)op[3] * 4920657205531689044UL) + ((uint64_t)op[4] * 17539165994719966075UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 17539165994719966075UL) + ((uint64_t)op[1] * 859750842212597749UL) + ((uint64_t)op[2] * 9308000454732092363UL) + ((((uint64_t)op[3] * 9324754700691716704UL) + ((uint64_t)op[4] * 4920657205531689044UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 4920657205531689044UL) + ((uint64_t)op[1] * 17539165994719966075UL) + ((uint64_t)op[2] * 859750842212597749UL) + ((uint64_t)op[3] * 9308000454732092363UL) + ((uint64_t)op[4] * 18243978746035669824UL);
	tmp_q[4] = ((uint64_t)op[0] * 9324754700691716704UL) + ((uint64_t)op[1] * 4920657205531689044UL) + ((uint64_t)op[2] * 17539165994719966075UL) + ((uint64_t)op[3] * 859750842212597749UL) + ((uint64_t)op[4] * 9308000454732092363UL);
