...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15975358528394620521UL) + ((((uint64_t)op[1] * 11995478652834460283UL) + ((uint64_t)op[2] * 2421498852260413766UL) + ((uint64_t)op[3] * 5013921415976928266UL) + ((uint64_t)op[4] * 2177146259598475085UL) + ((uint64_t)op[5] * 9415179663215268470UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 9415179663215268470UL) + ((uint64_t)op[1] * 15975358528394620521UL) + ((((uint64_t)op[2] * 11995478652834460283UL) + ((uint64_t)op[3] * 2421498852260413766UL) + ((uint64_t)op[4] * 5013921415976928266UL) + ((uint64_t)op[5] * 2177146259598475085UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 2177146259598475085UL) + ((uint64_t)op[1] * 9415179663215268470UL) + ((uint64_t)op[2] * 15975358528394620521UL) + ((((uint64_t)op[3] * 11995478652834460283UL) + ((uint64_t)op[4] * 2421498852260413766UL) + ((uint64_t)op[5] * 5013921415976928266UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 5013921415976928266UL) + ((uint64_t)op[1] * 2177146259598475085UL) + ((uint64_t)op[2] * 9415179663215268470UL) + ((uint64_t)op[3] * 15975358528394620521UL) + ((((uint64_t)op[4] * 11995478652834460283UL) + ((uint64_t)op[5] * 2421498852260413766UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 2421498852260413766UL) + ((uint64_t)op[1] * 5013921415976928266UL) + ((uint64_t)op[2] * 2177146259598475085UL) + ((uint64_t)op[3] * 9415179663215268470UL) + ((uint64_t)op[4] * 15975358528394620521UL) + ((uint64_t)op[5] * 13809583030665905049UL);
	tmp_q[5] = ((uint64_t)op[0] * 11995478652834460283UL) + ((uint64_t)op[1] * 2421498852260413766UL) + ((uint64_t)op[2] * 5013921415976928266UL) + ((uint64_t)op[3] * 2177146259598475085UL) + ((uint64_t)op[4] * 9415179663215268470UL) + ((uint64_t)op[5] * 15975358528394620521UL);
