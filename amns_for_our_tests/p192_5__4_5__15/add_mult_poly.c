...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 4042012825442907031UL) + ((((uint64_t)op[1] * 3286953480751773897UL) + ((uint64_t)op[2] * 13038186972378380345UL) + ((uint64_t)op[3] * 6945810801382881972UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 6945810801382881972UL) + ((uint64_t)op[1] * 4042012825442907031UL) + ((((uint64_t)op[2] * 3286953480751773897UL) + ((uint64_t)op[3] * 13038186972378380345UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 13038186972378380345UL) + ((uint64_t)op[1] * 6945810801382881972UL) + ((uint64_t)op[2] * 4042012825442907031UL) + ((uint64_t)op[3] * 16434767403758869485UL);
	tmp_q[3] = ((uint64_t)op[0] * 3286953480751773897UL) + ((uint64_t)op[1] * 13038186972378380345UL) + ((uint64_t)op[2] * 6945810801382881972UL) + ((uint64_t)op[3] * 4042012825442907031UL);
