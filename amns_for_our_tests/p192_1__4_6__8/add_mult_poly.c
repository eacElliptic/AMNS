...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14050255727688689873UL) + ((((uint64_t)op[1] * 9333754200323455572UL) + ((uint64_t)op[2] * 3021845975148031304UL) + ((uint64_t)op[3] * 15690104913115390238UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 15690104913115390238UL) + ((uint64_t)op[1] * 14050255727688689873UL) + ((((uint64_t)op[2] * 9333754200323455572UL) + ((uint64_t)op[3] * 3021845975148031304UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 3021845975148031304UL) + ((uint64_t)op[1] * 15690104913115390238UL) + ((uint64_t)op[2] * 14050255727688689873UL) + ((uint64_t)op[3] * 662292980812078584UL);
	tmp_q[3] = ((uint64_t)op[0] * 9333754200323455572UL) + ((uint64_t)op[1] * 3021845975148031304UL) + ((uint64_t)op[2] * 15690104913115390238UL) + ((uint64_t)op[3] * 14050255727688689873UL);
