...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 5842116460989901229UL) + ((((uint64_t)op[1] * 13154888970187876582UL) + ((uint64_t)op[2] * 13668055735879815456UL) + ((uint64_t)op[3] * 814332132363204109UL) + ((uint64_t)op[4] * 5100355451089651127UL) + ((uint64_t)op[5] * 11747671193618827936UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 11747671193618827936UL) + ((uint64_t)op[1] * 5842116460989901229UL) + ((((uint64_t)op[2] * 13154888970187876582UL) + ((uint64_t)op[3] * 13668055735879815456UL) + ((uint64_t)op[4] * 814332132363204109UL) + ((uint64_t)op[5] * 5100355451089651127UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 5100355451089651127UL) + ((uint64_t)op[1] * 11747671193618827936UL) + ((uint64_t)op[2] * 5842116460989901229UL) + ((((uint64_t)op[3] * 13154888970187876582UL) + ((uint64_t)op[4] * 13668055735879815456UL) + ((uint64_t)op[5] * 814332132363204109UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 814332132363204109UL) + ((uint64_t)op[1] * 5100355451089651127UL) + ((uint64_t)op[2] * 11747671193618827936UL) + ((uint64_t)op[3] * 5842116460989901229UL) + ((((uint64_t)op[4] * 13154888970187876582UL) + ((uint64_t)op[5] * 13668055735879815456UL)) * 18446744073709551609);
	tmp_q[4] = ((uint64_t)op[0] * 13668055735879815456UL) + ((uint64_t)op[1] * 814332132363204109UL) + ((uint64_t)op[2] * 5100355451089651127UL) + ((uint64_t)op[3] * 11747671193618827936UL) + ((uint64_t)op[4] * 5842116460989901229UL) + ((uint64_t)op[5] * 149497577232622006UL);
	tmp_q[5] = ((uint64_t)op[0] * 13154888970187876582UL) + ((uint64_t)op[1] * 13668055735879815456UL) + ((uint64_t)op[2] * 814332132363204109UL) + ((uint64_t)op[3] * 5100355451089651127UL) + ((uint64_t)op[4] * 11747671193618827936UL) + ((uint64_t)op[5] * 5842116460989901229UL);
