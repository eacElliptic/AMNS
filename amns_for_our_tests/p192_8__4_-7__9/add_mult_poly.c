...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3538520087087393320UL) + ((((uint64_t)op[1] * 11622326434746927684UL) + ((uint64_t)op[2] * 13161578560876325106UL) + ((uint64_t)op[3] * 11117833445818251671UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 11117833445818251671UL) + ((uint64_t)op[1] * 3538520087087393320UL) + ((((uint64_t)op[2] * 11622326434746927684UL) + ((uint64_t)op[3] * 13161578560876325106UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 13161578560876325106UL) + ((uint64_t)op[1] * 11117833445818251671UL) + ((uint64_t)op[2] * 3538520087087393320UL) + ((uint64_t)op[3] * 10877435325319264292UL);
	tmp_q[3] = ((uint64_t)op[0] * 11622326434746927684UL) + ((uint64_t)op[1] * 13161578560876325106UL) + ((uint64_t)op[2] * 11117833445818251671UL) + ((uint64_t)op[3] * 3538520087087393320UL);
