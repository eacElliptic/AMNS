...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7694687945627488685UL) + ((((uint64_t)op[1] * 11870000482141880976UL) + ((uint64_t)op[2] * 1621745733546245521UL) + ((uint64_t)op[3] * 7572763781264286794UL) + ((uint64_t)op[4] * 18202941241653918330UL) + ((uint64_t)op[5] * 7587708091933041755UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 7587708091933041755UL) + ((uint64_t)op[1] * 7694687945627488685UL) + ((((uint64_t)op[2] * 11870000482141880976UL) + ((uint64_t)op[3] * 1621745733546245521UL) + ((uint64_t)op[4] * 7572763781264286794UL) + ((uint64_t)op[5] * 18202941241653918330UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 18202941241653918330UL) + ((uint64_t)op[1] * 7587708091933041755UL) + ((uint64_t)op[2] * 7694687945627488685UL) + ((((uint64_t)op[3] * 11870000482141880976UL) + ((uint64_t)op[4] * 1621745733546245521UL) + ((uint64_t)op[5] * 7572763781264286794UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 7572763781264286794UL) + ((uint64_t)op[1] * 18202941241653918330UL) + ((uint64_t)op[2] * 7587708091933041755UL) + ((uint64_t)op[3] * 7694687945627488685UL) + ((((uint64_t)op[4] * 11870000482141880976UL) + ((uint64_t)op[5] * 1621745733546245521UL)) * 18446744073709551613);
	tmp_q[4] = ((uint64_t)op[0] * 1621745733546245521UL) + ((uint64_t)op[1] * 7572763781264286794UL) + ((uint64_t)op[2] * 18202941241653918330UL) + ((uint64_t)op[3] * 7587708091933041755UL) + ((uint64_t)op[4] * 7694687945627488685UL) + ((uint64_t)op[5] * 1283486700993460304UL);
	tmp_q[5] = ((uint64_t)op[0] * 11870000482141880976UL) + ((uint64_t)op[1] * 1621745733546245521UL) + ((uint64_t)op[2] * 7572763781264286794UL) + ((uint64_t)op[3] * 18202941241653918330UL) + ((uint64_t)op[4] * 7587708091933041755UL) + ((uint64_t)op[5] * 7694687945627488685UL);
