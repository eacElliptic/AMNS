...
void init_data(){
	...
	mpz_set_str (modul_p, "18753603594588300593843694313565958601462390402825314356490430292869", 10);

	mpz_set_str (gama_pow[0], "17906217259487672235977461631938197929051397569662210184417692161142", 10);
