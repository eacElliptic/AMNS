...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 41927707469162263UL) + ((((uint64_t)op[1] * 8645687795459869980UL) + ((uint64_t)op[2] * 28662983178279485UL) + ((uint64_t)op[3] * 14000976652896641067UL) + ((uint64_t)op[4] * 5936598916585764638UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 5936598916585764638UL) + ((uint64_t)op[1] * 41927707469162263UL) + ((((uint64_t)op[2] * 8645687795459869980UL) + ((uint64_t)op[3] * 28662983178279485UL) + ((uint64_t)op[4] * 14000976652896641067UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 14000976652896641067UL) + ((uint64_t)op[1] * 5936598916585764638UL) + ((uint64_t)op[2] * 41927707469162263UL) + ((((uint64_t)op[3] * 8645687795459869980UL) + ((uint64_t)op[4] * 28662983178279485UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 28662983178279485UL) + ((uint64_t)op[1] * 14000976652896641067UL) + ((uint64_t)op[2] * 5936598916585764638UL) + ((uint64_t)op[3] * 41927707469162263UL) + ((uint64_t)op[4] * 10956424761039493292UL);
	tmp_q[4] = ((uint64_t)op[0] * 8645687795459869980UL) + ((uint64_t)op[1] * 28662983178279485UL) + ((uint64_t)op[2] * 14000976652896641067UL) + ((uint64_t)op[3] * 5936598916585764638UL) + ((uint64_t)op[4] * 41927707469162263UL);
