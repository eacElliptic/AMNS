...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 669031552735628469UL) + ((((uint64_t)op[1] * 3850390085052756730UL) + ((uint64_t)op[2] * 9710900156159551079UL) + ((uint64_t)op[3] * 3180468945100329250UL) + ((uint64_t)op[4] * 17356404953715609634UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 17356404953715609634UL) + ((uint64_t)op[1] * 669031552735628469UL) + ((((uint64_t)op[2] * 3850390085052756730UL) + ((uint64_t)op[3] * 9710900156159551079UL) + ((uint64_t)op[4] * 3180468945100329250UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 3180468945100329250UL) + ((uint64_t)op[1] * 17356404953715609634UL) + ((uint64_t)op[2] * 669031552735628469UL) + ((((uint64_t)op[3] * 3850390085052756730UL) + ((uint64_t)op[4] * 9710900156159551079UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 9710900156159551079UL) + ((uint64_t)op[1] * 3180468945100329250UL) + ((uint64_t)op[2] * 17356404953715609634UL) + ((uint64_t)op[3] * 669031552735628469UL) + ((uint64_t)op[4] * 13791147637102562852UL);
	tmp_q[4] = ((uint64_t)op[0] * 3850390085052756730UL) + ((uint64_t)op[1] * 9710900156159551079UL) + ((uint64_t)op[2] * 3180468945100329250UL) + ((uint64_t)op[3] * 17356404953715609634UL) + ((uint64_t)op[4] * 669031552735628469UL);
