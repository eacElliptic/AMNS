...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17802198286452356153UL) + ((((uint64_t)op[1] * 17272763891109815442UL) + ((uint64_t)op[2] * 32275361032738097UL) + ((uint64_t)op[3] * 744986908316070046UL) + ((uint64_t)op[4] * 2535660239625066652UL) + ((uint64_t)op[5] * 7053412200005882876UL) + ((uint64_t)op[6] * 10622939267095186187UL)) * 8);
	tmp_q[1] = ((uint64_t)op[0] * 10622939267095186187UL) + ((uint64_t)op[1] * 17802198286452356153UL) + ((((uint64_t)op[2] * 17272763891109815442UL) + ((uint64_t)op[3] * 32275361032738097UL) + ((uint64_t)op[4] * 744986908316070046UL) + ((uint64_t)op[5] * 2535660239625066652UL) + ((uint64_t)op[6] * 7053412200005882876UL)) * 8);
	tmp_q[2] = ((uint64_t)op[0] * 7053412200005882876UL) + ((uint64_t)op[1] * 10622939267095186187UL) + ((uint64_t)op[2] * 17802198286452356153UL) + ((((uint64_t)op[3] * 17272763891109815442UL) + ((uint64_t)op[4] * 32275361032738097UL) + ((uint64_t)op[5] * 744986908316070046UL) + ((uint64_t)op[6] * 2535660239625066652UL)) * 8);
	tmp_q[3] = ((uint64_t)op[0] * 2535660239625066652UL) + ((uint64_t)op[1] * 7053412200005882876UL) + ((uint64_t)op[2] * 10622939267095186187UL) + ((uint64_t)op[3] * 17802198286452356153UL) + ((((uint64_t)op[4] * 17272763891109815442UL) + ((uint64_t)op[5] * 32275361032738097UL) + ((uint64_t)op[6] * 744986908316070046UL)) * 8);
	tmp_q[4] = ((uint64_t)op[0] * 744986908316070046UL) + ((uint64_t)op[1] * 2535660239625066652UL) + ((uint64_t)op[2] * 7053412200005882876UL) + ((uint64_t)op[3] * 10622939267095186187UL) + ((uint64_t)op[4] * 17802198286452356153UL) + ((((uint64_t)op[5] * 17272763891109815442UL) + ((uint64_t)op[6] * 32275361032738097UL)) * 8);
	tmp_q[5] = ((uint64_t)op[0] * 32275361032738097UL) + ((uint64_t)op[1] * 744986908316070046UL) + ((uint64_t)op[2] * 2535660239625066652UL) + ((uint64_t)op[3] * 7053412200005882876UL) + ((uint64_t)op[4] * 10622939267095186187UL) + ((uint64_t)op[5] * 17802198286452356153UL) + ((uint64_t)op[6] * 9054902612911662224UL);
	tmp_q[6] = ((uint64_t)op[0] * 17272763891109815442UL) + ((uint64_t)op[1] * 32275361032738097UL) + ((uint64_t)op[2] * 744986908316070046UL) + ((uint64_t)op[3] * 2535660239625066652UL) + ((uint64_t)op[4] * 7053412200005882876UL) + ((uint64_t)op[5] * 10622939267095186187UL) + ((uint64_t)op[6] * 17802198286452356153UL);
