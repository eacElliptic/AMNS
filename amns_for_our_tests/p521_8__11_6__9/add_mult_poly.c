...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12788416065672948961UL) + ((((uint64_t)op[1] * 13579513026919516455UL) + ((uint64_t)op[2] * 9306810177458241629UL) + ((uint64_t)op[3] * 13771302841726590919UL) + ((uint64_t)op[4] * 4763906738431177706UL) + ((uint64_t)op[5] * 17762998964860149551UL) + ((uint64_t)op[6] * 11502197098927065429UL) + ((uint64_t)op[7] * 16944666108654345031UL) + ((uint64_t)op[8] * 12293104920482715914UL) + ((uint64_t)op[9] * 5622599500972820218UL) + ((uint64_t)op[10] * 17068822549925918684UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 17068822549925918684UL) + ((uint64_t)op[1] * 12788416065672948961UL) + ((((uint64_t)op[2] * 13579513026919516455UL) + ((uint64_t)op[3] * 9306810177458241629UL) + ((uint64_t)op[4] * 13771302841726590919UL) + ((uint64_t)op[5] * 4763906738431177706UL) + ((uint64_t)op[6] * 17762998964860149551UL) + ((uint64_t)op[7] * 11502197098927065429UL) + ((uint64_t)op[8] * 16944666108654345031UL) + ((uint64_t)op[9] * 12293104920482715914UL) + ((uint64_t)op[10] * 5622599500972820218UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 5622599500972820218UL) + ((uint64_t)op[1] * 17068822549925918684UL) + ((uint64_t)op[2] * 12788416065672948961UL) + ((((uint64_t)op[3] * 13579513026919516455UL) + ((uint64_t)op[4] * 9306810177458241629UL) + ((uint64_t)op[5] * 13771302841726590919UL) + ((uint64_t)op[6] * 4763906738431177706UL) + ((uint64_t)op[7] * 17762998964860149551UL) + ((uint64_t)op[8] * 11502197098927065429UL) + ((uint64_t)op[9] * 16944666108654345031UL) + ((uint64_t)op[10] * 12293104920482715914UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 12293104920482715914UL) + ((uint64_t)op[1] * 5622599500972820218UL) + ((uint64_t)op[2] * 17068822549925918684UL) + ((uint64_t)op[3] * 12788416065672948961UL) + ((((uint64_t)op[4] * 13579513026919516455UL) + ((uint64_t)op[5] * 9306810177458241629UL) + ((uint64_t)op[6] * 13771302841726590919UL) + ((uint64_t)op[7] * 4763906738431177706UL) + ((uint64_t)op[8] * 17762998964860149551UL) + ((uint64_t)op[9] * 11502197098927065429UL) + ((uint64_t)op[10] * 16944666108654345031UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 16944666108654345031UL) + ((uint64_t)op[1] * 12293104920482715914UL) + ((uint64_t)op[2] * 5622599500972820218UL) + ((uint64_t)op[3] * 17068822549925918684UL) + ((uint64_t)op[4] * 12788416065672948961UL) + ((((uint64_t)op[5] * 13579513026919516455UL) + ((uint64_t)op[6] * 9306810177458241629UL) + ((uint64_t)op[7] * 13771302841726590919UL) + ((uint64_t)op[8] * 4763906738431177706UL) + ((uint64_t)op[9] * 17762998964860149551UL) + ((uint64_t)op[10] * 11502197098927065429UL)) * 6);
	tmp_q[5] = ((uint64_t)op[0] * 11502197098927065429UL) + ((uint64_t)op[1] * 16944666108654345031UL) + ((uint64_t)op[2] * 12293104920482715914UL) + ((uint64_t)op[3] * 5622599500972820218UL) + ((uint64_t)op[4] * 17068822549925918684UL) + ((uint64_t)op[5] * 12788416065672948961UL) + ((((uint64_t)op[6] * 13579513026919516455UL) + ((uint64_t)op[7] * 9306810177458241629UL) + ((uint64_t)op[8] * 13771302841726590919UL) + ((uint64_t)op[9] * 4763906738431177706UL) + ((uint64_t)op[10] * 17762998964860149551UL)) * 6);
	tmp_q[6] = ((uint64_t)op[0] * 17762998964860149551UL) + ((uint64_t)op[1] * 11502197098927065429UL) + ((uint64_t)op[2] * 16944666108654345031UL) + ((uint64_t)op[3] * 12293104920482715914UL) + ((uint64_t)op[4] * 5622599500972820218UL) + ((uint64_t)op[5] * 17068822549925918684UL) + ((uint64_t)op[6] * 12788416065672948961UL) + ((((uint64_t)op[7] * 13579513026919516455UL) + ((uint64_t)op[8] * 9306810177458241629UL) + ((uint64_t)op[9] * 13771302841726590919UL) + ((uint64_t)op[10] * 4763906738431177706UL)) * 6);
	tmp_q[7] = ((uint64_t)op[0] * 4763906738431177706UL) + ((uint64_t)op[1] * 17762998964860149551UL) + ((uint64_t)op[2] * 11502197098927065429UL) + ((uint64_t)op[3] * 16944666108654345031UL) + ((uint64_t)op[4] * 12293104920482715914UL) + ((uint64_t)op[5] * 5622599500972820218UL) + ((uint64_t)op[6] * 17068822549925918684UL) + ((uint64_t)op[7] * 12788416065672948961UL) + ((((uint64_t)op[8] * 13579513026919516455UL) + ((uint64_t)op[9] * 9306810177458241629UL) + ((uint64_t)op[10] * 13771302841726590919UL)) * 6);
	tmp_q[8] = ((uint64_t)op[0] * 13771302841726590919UL) + ((uint64_t)op[1] * 4763906738431177706UL) + ((uint64_t)op[2] * 17762998964860149551UL) + ((uint64_t)op[3] * 11502197098927065429UL) + ((uint64_t)op[4] * 16944666108654345031UL) + ((uint64_t)op[5] * 12293104920482715914UL) + ((uint64_t)op[6] * 5622599500972820218UL) + ((uint64_t)op[7] * 17068822549925918684UL) + ((uint64_t)op[8] * 12788416065672948961UL) + ((((uint64_t)op[9] * 13579513026919516455UL) + ((uint64_t)op[10] * 9306810177458241629UL)) * 6);
	tmp_q[9] = ((uint64_t)op[0] * 9306810177458241629UL) + ((uint64_t)op[1] * 13771302841726590919UL) + ((uint64_t)op[2] * 4763906738431177706UL) + ((uint64_t)op[3] * 17762998964860149551UL) + ((uint64_t)op[4] * 11502197098927065429UL) + ((uint64_t)op[5] * 16944666108654345031UL) + ((uint64_t)op[6] * 12293104920482715914UL) + ((uint64_t)op[7] * 5622599500972820218UL) + ((uint64_t)op[8] * 17068822549925918684UL) + ((uint64_t)op[9] * 12788416065672948961UL) + ((uint64_t)op[10] * 7690101866678892266UL);
	tmp_q[10] = ((uint64_t)op[0] * 13579513026919516455UL) + ((uint64_t)op[1] * 9306810177458241629UL) + ((uint64_t)op[2] * 13771302841726590919UL) + ((uint64_t)op[3] * 4763906738431177706UL) + ((uint64_t)op[4] * 17762998964860149551UL) + ((uint64_t)op[5] * 11502197098927065429UL) + ((uint64_t)op[6] * 16944666108654345031UL) + ((uint64_t)op[7] * 12293104920482715914UL) + ((uint64_t)op[8] * 5622599500972820218UL) + ((uint64_t)op[9] * 17068822549925918684UL) + ((uint64_t)op[10] * 12788416065672948961UL);
