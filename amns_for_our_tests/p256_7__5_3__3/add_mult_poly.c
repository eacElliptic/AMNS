...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7189589982972152033UL) + ((((uint64_t)op[1] * 13897045652009723101UL) + ((uint64_t)op[2] * 14264028069241701528UL) + ((uint64_t)op[3] * 8409055064009726357UL) + ((uint64_t)op[4] * 17855163245375112018UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 17855163245375112018UL) + ((uint64_t)op[1] * 7189589982972152033UL) + ((((uint64_t)op[2] * 13897045652009723101UL) + ((uint64_t)op[3] * 14264028069241701528UL) + ((uint64_t)op[4] * 8409055064009726357UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 8409055064009726357UL) + ((uint64_t)op[1] * 17855163245375112018UL) + ((uint64_t)op[2] * 7189589982972152033UL) + ((((uint64_t)op[3] * 13897045652009723101UL) + ((uint64_t)op[4] * 14264028069241701528UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 14264028069241701528UL) + ((uint64_t)op[1] * 8409055064009726357UL) + ((uint64_t)op[2] * 17855163245375112018UL) + ((uint64_t)op[3] * 7189589982972152033UL) + ((uint64_t)op[4] * 4797648808610066071UL);
	tmp_q[4] = ((uint64_t)op[0] * 13897045652009723101UL) + ((uint64_t)op[1] * 14264028069241701528UL) + ((uint64_t)op[2] * 8409055064009726357UL) + ((uint64_t)op[3] * 17855163245375112018UL) + ((uint64_t)op[4] * 7189589982972152033UL);
