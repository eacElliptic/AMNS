...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1304378125856591419UL) + ((((uint64_t)op[1] * 2988789671462585565UL) + ((uint64_t)op[2] * 2929536103038208709UL) + ((uint64_t)op[3] * 15288981084968798710UL) + ((uint64_t)op[4] * 11428244525180117033UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 11428244525180117033UL) + ((uint64_t)op[1] * 1304378125856591419UL) + ((((uint64_t)op[2] * 2988789671462585565UL) + ((uint64_t)op[3] * 2929536103038208709UL) + ((uint64_t)op[4] * 15288981084968798710UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 15288981084968798710UL) + ((uint64_t)op[1] * 11428244525180117033UL) + ((uint64_t)op[2] * 1304378125856591419UL) + ((((uint64_t)op[3] * 2988789671462585565UL) + ((uint64_t)op[4] * 2929536103038208709UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 2929536103038208709UL) + ((uint64_t)op[1] * 15288981084968798710UL) + ((uint64_t)op[2] * 11428244525180117033UL) + ((uint64_t)op[3] * 1304378125856591419UL) + ((uint64_t)op[4] * 514006044934038226UL);
	tmp_q[4] = ((uint64_t)op[0] * 2988789671462585565UL) + ((uint64_t)op[1] * 2929536103038208709UL) + ((uint64_t)op[2] * 15288981084968798710UL) + ((uint64_t)op[3] * 11428244525180117033UL) + ((uint64_t)op[4] * 1304378125856591419UL);
