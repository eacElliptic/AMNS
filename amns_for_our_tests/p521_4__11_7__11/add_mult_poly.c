...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11280122342308212616UL) + ((((uint64_t)op[1] * 15019669605021546041UL) + ((uint64_t)op[2] * 15069408456359180320UL) + ((uint64_t)op[3] * 12806228966935637524UL) + ((uint64_t)op[4] * 2773271979438455825UL) + ((uint64_t)op[5] * 18347310934792866405UL) + ((uint64_t)op[6] * 18396227387500343190UL) + ((uint64_t)op[7] * 2386740410197409589UL) + ((uint64_t)op[8] * 4545553585105010155UL) + ((uint64_t)op[9] * 4226845870281841013UL) + ((uint64_t)op[10] * 5898030988737216915UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 5898030988737216915UL) + ((uint64_t)op[1] * 11280122342308212616UL) + ((((uint64_t)op[2] * 15019669605021546041UL) + ((uint64_t)op[3] * 15069408456359180320UL) + ((uint64_t)op[4] * 12806228966935637524UL) + ((uint64_t)op[5] * 2773271979438455825UL) + ((uint64_t)op[6] * 18347310934792866405UL) + ((uint64_t)op[7] * 18396227387500343190UL) + ((uint64_t)op[8] * 2386740410197409589UL) + ((uint64_t)op[9] * 4545553585105010155UL) + ((uint64_t)op[10] * 4226845870281841013UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 4226845870281841013UL) + ((uint64_t)op[1] * 5898030988737216915UL) + ((uint64_t)op[2] * 11280122342308212616UL) + ((((uint64_t)op[3] * 15019669605021546041UL) + ((uint64_t)op[4] * 15069408456359180320UL) + ((uint64_t)op[5] * 12806228966935637524UL) + ((uint64_t)op[6] * 2773271979438455825UL) + ((uint64_t)op[7] * 18347310934792866405UL) + ((uint64_t)op[8] * 18396227387500343190UL) + ((uint64_t)op[9] * 2386740410197409589UL) + ((uint64_t)op[10] * 4545553585105010155UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 4545553585105010155UL) + ((uint64_t)op[1] * 4226845870281841013UL) + ((uint64_t)op[2] * 5898030988737216915UL) + ((uint64_t)op[3] * 11280122342308212616UL) + ((((uint64_t)op[4] * 15019669605021546041UL) + ((uint64_t)op[5] * 15069408456359180320UL) + ((uint64_t)op[6] * 12806228966935637524UL) + ((uint64_t)op[7] * 2773271979438455825UL) + ((uint64_t)op[8] * 18347310934792866405UL) + ((uint64_t)op[9] * 18396227387500343190UL) + ((uint64_t)op[10] * 2386740410197409589UL)) * 7);
	tmp_q[4] = ((uint64_t)op[0] * 2386740410197409589UL) + ((uint64_t)op[1] * 4545553585105010155UL) + ((uint64_t)op[2] * 4226845870281841013UL) + ((uint64_t)op[3] * 5898030988737216915UL) + ((uint64_t)op[4] * 11280122342308212616UL) + ((((uint64_t)op[5] * 15019669605021546041UL) + ((uint64_t)op[6] * 15069408456359180320UL) + ((uint64_t)op[7] * 12806228966935637524UL) + ((uint64_t)op[8] * 2773271979438455825UL) + ((uint64_t)op[9] * 18347310934792866405UL) + ((uint64_t)op[10] * 18396227387500343190UL)) * 7);
	tmp_q[5] = ((uint64_t)op[0] * 18396227387500343190UL) + ((uint64_t)op[1] * 2386740410197409589UL) + ((uint64_t)op[2] * 4545553585105010155UL) + ((uint64_t)op[3] * 4226845870281841013UL) + ((uint64_t)op[4] * 5898030988737216915UL) + ((uint64_t)op[5] * 11280122342308212616UL) + ((((uint64_t)op[6] * 15019669605021546041UL) + ((uint64_t)op[7] * 15069408456359180320UL) + ((uint64_t)op[8] * 12806228966935637524UL) + ((uint64_t)op[9] * 2773271979438455825UL) + ((uint64_t)op[10] * 18347310934792866405UL)) * 7);
	tmp_q[6] = ((uint64_t)op[0] * 18347310934792866405UL) + ((uint64_t)op[1] * 18396227387500343190UL) + ((uint64_t)op[2] * 2386740410197409589UL) + ((uint64_t)op[3] * 4545553585105010155UL) + ((uint64_t)op[4] * 4226845870281841013UL) + ((uint64_t)op[5] * 5898030988737216915UL) + ((uint64_t)op[6] * 11280122342308212616UL) + ((((uint64_t)op[7] * 15019669605021546041UL) + ((uint64_t)op[8] * 15069408456359180320UL) + ((uint64_t)op[9] * 12806228966935637524UL) + ((uint64_t)op[10] * 2773271979438455825UL)) * 7);
	tmp_q[7] = ((uint64_t)op[0] * 2773271979438455825UL) + ((uint64_t)op[1] * 18347310934792866405UL) + ((uint64_t)op[2] * 18396227387500343190UL) + ((uint64_t)op[3] * 2386740410197409589UL) + ((uint64_t)op[4] * 4545553585105010155UL) + ((uint64_t)op[5] * 4226845870281841013UL) + ((uint64_t)op[6] * 5898030988737216915UL) + ((uint64_t)op[7] * 11280122342308212616UL) + ((((uint64_t)op[8] * 15019669605021546041UL) + ((uint64_t)op[9] * 15069408456359180320UL) + ((uint64_t)op[10] * 12806228966935637524UL)) * 7);
	tmp_q[8] = ((uint64_t)op[0] * 12806228966935637524UL) + ((uint64_t)op[1] * 2773271979438455825UL) + ((uint64_t)op[2] * 18347310934792866405UL) + ((uint64_t)op[3] * 18396227387500343190UL) + ((uint64_t)op[4] * 2386740410197409589UL) + ((uint64_t)op[5] * 4545553585105010155UL) + ((uint64_t)op[6] * 4226845870281841013UL) + ((uint64_t)op[7] * 5898030988737216915UL) + ((uint64_t)op[8] * 11280122342308212616UL) + ((((uint64_t)op[9] * 15019669605021546041UL) + ((uint64_t)op[10] * 15069408456359180320UL)) * 7);
	tmp_q[9] = ((uint64_t)op[0] * 15069408456359180320UL) + ((uint64_t)op[1] * 12806228966935637524UL) + ((uint64_t)op[2] * 2773271979438455825UL) + ((uint64_t)op[3] * 18347310934792866405UL) + ((uint64_t)op[4] * 18396227387500343190UL) + ((uint64_t)op[5] * 2386740410197409589UL) + ((uint64_t)op[6] * 4545553585105010155UL) + ((uint64_t)op[7] * 4226845870281841013UL) + ((uint64_t)op[8] * 5898030988737216915UL) + ((uint64_t)op[9] * 11280122342308212616UL) + ((uint64_t)op[10] * 12903966866603064207UL);
	tmp_q[10] = ((uint64_t)op[0] * 15019669605021546041UL) + ((uint64_t)op[1] * 15069408456359180320UL) + ((uint64_t)op[2] * 12806228966935637524UL) + ((uint64_t)op[3] * 2773271979438455825UL) + ((uint64_t)op[4] * 18347310934792866405UL) + ((uint64_t)op[5] * 18396227387500343190UL) + ((uint64_t)op[6] * 2386740410197409589UL) + ((uint64_t)op[7] * 4545553585105010155UL) + ((uint64_t)op[8] * 4226845870281841013UL) + ((uint64_t)op[9] * 5898030988737216915UL) + ((uint64_t)op[10] * 11280122342308212616UL);
