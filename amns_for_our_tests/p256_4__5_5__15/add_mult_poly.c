...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11298232241311266714UL) + ((((uint64_t)op[1] * 16370808634138383482UL) + ((uint64_t)op[2] * 7021793064388121244UL) + ((uint64_t)op[3] * 13831764075634726133UL) + ((uint64_t)op[4] * 12451632536822455964UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 12451632536822455964UL) + ((uint64_t)op[1] * 11298232241311266714UL) + ((((uint64_t)op[2] * 16370808634138383482UL) + ((uint64_t)op[3] * 7021793064388121244UL) + ((uint64_t)op[4] * 13831764075634726133UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 13831764075634726133UL) + ((uint64_t)op[1] * 12451632536822455964UL) + ((uint64_t)op[2] * 11298232241311266714UL) + ((((uint64_t)op[3] * 16370808634138383482UL) + ((uint64_t)op[4] * 7021793064388121244UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 7021793064388121244UL) + ((uint64_t)op[1] * 13831764075634726133UL) + ((uint64_t)op[2] * 12451632536822455964UL) + ((uint64_t)op[3] * 11298232241311266714UL) + ((uint64_t)op[4] * 8067066875853710946UL);
	tmp_q[4] = ((uint64_t)op[0] * 16370808634138383482UL) + ((uint64_t)op[1] * 7021793064388121244UL) + ((uint64_t)op[2] * 13831764075634726133UL) + ((uint64_t)op[3] * 12451632536822455964UL) + ((uint64_t)op[4] * 11298232241311266714UL);
