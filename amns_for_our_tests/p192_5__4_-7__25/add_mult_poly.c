...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7683737246485837200UL) + ((((uint64_t)op[1] * 8407341435932969120UL) + ((uint64_t)op[2] * 12348502763410823565UL) + ((uint64_t)op[3] * 9249886407819541190UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 9249886407819541190UL) + ((uint64_t)op[1] * 7683737246485837200UL) + ((((uint64_t)op[2] * 8407341435932969120UL) + ((uint64_t)op[3] * 12348502763410823565UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 12348502763410823565UL) + ((uint64_t)op[1] * 9249886407819541190UL) + ((uint64_t)op[2] * 7683737246485837200UL) + ((uint64_t)op[3] * 14935586243307422624UL);
	tmp_q[3] = ((uint64_t)op[0] * 8407341435932969120UL) + ((uint64_t)op[1] * 12348502763410823565UL) + ((uint64_t)op[2] * 9249886407819541190UL) + ((uint64_t)op[3] * 7683737246485837200UL);
