...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6077603387505693839UL) + ((((uint64_t)op[1] * 16938211858072521836UL) + ((uint64_t)op[2] * 953160324485746453UL) + ((uint64_t)op[3] * 4368238589447791252UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 4368238589447791252UL) + ((uint64_t)op[1] * 6077603387505693839UL) + ((((uint64_t)op[2] * 16938211858072521836UL) + ((uint64_t)op[3] * 953160324485746453UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 953160324485746453UL) + ((uint64_t)op[1] * 4368238589447791252UL) + ((uint64_t)op[2] * 6077603387505693839UL) + ((uint64_t)op[3] * 12068257725096238240UL);
	tmp_q[3] = ((uint64_t)op[0] * 16938211858072521836UL) + ((uint64_t)op[1] * 953160324485746453UL) + ((uint64_t)op[2] * 4368238589447791252UL) + ((uint64_t)op[3] * 6077603387505693839UL);
