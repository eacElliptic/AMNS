...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10211738422238389713UL) + ((((uint64_t)op[1] * 540214429955852388UL) + ((uint64_t)op[2] * 13494509485540354703UL) + ((uint64_t)op[3] * 8602191454897955424UL) + ((uint64_t)op[4] * 15196391513201044442UL)) * 18446744073709551612);
	tmp_q[1] = ((uint64_t)op[0] * 15196391513201044442UL) + ((uint64_t)op[1] * 10211738422238389713UL) + ((((uint64_t)op[2] * 540214429955852388UL) + ((uint64_t)op[3] * 13494509485540354703UL) + ((uint64_t)op[4] * 8602191454897955424UL)) * 18446744073709551612);
	tmp_q[2] = ((uint64_t)op[0] * 8602191454897955424UL) + ((uint64_t)op[1] * 15196391513201044442UL) + ((uint64_t)op[2] * 10211738422238389713UL) + ((((uint64_t)op[3] * 540214429955852388UL) + ((uint64_t)op[4] * 13494509485540354703UL)) * 18446744073709551612);
	tmp_q[3] = ((uint64_t)op[0] * 13494509485540354703UL) + ((uint64_t)op[1] * 8602191454897955424UL) + ((uint64_t)op[2] * 15196391513201044442UL) + ((uint64_t)op[3] * 10211738422238389713UL) + ((uint64_t)op[4] * 16285886353886142064UL);
	tmp_q[4] = ((uint64_t)op[0] * 540214429955852388UL) + ((uint64_t)op[1] * 13494509485540354703UL) + ((uint64_t)op[2] * 8602191454897955424UL) + ((uint64_t)op[3] * 15196391513201044442UL) + ((uint64_t)op[4] * 10211738422238389713UL);
