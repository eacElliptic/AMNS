...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8801339306875621650UL) + ((((uint64_t)op[1] * 3041160444823850537UL) + ((uint64_t)op[2] * 1910615545346763121UL) + ((uint64_t)op[3] * 9755891579579182336UL) + ((uint64_t)op[4] * 10188863780493511609UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 10188863780493511609UL) + ((uint64_t)op[1] * 8801339306875621650UL) + ((((uint64_t)op[2] * 3041160444823850537UL) + ((uint64_t)op[3] * 1910615545346763121UL) + ((uint64_t)op[4] * 9755891579579182336UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 9755891579579182336UL) + ((uint64_t)op[1] * 10188863780493511609UL) + ((uint64_t)op[2] * 8801339306875621650UL) + ((((uint64_t)op[3] * 3041160444823850537UL) + ((uint64_t)op[4] * 1910615545346763121UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 1910615545346763121UL) + ((uint64_t)op[1] * 9755891579579182336UL) + ((uint64_t)op[2] * 10188863780493511609UL) + ((uint64_t)op[3] * 8801339306875621650UL) + ((uint64_t)op[4] * 15605365033652149473UL);
	tmp_q[4] = ((uint64_t)op[0] * 3041160444823850537UL) + ((uint64_t)op[1] * 1910615545346763121UL) + ((uint64_t)op[2] * 9755891579579182336UL) + ((uint64_t)op[3] * 10188863780493511609UL) + ((uint64_t)op[4] * 8801339306875621650UL);
