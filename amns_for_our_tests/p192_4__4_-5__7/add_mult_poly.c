...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 5176777346965077543UL) + ((((uint64_t)op[1] * 17635742608254108045UL) + ((uint64_t)op[2] * 748709281601232991UL) + ((uint64_t)op[3] * 13405246916409843070UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 13405246916409843070UL) + ((uint64_t)op[1] * 5176777346965077543UL) + ((((uint64_t)op[2] * 17635742608254108045UL) + ((uint64_t)op[3] * 748709281601232991UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 748709281601232991UL) + ((uint64_t)op[1] * 13405246916409843070UL) + ((uint64_t)op[2] * 5176777346965077543UL) + ((uint64_t)op[3] * 4055007327277217855UL);
	tmp_q[3] = ((uint64_t)op[0] * 17635742608254108045UL) + ((uint64_t)op[1] * 748709281601232991UL) + ((uint64_t)op[2] * 13405246916409843070UL) + ((uint64_t)op[3] * 5176777346965077543UL);
