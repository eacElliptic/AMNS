...
void init_data(){
	...
	mpz_set_str (modul_p, "4931184686727119005898123744800998425021659611022718352233", 10);

	mpz_set_str (gama_pow[0], "1643670524467311240141256751631340550911074311796035278587", 10);
