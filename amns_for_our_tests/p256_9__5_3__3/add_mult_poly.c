...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 44236387551597973UL) + ((((uint64_t)op[1] * 5856732181630200620UL) + ((uint64_t)op[2] * 10822540250860356407UL) + ((uint64_t)op[3] * 4211459956208755992UL) + ((uint64_t)op[4] * 17647017785711432829UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 17647017785711432829UL) + ((uint64_t)op[1] * 44236387551597973UL) + ((((uint64_t)op[2] * 5856732181630200620UL) + ((uint64_t)op[3] * 10822540250860356407UL) + ((uint64_t)op[4] * 4211459956208755992UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 4211459956208755992UL) + ((uint64_t)op[1] * 17647017785711432829UL) + ((uint64_t)op[2] * 44236387551597973UL) + ((((uint64_t)op[3] * 5856732181630200620UL) + ((uint64_t)op[4] * 10822540250860356407UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 10822540250860356407UL) + ((uint64_t)op[1] * 4211459956208755992UL) + ((uint64_t)op[2] * 17647017785711432829UL) + ((uint64_t)op[3] * 44236387551597973UL) + ((uint64_t)op[4] * 17570196544890601860UL);
	tmp_q[4] = ((uint64_t)op[0] * 5856732181630200620UL) + ((uint64_t)op[1] * 10822540250860356407UL) + ((uint64_t)op[2] * 4211459956208755992UL) + ((uint64_t)op[3] * 17647017785711432829UL) + ((uint64_t)op[4] * 44236387551597973UL);
