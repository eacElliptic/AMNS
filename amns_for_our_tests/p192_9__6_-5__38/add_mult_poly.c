...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10707726114017073300UL) + ((((uint64_t)op[1] * 17324124284988689557UL) + ((uint64_t)op[2] * 11662191421527311621UL) + ((uint64_t)op[3] * 375355679208724421UL) + ((uint64_t)op[4] * 14799695072816947001UL) + ((uint64_t)op[5] * 10432664229507985997UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 10432664229507985997UL) + ((uint64_t)op[1] * 10707726114017073300UL) + ((((uint64_t)op[2] * 17324124284988689557UL) + ((uint64_t)op[3] * 11662191421527311621UL) + ((uint64_t)op[4] * 375355679208724421UL) + ((uint64_t)op[5] * 14799695072816947001UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 14799695072816947001UL) + ((uint64_t)op[1] * 10432664229507985997UL) + ((uint64_t)op[2] * 10707726114017073300UL) + ((((uint64_t)op[3] * 17324124284988689557UL) + ((uint64_t)op[4] * 11662191421527311621UL) + ((uint64_t)op[5] * 375355679208724421UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 375355679208724421UL) + ((uint64_t)op[1] * 14799695072816947001UL) + ((uint64_t)op[2] * 10432664229507985997UL) + ((uint64_t)op[3] * 10707726114017073300UL) + ((((uint64_t)op[4] * 17324124284988689557UL) + ((uint64_t)op[5] * 11662191421527311621UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 11662191421527311621UL) + ((uint64_t)op[1] * 375355679208724421UL) + ((uint64_t)op[2] * 14799695072816947001UL) + ((uint64_t)op[3] * 10432664229507985997UL) + ((uint64_t)op[4] * 10707726114017073300UL) + ((uint64_t)op[5] * 5613098943604310295UL);
	tmp_q[5] = ((uint64_t)op[0] * 17324124284988689557UL) + ((uint64_t)op[1] * 11662191421527311621UL) + ((uint64_t)op[2] * 375355679208724421UL) + ((uint64_t)op[3] * 14799695072816947001UL) + ((uint64_t)op[4] * 10432664229507985997UL) + ((uint64_t)op[5] * 10707726114017073300UL);
