...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9711513040812756017UL) + ((((uint64_t)op[1] * 12003986053133796253UL) + ((uint64_t)op[2] * 9524335271146308589UL) + ((uint64_t)op[3] * 18052948469607658949UL) + ((uint64_t)op[4] * 1823028408051073808UL) + ((uint64_t)op[5] * 10163202227621904088UL) + ((uint64_t)op[6] * 10846822680092352945UL)) * 18446744073709551612);
	tmp_q[1] = ((uint64_t)op[0] * 10846822680092352945UL) + ((uint64_t)op[1] * 9711513040812756017UL) + ((((uint64_t)op[2] * 12003986053133796253UL) + ((uint64_t)op[3] * 9524335271146308589UL) + ((uint64_t)op[4] * 18052948469607658949UL) + ((uint64_t)op[5] * 1823028408051073808UL) + ((uint64_t)op[6] * 10163202227621904088UL)) * 18446744073709551612);
	tmp_q[2] = ((uint64_t)op[0] * 10163202227621904088UL) + ((uint64_t)op[1] * 10846822680092352945UL) + ((uint64_t)op[2] * 9711513040812756017UL) + ((((uint64_t)op[3] * 12003986053133796253UL) + ((uint64_t)op[4] * 9524335271146308589UL) + ((uint64_t)op[5] * 18052948469607658949UL) + ((uint64_t)op[6] * 1823028408051073808UL)) * 18446744073709551612);
	tmp_q[3] = ((uint64_t)op[0] * 1823028408051073808UL) + ((uint64_t)op[1] * 10163202227621904088UL) + ((uint64_t)op[2] * 10846822680092352945UL) + ((uint64_t)op[3] * 9711513040812756017UL) + ((((uint64_t)op[4] * 12003986053133796253UL) + ((uint64_t)op[5] * 9524335271146308589UL) + ((uint64_t)op[6] * 18052948469607658949UL)) * 18446744073709551612);
	tmp_q[4] = ((uint64_t)op[0] * 18052948469607658949UL) + ((uint64_t)op[1] * 1823028408051073808UL) + ((uint64_t)op[2] * 10163202227621904088UL) + ((uint64_t)op[3] * 10846822680092352945UL) + ((uint64_t)op[4] * 9711513040812756017UL) + ((((uint64_t)op[5] * 12003986053133796253UL) + ((uint64_t)op[6] * 9524335271146308589UL)) * 18446744073709551612);
	tmp_q[5] = ((uint64_t)op[0] * 9524335271146308589UL) + ((uint64_t)op[1] * 18052948469607658949UL) + ((uint64_t)op[2] * 1823028408051073808UL) + ((uint64_t)op[3] * 10163202227621904088UL) + ((uint64_t)op[4] * 10846822680092352945UL) + ((uint64_t)op[5] * 9711513040812756017UL) + ((uint64_t)op[6] * 7324288008593469836UL);
	tmp_q[6] = ((uint64_t)op[0] * 12003986053133796253UL) + ((uint64_t)op[1] * 9524335271146308589UL) + ((uint64_t)op[2] * 18052948469607658949UL) + ((uint64_t)op[3] * 1823028408051073808UL) + ((uint64_t)op[4] * 10163202227621904088UL) + ((uint64_t)op[5] * 10846822680092352945UL) + ((uint64_t)op[6] * 9711513040812756017UL);
