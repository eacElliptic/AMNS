...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 18326097787473976849UL) + ((((uint64_t)op[1] * 2887224308262061131UL) + ((uint64_t)op[2] * 14011069347539808682UL) + ((uint64_t)op[3] * 4853096044353575609UL) + ((uint64_t)op[4] * 17616924472544751521UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 17616924472544751521UL) + ((uint64_t)op[1] * 18326097787473976849UL) + ((((uint64_t)op[2] * 2887224308262061131UL) + ((uint64_t)op[3] * 14011069347539808682UL) + ((uint64_t)op[4] * 4853096044353575609UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 4853096044353575609UL) + ((uint64_t)op[1] * 17616924472544751521UL) + ((uint64_t)op[2] * 18326097787473976849UL) + ((((uint64_t)op[3] * 2887224308262061131UL) + ((uint64_t)op[4] * 14011069347539808682UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 14011069347539808682UL) + ((uint64_t)op[1] * 4853096044353575609UL) + ((uint64_t)op[2] * 17616924472544751521UL) + ((uint64_t)op[3] * 18326097787473976849UL) + ((uint64_t)op[4] * 13795693681322614184UL);
	tmp_q[4] = ((uint64_t)op[0] * 2887224308262061131UL) + ((uint64_t)op[1] * 14011069347539808682UL) + ((uint64_t)op[2] * 4853096044353575609UL) + ((uint64_t)op[3] * 17616924472544751521UL) + ((uint64_t)op[4] * 18326097787473976849UL);
