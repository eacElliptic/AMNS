...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2215190822360613697UL) + ((((uint64_t)op[1] * 5374966148198020006UL) + ((uint64_t)op[2] * 835933969413287118UL) + ((uint64_t)op[3] * 14802545891985544074UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 14802545891985544074UL) + ((uint64_t)op[1] * 2215190822360613697UL) + ((((uint64_t)op[2] * 5374966148198020006UL) + ((uint64_t)op[3] * 835933969413287118UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 835933969413287118UL) + ((uint64_t)op[1] * 14802545891985544074UL) + ((uint64_t)op[2] * 2215190822360613697UL) + ((uint64_t)op[3] * 10018657406429003202UL);
	tmp_q[3] = ((uint64_t)op[0] * 5374966148198020006UL) + ((uint64_t)op[1] * 835933969413287118UL) + ((uint64_t)op[2] * 14802545891985544074UL) + ((uint64_t)op[3] * 2215190822360613697UL);
