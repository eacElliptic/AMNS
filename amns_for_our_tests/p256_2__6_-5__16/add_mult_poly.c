...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11794774909943575674UL) + ((((uint64_t)op[1] * 3759683516736399879UL) + ((uint64_t)op[2] * 12906876996705714693UL) + ((uint64_t)op[3] * 8670760365779699297UL) + ((uint64_t)op[4] * 17775042349634122743UL) + ((uint64_t)op[5] * 17839135669603212895UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 17839135669603212895UL) + ((uint64_t)op[1] * 11794774909943575674UL) + ((((uint64_t)op[2] * 3759683516736399879UL) + ((uint64_t)op[3] * 12906876996705714693UL) + ((uint64_t)op[4] * 8670760365779699297UL) + ((uint64_t)op[5] * 17775042349634122743UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 17775042349634122743UL) + ((uint64_t)op[1] * 17839135669603212895UL) + ((uint64_t)op[2] * 11794774909943575674UL) + ((((uint64_t)op[3] * 3759683516736399879UL) + ((uint64_t)op[4] * 12906876996705714693UL) + ((uint64_t)op[5] * 8670760365779699297UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 8670760365779699297UL) + ((uint64_t)op[1] * 17775042349634122743UL) + ((uint64_t)op[2] * 17839135669603212895UL) + ((uint64_t)op[3] * 11794774909943575674UL) + ((((uint64_t)op[4] * 3759683516736399879UL) + ((uint64_t)op[5] * 12906876996705714693UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 12906876996705714693UL) + ((uint64_t)op[1] * 8670760365779699297UL) + ((uint64_t)op[2] * 17775042349634122743UL) + ((uint64_t)op[3] * 17839135669603212895UL) + ((uint64_t)op[4] * 11794774909943575674UL) + ((uint64_t)op[5] * 18095070563737103837UL);
	tmp_q[5] = ((uint64_t)op[0] * 3759683516736399879UL) + ((uint64_t)op[1] * 12906876996705714693UL) + ((uint64_t)op[2] * 8670760365779699297UL) + ((uint64_t)op[3] * 17775042349634122743UL) + ((uint64_t)op[4] * 17839135669603212895UL) + ((uint64_t)op[5] * 11794774909943575674UL);
