...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3564921459781272187UL) + ((((uint64_t)op[1] * 15315157880421655673UL) + ((uint64_t)op[2] * 17209536627171127320UL) + ((uint64_t)op[3] * 1525807361391803244UL) + ((uint64_t)op[4] * 3165010235347962359UL)) * 4);
	tmp_q[1] = ((uint64_t)op[0] * 3165010235347962359UL) + ((uint64_t)op[1] * 3564921459781272187UL) + ((((uint64_t)op[2] * 15315157880421655673UL) + ((uint64_t)op[3] * 17209536627171127320UL) + ((uint64_t)op[4] * 1525807361391803244UL)) * 4);
	tmp_q[2] = ((uint64_t)op[0] * 1525807361391803244UL) + ((uint64_t)op[1] * 3165010235347962359UL) + ((uint64_t)op[2] * 3564921459781272187UL) + ((((uint64_t)op[3] * 15315157880421655673UL) + ((uint64_t)op[4] * 17209536627171127320UL)) * 4);
	tmp_q[3] = ((uint64_t)op[0] * 17209536627171127320UL) + ((uint64_t)op[1] * 1525807361391803244UL) + ((uint64_t)op[2] * 3165010235347962359UL) + ((uint64_t)op[3] * 3564921459781272187UL) + ((uint64_t)op[4] * 5920399300557967844UL);
	tmp_q[4] = ((uint64_t)op[0] * 15315157880421655673UL) + ((uint64_t)op[1] * 17209536627171127320UL) + ((uint64_t)op[2] * 1525807361391803244UL) + ((uint64_t)op[3] * 3165010235347962359UL) + ((uint64_t)op[4] * 3564921459781272187UL);
