...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12007769933841827968UL) + ((((uint64_t)op[1] * 3533190030156221260UL) + ((uint64_t)op[2] * 1733740523334937843UL) + ((uint64_t)op[3] * 12179887422360797936UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 12179887422360797936UL) + ((uint64_t)op[1] * 12007769933841827968UL) + ((((uint64_t)op[2] * 3533190030156221260UL) + ((uint64_t)op[3] * 1733740523334937843UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 1733740523334937843UL) + ((uint64_t)op[1] * 12179887422360797936UL) + ((uint64_t)op[2] * 12007769933841827968UL) + ((uint64_t)op[3] * 7847173983240887836UL);
	tmp_q[3] = ((uint64_t)op[0] * 3533190030156221260UL) + ((uint64_t)op[1] * 1733740523334937843UL) + ((uint64_t)op[2] * 12179887422360797936UL) + ((uint64_t)op[3] * 12007769933841827968UL);
