...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16007742681197458855UL) + ((((uint64_t)op[1] * 11643484610224921865UL) + ((uint64_t)op[2] * 5795705322575667829UL) + ((uint64_t)op[3] * 8693163330431543580UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 8693163330431543580UL) + ((uint64_t)op[1] * 16007742681197458855UL) + ((((uint64_t)op[2] * 11643484610224921865UL) + ((uint64_t)op[3] * 5795705322575667829UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 5795705322575667829UL) + ((uint64_t)op[1] * 8693163330431543580UL) + ((uint64_t)op[2] * 16007742681197458855UL) + ((uint64_t)op[3] * 3926068633488675274UL);
	tmp_q[3] = ((uint64_t)op[0] * 11643484610224921865UL) + ((uint64_t)op[1] * 5795705322575667829UL) + ((uint64_t)op[2] * 8693163330431543580UL) + ((uint64_t)op[3] * 16007742681197458855UL);
