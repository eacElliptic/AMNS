...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12412702324121363716UL) + ((((uint64_t)op[1] * 128679142214506023UL) + ((uint64_t)op[2] * 13033681375999968009UL) + ((uint64_t)op[3] * 8438783534870542003UL) + ((uint64_t)op[4] * 14172698908166640300UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 14172698908166640300UL) + ((uint64_t)op[1] * 12412702324121363716UL) + ((((uint64_t)op[2] * 128679142214506023UL) + ((uint64_t)op[3] * 13033681375999968009UL) + ((uint64_t)op[4] * 8438783534870542003UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 8438783534870542003UL) + ((uint64_t)op[1] * 14172698908166640300UL) + ((uint64_t)op[2] * 12412702324121363716UL) + ((((uint64_t)op[3] * 128679142214506023UL) + ((uint64_t)op[4] * 13033681375999968009UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 13033681375999968009UL) + ((uint64_t)op[1] * 8438783534870542003UL) + ((uint64_t)op[2] * 14172698908166640300UL) + ((uint64_t)op[3] * 12412702324121363716UL) + ((uint64_t)op[4] * 17545990078208009455UL);
	tmp_q[4] = ((uint64_t)op[0] * 128679142214506023UL) + ((uint64_t)op[1] * 13033681375999968009UL) + ((uint64_t)op[2] * 8438783534870542003UL) + ((uint64_t)op[3] * 14172698908166640300UL) + ((uint64_t)op[4] * 12412702324121363716UL);
