...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17208272469417034426UL) + ((((uint64_t)op[1] * 9183635126891911600UL) + ((uint64_t)op[2] * 12463428869298639782UL) + ((uint64_t)op[3] * 8490702294073102620UL) + ((uint64_t)op[4] * 2965586844283431469UL) + ((uint64_t)op[5] * 15099814262289494593UL) + ((uint64_t)op[6] * 17481292273914176535UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 17481292273914176535UL) + ((uint64_t)op[1] * 17208272469417034426UL) + ((((uint64_t)op[2] * 9183635126891911600UL) + ((uint64_t)op[3] * 12463428869298639782UL) + ((uint64_t)op[4] * 8490702294073102620UL) + ((uint64_t)op[5] * 2965586844283431469UL) + ((uint64_t)op[6] * 15099814262289494593UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 15099814262289494593UL) + ((uint64_t)op[1] * 17481292273914176535UL) + ((uint64_t)op[2] * 17208272469417034426UL) + ((((uint64_t)op[3] * 9183635126891911600UL) + ((uint64_t)op[4] * 12463428869298639782UL) + ((uint64_t)op[5] * 8490702294073102620UL) + ((uint64_t)op[6] * 2965586844283431469UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 2965586844283431469UL) + ((uint64_t)op[1] * 15099814262289494593UL) + ((uint64_t)op[2] * 17481292273914176535UL) + ((uint64_t)op[3] * 17208272469417034426UL) + ((((uint64_t)op[4] * 9183635126891911600UL) + ((uint64_t)op[5] * 12463428869298639782UL) + ((uint64_t)op[6] * 8490702294073102620UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 8490702294073102620UL) + ((uint64_t)op[1] * 2965586844283431469UL) + ((uint64_t)op[2] * 15099814262289494593UL) + ((uint64_t)op[3] * 17481292273914176535UL) + ((uint64_t)op[4] * 17208272469417034426UL) + ((((uint64_t)op[5] * 9183635126891911600UL) + ((uint64_t)op[6] * 12463428869298639782UL)) * 18446744073709551611);
	tmp_q[5] = ((uint64_t)op[0] * 12463428869298639782UL) + ((uint64_t)op[1] * 8490702294073102620UL) + ((uint64_t)op[2] * 2965586844283431469UL) + ((uint64_t)op[3] * 15099814262289494593UL) + ((uint64_t)op[4] * 17481292273914176535UL) + ((uint64_t)op[5] * 17208272469417034426UL) + ((uint64_t)op[6] * 9422056586669096848UL);
	tmp_q[6] = ((uint64_t)op[0] * 9183635126891911600UL) + ((uint64_t)op[1] * 12463428869298639782UL) + ((uint64_t)op[2] * 8490702294073102620UL) + ((uint64_t)op[3] * 2965586844283431469UL) + ((uint64_t)op[4] * 15099814262289494593UL) + ((uint64_t)op[5] * 17481292273914176535UL) + ((uint64_t)op[6] * 17208272469417034426UL);
