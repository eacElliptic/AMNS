...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11433349347645142975UL) + ((((uint64_t)op[1] * 11450045966638690620UL) + ((uint64_t)op[2] * 8267912204764993029UL) + ((uint64_t)op[3] * 11149458488983419625UL) + ((uint64_t)op[4] * 18437430306706813568UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 18437430306706813568UL) + ((uint64_t)op[1] * 11433349347645142975UL) + ((((uint64_t)op[2] * 11450045966638690620UL) + ((uint64_t)op[3] * 8267912204764993029UL) + ((uint64_t)op[4] * 11149458488983419625UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 11149458488983419625UL) + ((uint64_t)op[1] * 18437430306706813568UL) + ((uint64_t)op[2] * 11433349347645142975UL) + ((((uint64_t)op[3] * 11450045966638690620UL) + ((uint64_t)op[4] * 8267912204764993029UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 8267912204764993029UL) + ((uint64_t)op[1] * 11149458488983419625UL) + ((uint64_t)op[2] * 18437430306706813568UL) + ((uint64_t)op[3] * 11433349347645142975UL) + ((uint64_t)op[4] * 12083398602076923740UL);
	tmp_q[4] = ((uint64_t)op[0] * 11450045966638690620UL) + ((uint64_t)op[1] * 8267912204764993029UL) + ((uint64_t)op[2] * 11149458488983419625UL) + ((uint64_t)op[3] * 18437430306706813568UL) + ((uint64_t)op[4] * 11433349347645142975UL);
