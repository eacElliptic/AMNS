...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10752056128082062931UL) + ((((uint64_t)op[1] * 15036470861897899653UL) + ((uint64_t)op[2] * 15463762894516153499UL) + ((uint64_t)op[3] * 10873980292445264822UL) + ((uint64_t)op[4] * 9743213971323689317UL) + ((uint64_t)op[5] * 6226472646285889159UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 6226472646285889159UL) + ((uint64_t)op[1] * 10752056128082062931UL) + ((((uint64_t)op[2] * 15036470861897899653UL) + ((uint64_t)op[3] * 15463762894516153499UL) + ((uint64_t)op[4] * 10873980292445264822UL) + ((uint64_t)op[5] * 9743213971323689317UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 9743213971323689317UL) + ((uint64_t)op[1] * 6226472646285889159UL) + ((uint64_t)op[2] * 10752056128082062931UL) + ((((uint64_t)op[3] * 15036470861897899653UL) + ((uint64_t)op[4] * 15463762894516153499UL) + ((uint64_t)op[5] * 10873980292445264822UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 10873980292445264822UL) + ((uint64_t)op[1] * 9743213971323689317UL) + ((uint64_t)op[2] * 6226472646285889159UL) + ((uint64_t)op[3] * 10752056128082062931UL) + ((((uint64_t)op[4] * 15036470861897899653UL) + ((uint64_t)op[5] * 15463762894516153499UL)) * 18446744073709551613);
	tmp_q[4] = ((uint64_t)op[0] * 15463762894516153499UL) + ((uint64_t)op[1] * 10873980292445264822UL) + ((uint64_t)op[2] * 9743213971323689317UL) + ((uint64_t)op[3] * 6226472646285889159UL) + ((uint64_t)op[4] * 10752056128082062931UL) + ((uint64_t)op[5] * 10230819635434955889UL);
	tmp_q[5] = ((uint64_t)op[0] * 15036470861897899653UL) + ((uint64_t)op[1] * 15463762894516153499UL) + ((uint64_t)op[2] * 10873980292445264822UL) + ((uint64_t)op[3] * 9743213971323689317UL) + ((uint64_t)op[4] * 6226472646285889159UL) + ((uint64_t)op[5] * 10752056128082062931UL);
