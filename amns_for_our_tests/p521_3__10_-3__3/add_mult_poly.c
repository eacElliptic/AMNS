...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8500764684742638647UL) + ((((uint64_t)op[1] * 17629625551606160677UL) + ((uint64_t)op[2] * 16975901531116530631UL) + ((uint64_t)op[3] * 18202253505623178728UL) + ((uint64_t)op[4] * 15415496565806850443UL) + ((uint64_t)op[5] * 2803312231869001829UL) + ((uint64_t)op[6] * 5498157359073100129UL) + ((uint64_t)op[7] * 8134912577998312117UL) + ((uint64_t)op[8] * 16916042393422109713UL) + ((uint64_t)op[9] * 403101767405704575UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 403101767405704575UL) + ((uint64_t)op[1] * 8500764684742638647UL) + ((((uint64_t)op[2] * 17629625551606160677UL) + ((uint64_t)op[3] * 16975901531116530631UL) + ((uint64_t)op[4] * 18202253505623178728UL) + ((uint64_t)op[5] * 15415496565806850443UL) + ((uint64_t)op[6] * 2803312231869001829UL) + ((uint64_t)op[7] * 5498157359073100129UL) + ((uint64_t)op[8] * 8134912577998312117UL) + ((uint64_t)op[9] * 16916042393422109713UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 16916042393422109713UL) + ((uint64_t)op[1] * 403101767405704575UL) + ((uint64_t)op[2] * 8500764684742638647UL) + ((((uint64_t)op[3] * 17629625551606160677UL) + ((uint64_t)op[4] * 16975901531116530631UL) + ((uint64_t)op[5] * 18202253505623178728UL) + ((uint64_t)op[6] * 15415496565806850443UL) + ((uint64_t)op[7] * 2803312231869001829UL) + ((uint64_t)op[8] * 5498157359073100129UL) + ((uint64_t)op[9] * 8134912577998312117UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 8134912577998312117UL) + ((uint64_t)op[1] * 16916042393422109713UL) + ((uint64_t)op[2] * 403101767405704575UL) + ((uint64_t)op[3] * 8500764684742638647UL) + ((((uint64_t)op[4] * 17629625551606160677UL) + ((uint64_t)op[5] * 16975901531116530631UL) + ((uint64_t)op[6] * 18202253505623178728UL) + ((uint64_t)op[7] * 15415496565806850443UL) + ((uint64_t)op[8] * 2803312231869001829UL) + ((uint64_t)op[9] * 5498157359073100129UL)) * 18446744073709551613);
	tmp_q[4] = ((uint64_t)op[0] * 5498157359073100129UL) + ((uint64_t)op[1] * 8134912577998312117UL) + ((uint64_t)op[2] * 16916042393422109713UL) + ((uint64_t)op[3] * 403101767405704575UL) + ((uint64_t)op[4] * 8500764684742638647UL) + ((((uint64_t)op[5] * 17629625551606160677UL) + ((uint64_t)op[6] * 16975901531116530631UL) + ((uint64_t)op[7] * 18202253505623178728UL) + ((uint64_t)op[8] * 15415496565806850443UL) + ((uint64_t)op[9] * 2803312231869001829UL)) * 18446744073709551613);
	tmp_q[5] = ((uint64_t)op[0] * 2803312231869001829UL) + ((uint64_t)op[1] * 5498157359073100129UL) + ((uint64_t)op[2] * 8134912577998312117UL) + ((uint64_t)op[3] * 16916042393422109713UL) + ((uint64_t)op[4] * 403101767405704575UL) + ((uint64_t)op[5] * 8500764684742638647UL) + ((((uint64_t)op[6] * 17629625551606160677UL) + ((uint64_t)op[7] * 16975901531116530631UL) + ((uint64_t)op[8] * 18202253505623178728UL) + ((uint64_t)op[9] * 15415496565806850443UL)) * 18446744073709551613);
	tmp_q[6] = ((uint64_t)op[0] * 15415496565806850443UL) + ((uint64_t)op[1] * 2803312231869001829UL) + ((uint64_t)op[2] * 5498157359073100129UL) + ((uint64_t)op[3] * 8134912577998312117UL) + ((uint64_t)op[4] * 16916042393422109713UL) + ((uint64_t)op[5] * 403101767405704575UL) + ((uint64_t)op[6] * 8500764684742638647UL) + ((((uint64_t)op[7] * 17629625551606160677UL) + ((uint64_t)op[8] * 16975901531116530631UL) + ((uint64_t)op[9] * 18202253505623178728UL)) * 18446744073709551613);
	tmp_q[7] = ((uint64_t)op[0] * 18202253505623178728UL) + ((uint64_t)op[1] * 15415496565806850443UL) + ((uint64_t)op[2] * 2803312231869001829UL) + ((uint64_t)op[3] * 5498157359073100129UL) + ((uint64_t)op[4] * 8134912577998312117UL) + ((uint64_t)op[5] * 16916042393422109713UL) + ((uint64_t)op[6] * 403101767405704575UL) + ((uint64_t)op[7] * 8500764684742638647UL) + ((((uint64_t)op[8] * 17629625551606160677UL) + ((uint64_t)op[9] * 16975901531116530631UL)) * 18446744073709551613);
	tmp_q[8] = ((uint64_t)op[0] * 16975901531116530631UL) + ((uint64_t)op[1] * 18202253505623178728UL) + ((uint64_t)op[2] * 15415496565806850443UL) + ((uint64_t)op[3] * 2803312231869001829UL) + ((uint64_t)op[4] * 5498157359073100129UL) + ((uint64_t)op[5] * 8134912577998312117UL) + ((uint64_t)op[6] * 16916042393422109713UL) + ((uint64_t)op[7] * 403101767405704575UL) + ((uint64_t)op[8] * 8500764684742638647UL) + ((uint64_t)op[9] * 2451355566310172817UL);
	tmp_q[9] = ((uint64_t)op[0] * 17629625551606160677UL) + ((uint64_t)op[1] * 16975901531116530631UL) + ((uint64_t)op[2] * 18202253505623178728UL) + ((uint64_t)op[3] * 15415496565806850443UL) + ((uint64_t)op[4] * 2803312231869001829UL) + ((uint64_t)op[5] * 5498157359073100129UL) + ((uint64_t)op[6] * 8134912577998312117UL) + ((uint64_t)op[7] * 16916042393422109713UL) + ((uint64_t)op[8] * 403101767405704575UL) + ((uint64_t)op[9] * 8500764684742638647UL);
