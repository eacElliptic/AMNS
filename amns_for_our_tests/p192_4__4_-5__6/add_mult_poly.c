...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15643430833819115965UL) + ((((uint64_t)op[1] * 5366641324508039829UL) + ((uint64_t)op[2] * 17598401686789740085UL) + ((uint64_t)op[3] * 14206304064543319910UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 14206304064543319910UL) + ((uint64_t)op[1] * 15643430833819115965UL) + ((((uint64_t)op[2] * 5366641324508039829UL) + ((uint64_t)op[3] * 17598401686789740085UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 17598401686789740085UL) + ((uint64_t)op[1] * 14206304064543319910UL) + ((uint64_t)op[2] * 15643430833819115965UL) + ((uint64_t)op[3] * 10060281524878904087UL);
	tmp_q[3] = ((uint64_t)op[0] * 5366641324508039829UL) + ((uint64_t)op[1] * 17598401686789740085UL) + ((uint64_t)op[2] * 14206304064543319910UL) + ((uint64_t)op[3] * 15643430833819115965UL);
