...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8267942303192769044UL) + ((((uint64_t)op[1] * 1005558951572469417UL) + ((uint64_t)op[2] * 14308257834820564431UL) + ((uint64_t)op[3] * 12754974915497450973UL)) * 18446744073709551615);
	tmp_q[1] = ((uint64_t)op[0] * 12754974915497450973UL) + ((uint64_t)op[1] * 8267942303192769044UL) + ((((uint64_t)op[2] * 1005558951572469417UL) + ((uint64_t)op[3] * 14308257834820564431UL)) * 18446744073709551615);
	tmp_q[2] = ((uint64_t)op[0] * 14308257834820564431UL) + ((uint64_t)op[1] * 12754974915497450973UL) + ((uint64_t)op[2] * 8267942303192769044UL) + ((uint64_t)op[3] * 17441185122137082199UL);
	tmp_q[3] = ((uint64_t)op[0] * 1005558951572469417UL) + ((uint64_t)op[1] * 14308257834820564431UL) + ((uint64_t)op[2] * 12754974915497450973UL) + ((uint64_t)op[3] * 8267942303192769044UL);
