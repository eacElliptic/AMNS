...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1295451224129235079UL) + ((((uint64_t)op[1] * 18101561897303856579UL) + ((uint64_t)op[2] * 15883458953462542526UL) + ((uint64_t)op[3] * 16592122094397941222UL) + ((uint64_t)op[4] * 44498175930170337UL) + ((uint64_t)op[5] * 10747653409561832108UL)) * 18446744073709551612);
	tmp_q[1] = ((uint64_t)op[0] * 10747653409561832108UL) + ((uint64_t)op[1] * 1295451224129235079UL) + ((((uint64_t)op[2] * 18101561897303856579UL) + ((uint64_t)op[3] * 15883458953462542526UL) + ((uint64_t)op[4] * 16592122094397941222UL) + ((uint64_t)op[5] * 44498175930170337UL)) * 18446744073709551612);
	tmp_q[2] = ((uint64_t)op[0] * 44498175930170337UL) + ((uint64_t)op[1] * 10747653409561832108UL) + ((uint64_t)op[2] * 1295451224129235079UL) + ((((uint64_t)op[3] * 18101561897303856579UL) + ((uint64_t)op[4] * 15883458953462542526UL) + ((uint64_t)op[5] * 16592122094397941222UL)) * 18446744073709551612);
	tmp_q[3] = ((uint64_t)op[0] * 16592122094397941222UL) + ((uint64_t)op[1] * 44498175930170337UL) + ((uint64_t)op[2] * 10747653409561832108UL) + ((uint64_t)op[3] * 1295451224129235079UL) + ((((uint64_t)op[4] * 18101561897303856579UL) + ((uint64_t)op[5] * 15883458953462542526UL)) * 18446744073709551612);
	tmp_q[4] = ((uint64_t)op[0] * 15883458953462542526UL) + ((uint64_t)op[1] * 16592122094397941222UL) + ((uint64_t)op[2] * 44498175930170337UL) + ((uint64_t)op[3] * 10747653409561832108UL) + ((uint64_t)op[4] * 1295451224129235079UL) + ((uint64_t)op[5] * 1380728705622780148UL);
	tmp_q[5] = ((uint64_t)op[0] * 18101561897303856579UL) + ((uint64_t)op[1] * 15883458953462542526UL) + ((uint64_t)op[2] * 16592122094397941222UL) + ((uint64_t)op[3] * 44498175930170337UL) + ((uint64_t)op[4] * 10747653409561832108UL) + ((uint64_t)op[5] * 1295451224129235079UL);
