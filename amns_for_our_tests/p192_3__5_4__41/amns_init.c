...
void init_data(){
	...
	mpz_set_str (modul_p, "5188114531784720556807958443053228979127460137472088413737", 10);

	mpz_set_str (gama_pow[0], "1408806233604015291048088211084645303274271590869644028811", 10);
