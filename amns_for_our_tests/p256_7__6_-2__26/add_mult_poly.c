...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6013402998733058327UL) + ((((uint64_t)op[1] * 790305740431130726UL) + ((uint64_t)op[2] * 11549745424084401992UL) + ((uint64_t)op[3] * 5619996858377980416UL) + ((uint64_t)op[4] * 342855405556445914UL) + ((uint64_t)op[5] * 2535597393961602798UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 2535597393961602798UL) + ((uint64_t)op[1] * 6013402998733058327UL) + ((((uint64_t)op[2] * 790305740431130726UL) + ((uint64_t)op[3] * 11549745424084401992UL) + ((uint64_t)op[4] * 5619996858377980416UL) + ((uint64_t)op[5] * 342855405556445914UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 342855405556445914UL) + ((uint64_t)op[1] * 2535597393961602798UL) + ((uint64_t)op[2] * 6013402998733058327UL) + ((((uint64_t)op[3] * 790305740431130726UL) + ((uint64_t)op[4] * 11549745424084401992UL) + ((uint64_t)op[5] * 5619996858377980416UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 5619996858377980416UL) + ((uint64_t)op[1] * 342855405556445914UL) + ((uint64_t)op[2] * 2535597393961602798UL) + ((uint64_t)op[3] * 6013402998733058327UL) + ((((uint64_t)op[4] * 790305740431130726UL) + ((uint64_t)op[5] * 11549745424084401992UL)) * 18446744073709551614);
	tmp_q[4] = ((uint64_t)op[0] * 11549745424084401992UL) + ((uint64_t)op[1] * 5619996858377980416UL) + ((uint64_t)op[2] * 342855405556445914UL) + ((uint64_t)op[3] * 2535597393961602798UL) + ((uint64_t)op[4] * 6013402998733058327UL) + ((uint64_t)op[5] * 16866132592847290164UL);
	tmp_q[5] = ((uint64_t)op[0] * 790305740431130726UL) + ((uint64_t)op[1] * 11549745424084401992UL) + ((uint64_t)op[2] * 5619996858377980416UL) + ((uint64_t)op[3] * 342855405556445914UL) + ((uint64_t)op[4] * 2535597393961602798UL) + ((uint64_t)op[5] * 6013402998733058327UL);
