...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2237879994671164728UL) + ((((uint64_t)op[1] * 14086888378839534326UL) + ((uint64_t)op[2] * 1754221312519111341UL) + ((uint64_t)op[3] * 604622552830003067UL) + ((uint64_t)op[4] * 14397233371798796925UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 14397233371798796925UL) + ((uint64_t)op[1] * 2237879994671164728UL) + ((((uint64_t)op[2] * 14086888378839534326UL) + ((uint64_t)op[3] * 1754221312519111341UL) + ((uint64_t)op[4] * 604622552830003067UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 604622552830003067UL) + ((uint64_t)op[1] * 14397233371798796925UL) + ((uint64_t)op[2] * 2237879994671164728UL) + ((((uint64_t)op[3] * 14086888378839534326UL) + ((uint64_t)op[4] * 1754221312519111341UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 1754221312519111341UL) + ((uint64_t)op[1] * 604622552830003067UL) + ((uint64_t)op[2] * 14397233371798796925UL) + ((uint64_t)op[3] * 2237879994671164728UL) + ((uint64_t)op[4] * 13079567084610051870UL);
	tmp_q[4] = ((uint64_t)op[0] * 14086888378839534326UL) + ((uint64_t)op[1] * 1754221312519111341UL) + ((uint64_t)op[2] * 604622552830003067UL) + ((uint64_t)op[3] * 14397233371798796925UL) + ((uint64_t)op[4] * 2237879994671164728UL);
