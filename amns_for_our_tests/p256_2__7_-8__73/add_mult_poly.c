...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 18054503162246253377UL) + ((((uint64_t)op[1] * 6445158496448159872UL) + ((uint64_t)op[2] * 7555640643921290963UL) + ((uint64_t)op[3] * 9390622438804773131UL) + ((uint64_t)op[4] * 3103442584058804443UL) + ((uint64_t)op[5] * 6671969937432533122UL) + ((uint64_t)op[6] * 13208013625411377890UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 13208013625411377890UL) + ((uint64_t)op[1] * 18054503162246253377UL) + ((((uint64_t)op[2] * 6445158496448159872UL) + ((uint64_t)op[3] * 7555640643921290963UL) + ((uint64_t)op[4] * 9390622438804773131UL) + ((uint64_t)op[5] * 3103442584058804443UL) + ((uint64_t)op[6] * 6671969937432533122UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 6671969937432533122UL) + ((uint64_t)op[1] * 13208013625411377890UL) + ((uint64_t)op[2] * 18054503162246253377UL) + ((((uint64_t)op[3] * 6445158496448159872UL) + ((uint64_t)op[4] * 7555640643921290963UL) + ((uint64_t)op[5] * 9390622438804773131UL) + ((uint64_t)op[6] * 3103442584058804443UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 3103442584058804443UL) + ((uint64_t)op[1] * 6671969937432533122UL) + ((uint64_t)op[2] * 13208013625411377890UL) + ((uint64_t)op[3] * 18054503162246253377UL) + ((((uint64_t)op[4] * 6445158496448159872UL) + ((uint64_t)op[5] * 7555640643921290963UL) + ((uint64_t)op[6] * 9390622438804773131UL)) * 18446744073709551608);
	tmp_q[4] = ((uint64_t)op[0] * 9390622438804773131UL) + ((uint64_t)op[1] * 3103442584058804443UL) + ((uint64_t)op[2] * 6671969937432533122UL) + ((uint64_t)op[3] * 13208013625411377890UL) + ((uint64_t)op[4] * 18054503162246253377UL) + ((((uint64_t)op[5] * 6445158496448159872UL) + ((uint64_t)op[6] * 7555640643921290963UL)) * 18446744073709551608);
	tmp_q[5] = ((uint64_t)op[0] * 7555640643921290963UL) + ((uint64_t)op[1] * 9390622438804773131UL) + ((uint64_t)op[2] * 3103442584058804443UL) + ((uint64_t)op[3] * 6671969937432533122UL) + ((uint64_t)op[4] * 13208013625411377890UL) + ((uint64_t)op[5] * 18054503162246253377UL) + ((uint64_t)op[6] * 3778964249543375872UL);
	tmp_q[6] = ((uint64_t)op[0] * 6445158496448159872UL) + ((uint64_t)op[1] * 7555640643921290963UL) + ((uint64_t)op[2] * 9390622438804773131UL) + ((uint64_t)op[3] * 3103442584058804443UL) + ((uint64_t)op[4] * 6671969937432533122UL) + ((uint64_t)op[5] * 13208013625411377890UL) + ((uint64_t)op[6] * 18054503162246253377UL);
