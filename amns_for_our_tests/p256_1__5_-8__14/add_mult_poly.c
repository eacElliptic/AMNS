...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8721700962609836323UL) + ((((uint64_t)op[1] * 2664881810542079634UL) + ((uint64_t)op[2] * 10078539150162164316UL) + ((uint64_t)op[3] * 1649493958188036816UL) + ((uint64_t)op[4] * 13611714509585427280UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 13611714509585427280UL) + ((uint64_t)op[1] * 8721700962609836323UL) + ((((uint64_t)op[2] * 2664881810542079634UL) + ((uint64_t)op[3] * 10078539150162164316UL) + ((uint64_t)op[4] * 1649493958188036816UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 1649493958188036816UL) + ((uint64_t)op[1] * 13611714509585427280UL) + ((uint64_t)op[2] * 8721700962609836323UL) + ((((uint64_t)op[3] * 2664881810542079634UL) + ((uint64_t)op[4] * 10078539150162164316UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 10078539150162164316UL) + ((uint64_t)op[1] * 1649493958188036816UL) + ((uint64_t)op[2] * 13611714509585427280UL) + ((uint64_t)op[3] * 8721700962609836323UL) + ((uint64_t)op[4] * 15574433663082466160UL);
	tmp_q[4] = ((uint64_t)op[0] * 2664881810542079634UL) + ((uint64_t)op[1] * 10078539150162164316UL) + ((uint64_t)op[2] * 1649493958188036816UL) + ((uint64_t)op[3] * 13611714509585427280UL) + ((uint64_t)op[4] * 8721700962609836323UL);
