...
void init_data(){
	...
	mpz_set_str (modul_p, "4241674529099331390960323502811163367093776157756351131747", 10);

	mpz_set_str (gama_pow[0], "1932378191434321298453929758608406683530014703798480815268", 10);
