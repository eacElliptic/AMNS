...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12030442742899727789UL) + ((((uint64_t)op[1] * 1594089333880806781UL) + ((uint64_t)op[2] * 4572708108068965370UL) + ((uint64_t)op[3] * 6552569562813210010UL) + ((uint64_t)op[4] * 2258431535168610666UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 2258431535168610666UL) + ((uint64_t)op[1] * 12030442742899727789UL) + ((((uint64_t)op[2] * 1594089333880806781UL) + ((uint64_t)op[3] * 4572708108068965370UL) + ((uint64_t)op[4] * 6552569562813210010UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 6552569562813210010UL) + ((uint64_t)op[1] * 2258431535168610666UL) + ((uint64_t)op[2] * 12030442742899727789UL) + ((((uint64_t)op[3] * 1594089333880806781UL) + ((uint64_t)op[4] * 4572708108068965370UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 4572708108068965370UL) + ((uint64_t)op[1] * 6552569562813210010UL) + ((uint64_t)op[2] * 2258431535168610666UL) + ((uint64_t)op[3] * 12030442742899727789UL) + ((uint64_t)op[4] * 9564536003284840686UL);
	tmp_q[4] = ((uint64_t)op[0] * 1594089333880806781UL) + ((uint64_t)op[1] * 4572708108068965370UL) + ((uint64_t)op[2] * 6552569562813210010UL) + ((uint64_t)op[3] * 2258431535168610666UL) + ((uint64_t)op[4] * 12030442742899727789UL);
