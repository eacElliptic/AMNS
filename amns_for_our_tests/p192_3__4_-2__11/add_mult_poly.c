...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16181781984146843589UL) + ((((uint64_t)op[1] * 8044376621713641244UL) + ((uint64_t)op[2] * 7983924036477186745UL) + ((uint64_t)op[3] * 15744395757362088232UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 15744395757362088232UL) + ((uint64_t)op[1] * 16181781984146843589UL) + ((((uint64_t)op[2] * 8044376621713641244UL) + ((uint64_t)op[3] * 7983924036477186745UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 7983924036477186745UL) + ((uint64_t)op[1] * 15744395757362088232UL) + ((uint64_t)op[2] * 16181781984146843589UL) + ((uint64_t)op[3] * 2357990830282269128UL);
	tmp_q[3] = ((uint64_t)op[0] * 8044376621713641244UL) + ((uint64_t)op[1] * 7983924036477186745UL) + ((uint64_t)op[2] * 15744395757362088232UL) + ((uint64_t)op[3] * 16181781984146843589UL);
