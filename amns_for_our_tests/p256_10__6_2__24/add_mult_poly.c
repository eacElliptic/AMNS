...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11337178660009888593UL) + ((((uint64_t)op[1] * 3097461220727848028UL) + ((uint64_t)op[2] * 15039242982457981184UL) + ((uint64_t)op[3] * 11138993243180048803UL) + ((uint64_t)op[4] * 17502397674372328731UL) + ((uint64_t)op[5] * 3281184217743361352UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 3281184217743361352UL) + ((uint64_t)op[1] * 11337178660009888593UL) + ((((uint64_t)op[2] * 3097461220727848028UL) + ((uint64_t)op[3] * 15039242982457981184UL) + ((uint64_t)op[4] * 11138993243180048803UL) + ((uint64_t)op[5] * 17502397674372328731UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 17502397674372328731UL) + ((uint64_t)op[1] * 3281184217743361352UL) + ((uint64_t)op[2] * 11337178660009888593UL) + ((((uint64_t)op[3] * 3097461220727848028UL) + ((uint64_t)op[4] * 15039242982457981184UL) + ((uint64_t)op[5] * 11138993243180048803UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 11138993243180048803UL) + ((uint64_t)op[1] * 17502397674372328731UL) + ((uint64_t)op[2] * 3281184217743361352UL) + ((uint64_t)op[3] * 11337178660009888593UL) + ((((uint64_t)op[4] * 3097461220727848028UL) + ((uint64_t)op[5] * 15039242982457981184UL)) * 2);
	tmp_q[4] = ((uint64_t)op[0] * 15039242982457981184UL) + ((uint64_t)op[1] * 11138993243180048803UL) + ((uint64_t)op[2] * 17502397674372328731UL) + ((uint64_t)op[3] * 3281184217743361352UL) + ((uint64_t)op[4] * 11337178660009888593UL) + ((uint64_t)op[5] * 6194922441455696056UL);
	tmp_q[5] = ((uint64_t)op[0] * 3097461220727848028UL) + ((uint64_t)op[1] * 15039242982457981184UL) + ((uint64_t)op[2] * 11138993243180048803UL) + ((uint64_t)op[3] * 17502397674372328731UL) + ((uint64_t)op[4] * 3281184217743361352UL) + ((uint64_t)op[5] * 11337178660009888593UL);
