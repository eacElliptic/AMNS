...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11619570354369136193UL) + ((((uint64_t)op[1] * 17112576043856387913UL) + ((uint64_t)op[2] * 8360638793178637419UL) + ((uint64_t)op[3] * 3665043501370130409UL) + ((uint64_t)op[4] * 10535467247138101204UL) + ((uint64_t)op[5] * 2754478810157455281UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 2754478810157455281UL) + ((uint64_t)op[1] * 11619570354369136193UL) + ((((uint64_t)op[2] * 17112576043856387913UL) + ((uint64_t)op[3] * 8360638793178637419UL) + ((uint64_t)op[4] * 3665043501370130409UL) + ((uint64_t)op[5] * 10535467247138101204UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 10535467247138101204UL) + ((uint64_t)op[1] * 2754478810157455281UL) + ((uint64_t)op[2] * 11619570354369136193UL) + ((((uint64_t)op[3] * 17112576043856387913UL) + ((uint64_t)op[4] * 8360638793178637419UL) + ((uint64_t)op[5] * 3665043501370130409UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 3665043501370130409UL) + ((uint64_t)op[1] * 10535467247138101204UL) + ((uint64_t)op[2] * 2754478810157455281UL) + ((uint64_t)op[3] * 11619570354369136193UL) + ((((uint64_t)op[4] * 17112576043856387913UL) + ((uint64_t)op[5] * 8360638793178637419UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 8360638793178637419UL) + ((uint64_t)op[1] * 3665043501370130409UL) + ((uint64_t)op[2] * 10535467247138101204UL) + ((uint64_t)op[3] * 2754478810157455281UL) + ((uint64_t)op[4] * 11619570354369136193UL) + ((uint64_t)op[5] * 10441735894590569398UL);
	tmp_q[5] = ((uint64_t)op[0] * 17112576043856387913UL) + ((uint64_t)op[1] * 8360638793178637419UL) + ((uint64_t)op[2] * 3665043501370130409UL) + ((uint64_t)op[3] * 10535467247138101204UL) + ((uint64_t)op[4] * 2754478810157455281UL) + ((uint64_t)op[5] * 11619570354369136193UL);
