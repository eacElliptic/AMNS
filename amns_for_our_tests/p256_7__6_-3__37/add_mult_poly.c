...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7694687945627488685UL) + ((((uint64_t)op[1] * 15280273693953532939UL) + ((uint64_t)op[2] * 13842017160969907978UL) + ((uint64_t)op[3] * 10873980292445264822UL) + ((uint64_t)op[4] * 9987016803379322603UL) + ((uint64_t)op[5] * 1361235445647152596UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 1361235445647152596UL) + ((uint64_t)op[1] * 7694687945627488685UL) + ((((uint64_t)op[2] * 15280273693953532939UL) + ((uint64_t)op[3] * 13842017160969907978UL) + ((uint64_t)op[4] * 10873980292445264822UL) + ((uint64_t)op[5] * 9987016803379322603UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 9987016803379322603UL) + ((uint64_t)op[1] * 1361235445647152596UL) + ((uint64_t)op[2] * 7694687945627488685UL) + ((((uint64_t)op[3] * 15280273693953532939UL) + ((uint64_t)op[4] * 13842017160969907978UL) + ((uint64_t)op[5] * 10873980292445264822UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 10873980292445264822UL) + ((uint64_t)op[1] * 9987016803379322603UL) + ((uint64_t)op[2] * 1361235445647152596UL) + ((uint64_t)op[3] * 7694687945627488685UL) + ((((uint64_t)op[4] * 15280273693953532939UL) + ((uint64_t)op[5] * 13842017160969907978UL)) * 18446744073709551613);
	tmp_q[4] = ((uint64_t)op[0] * 13842017160969907978UL) + ((uint64_t)op[1] * 10873980292445264822UL) + ((uint64_t)op[2] * 9987016803379322603UL) + ((uint64_t)op[3] * 1361235445647152596UL) + ((uint64_t)op[4] * 7694687945627488685UL) + ((uint64_t)op[5] * 9499411139268056031UL);
	tmp_q[5] = ((uint64_t)op[0] * 15280273693953532939UL) + ((uint64_t)op[1] * 13842017160969907978UL) + ((uint64_t)op[2] * 10873980292445264822UL) + ((uint64_t)op[3] * 9987016803379322603UL) + ((uint64_t)op[4] * 1361235445647152596UL) + ((uint64_t)op[5] * 7694687945627488685UL);
