...
void init_data(){
	...
	mpz_set_str (modul_p, "4223096616398246806665204505563498088829151534660126284963", 10);

	mpz_set_str (gama_pow[0], "4093343195062746109840652579440769541065313810635992819876", 10);
