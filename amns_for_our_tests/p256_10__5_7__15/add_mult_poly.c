...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17452649932059388489UL) + ((((uint64_t)op[1] * 10692187947171972537UL) + ((uint64_t)op[2] * 2425376215769548527UL) + ((uint64_t)op[3] * 873166316909712170UL) + ((uint64_t)op[4] * 10089082464821723806UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 10089082464821723806UL) + ((uint64_t)op[1] * 17452649932059388489UL) + ((((uint64_t)op[2] * 10692187947171972537UL) + ((uint64_t)op[3] * 2425376215769548527UL) + ((uint64_t)op[4] * 873166316909712170UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 873166316909712170UL) + ((uint64_t)op[1] * 10089082464821723806UL) + ((uint64_t)op[2] * 17452649932059388489UL) + ((((uint64_t)op[3] * 10692187947171972537UL) + ((uint64_t)op[4] * 2425376215769548527UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 2425376215769548527UL) + ((uint64_t)op[1] * 873166316909712170UL) + ((uint64_t)op[2] * 10089082464821723806UL) + ((uint64_t)op[3] * 17452649932059388489UL) + ((uint64_t)op[4] * 1058339335365601295UL);
	tmp_q[4] = ((uint64_t)op[0] * 10692187947171972537UL) + ((uint64_t)op[1] * 2425376215769548527UL) + ((uint64_t)op[2] * 873166316909712170UL) + ((uint64_t)op[3] * 10089082464821723806UL) + ((uint64_t)op[4] * 17452649932059388489UL);
