...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11557084361408393936UL) + ((((uint64_t)op[1] * 4591722739246774224UL) + ((uint64_t)op[2] * 16032190124718783174UL) + ((uint64_t)op[3] * 1088102615938305516UL) + ((uint64_t)op[4] * 8773555458817033659UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 8773555458817033659UL) + ((uint64_t)op[1] * 11557084361408393936UL) + ((((uint64_t)op[2] * 4591722739246774224UL) + ((uint64_t)op[3] * 16032190124718783174UL) + ((uint64_t)op[4] * 1088102615938305516UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 1088102615938305516UL) + ((uint64_t)op[1] * 8773555458817033659UL) + ((uint64_t)op[2] * 11557084361408393936UL) + ((((uint64_t)op[3] * 4591722739246774224UL) + ((uint64_t)op[4] * 16032190124718783174UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 16032190124718783174UL) + ((uint64_t)op[1] * 1088102615938305516UL) + ((uint64_t)op[2] * 8773555458817033659UL) + ((uint64_t)op[3] * 11557084361408393936UL) + ((uint64_t)op[4] * 4511869622524319504UL);
	tmp_q[4] = ((uint64_t)op[0] * 4591722739246774224UL) + ((uint64_t)op[1] * 16032190124718783174UL) + ((uint64_t)op[2] * 1088102615938305516UL) + ((uint64_t)op[3] * 8773555458817033659UL) + ((uint64_t)op[4] * 11557084361408393936UL);
