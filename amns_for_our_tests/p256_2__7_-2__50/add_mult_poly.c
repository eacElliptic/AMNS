...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1172966123947097393UL) + ((((uint64_t)op[1] * 5385923291960364249UL) + ((uint64_t)op[2] * 15949311739685682825UL) + ((uint64_t)op[3] * 10969715490151596496UL) + ((uint64_t)op[4] * 1206417849174560101UL) + ((uint64_t)op[5] * 7331945623190907960UL) + ((uint64_t)op[6] * 8336784512415969697UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 8336784512415969697UL) + ((uint64_t)op[1] * 1172966123947097393UL) + ((((uint64_t)op[2] * 5385923291960364249UL) + ((uint64_t)op[3] * 15949311739685682825UL) + ((uint64_t)op[4] * 10969715490151596496UL) + ((uint64_t)op[5] * 1206417849174560101UL) + ((uint64_t)op[6] * 7331945623190907960UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 7331945623190907960UL) + ((uint64_t)op[1] * 8336784512415969697UL) + ((uint64_t)op[2] * 1172966123947097393UL) + ((((uint64_t)op[3] * 5385923291960364249UL) + ((uint64_t)op[4] * 15949311739685682825UL) + ((uint64_t)op[5] * 10969715490151596496UL) + ((uint64_t)op[6] * 1206417849174560101UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 1206417849174560101UL) + ((uint64_t)op[1] * 7331945623190907960UL) + ((uint64_t)op[2] * 8336784512415969697UL) + ((uint64_t)op[3] * 1172966123947097393UL) + ((((uint64_t)op[4] * 5385923291960364249UL) + ((uint64_t)op[5] * 15949311739685682825UL) + ((uint64_t)op[6] * 10969715490151596496UL)) * 18446744073709551614);
	tmp_q[4] = ((uint64_t)op[0] * 10969715490151596496UL) + ((uint64_t)op[1] * 1206417849174560101UL) + ((uint64_t)op[2] * 7331945623190907960UL) + ((uint64_t)op[3] * 8336784512415969697UL) + ((uint64_t)op[4] * 1172966123947097393UL) + ((((uint64_t)op[5] * 5385923291960364249UL) + ((uint64_t)op[6] * 15949311739685682825UL)) * 18446744073709551614);
	tmp_q[5] = ((uint64_t)op[0] * 15949311739685682825UL) + ((uint64_t)op[1] * 10969715490151596496UL) + ((uint64_t)op[2] * 1206417849174560101UL) + ((uint64_t)op[3] * 7331945623190907960UL) + ((uint64_t)op[4] * 8336784512415969697UL) + ((uint64_t)op[5] * 1172966123947097393UL) + ((uint64_t)op[6] * 7674897489788823118UL);
	tmp_q[6] = ((uint64_t)op[0] * 5385923291960364249UL) + ((uint64_t)op[1] * 15949311739685682825UL) + ((uint64_t)op[2] * 10969715490151596496UL) + ((uint64_t)op[3] * 1206417849174560101UL) + ((uint64_t)op[4] * 7331945623190907960UL) + ((uint64_t)op[5] * 8336784512415969697UL) + ((uint64_t)op[6] * 1172966123947097393UL);
