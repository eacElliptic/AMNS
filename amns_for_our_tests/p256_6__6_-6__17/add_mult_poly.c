...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3442880976321562519UL) + ((((uint64_t)op[1] * 16101278054621039687UL) + ((uint64_t)op[2] * 2282309971648352746UL) + ((uint64_t)op[3] * 15337498197876698615UL) + ((uint64_t)op[4] * 18053058986988116344UL) + ((uint64_t)op[5] * 12457753832409935727UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 12457753832409935727UL) + ((uint64_t)op[1] * 3442880976321562519UL) + ((((uint64_t)op[2] * 16101278054621039687UL) + ((uint64_t)op[3] * 2282309971648352746UL) + ((uint64_t)op[4] * 15337498197876698615UL) + ((uint64_t)op[5] * 18053058986988116344UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 18053058986988116344UL) + ((uint64_t)op[1] * 12457753832409935727UL) + ((uint64_t)op[2] * 3442880976321562519UL) + ((((uint64_t)op[3] * 16101278054621039687UL) + ((uint64_t)op[4] * 2282309971648352746UL) + ((uint64_t)op[5] * 15337498197876698615UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 15337498197876698615UL) + ((uint64_t)op[1] * 18053058986988116344UL) + ((uint64_t)op[2] * 12457753832409935727UL) + ((uint64_t)op[3] * 3442880976321562519UL) + ((((uint64_t)op[4] * 16101278054621039687UL) + ((uint64_t)op[5] * 2282309971648352746UL)) * 18446744073709551610);
	tmp_q[4] = ((uint64_t)op[0] * 2282309971648352746UL) + ((uint64_t)op[1] * 15337498197876698615UL) + ((uint64_t)op[2] * 18053058986988116344UL) + ((uint64_t)op[3] * 12457753832409935727UL) + ((uint64_t)op[4] * 3442880976321562519UL) + ((uint64_t)op[5] * 14072796114531071574UL);
	tmp_q[5] = ((uint64_t)op[0] * 16101278054621039687UL) + ((uint64_t)op[1] * 2282309971648352746UL) + ((uint64_t)op[2] * 15337498197876698615UL) + ((uint64_t)op[3] * 18053058986988116344UL) + ((uint64_t)op[4] * 12457753832409935727UL) + ((uint64_t)op[5] * 3442880976321562519UL);
