...
void init_data(){
	...
	mpz_set_str (modul_p, "17417797210651434478546258812978819263894769552128577205286135050483", 10);

	mpz_set_str (gama_pow[0], "9399550898148924456489868889286252188864177962714737280253081686228", 10);
