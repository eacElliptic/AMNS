...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8891500004071297081UL) + ((((uint64_t)op[1] * 17709559299838846424UL) + ((uint64_t)op[2] * 12691627108205306234UL) + ((uint64_t)op[3] * 14893501738449630904UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 14893501738449630904UL) + ((uint64_t)op[1] * 8891500004071297081UL) + ((((uint64_t)op[2] * 17709559299838846424UL) + ((uint64_t)op[3] * 12691627108205306234UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 12691627108205306234UL) + ((uint64_t)op[1] * 14893501738449630904UL) + ((uint64_t)op[2] * 8891500004071297081UL) + ((uint64_t)op[3] * 1474369547741410384UL);
	tmp_q[3] = ((uint64_t)op[0] * 17709559299838846424UL) + ((uint64_t)op[1] * 12691627108205306234UL) + ((uint64_t)op[2] * 14893501738449630904UL) + ((uint64_t)op[3] * 8891500004071297081UL);
