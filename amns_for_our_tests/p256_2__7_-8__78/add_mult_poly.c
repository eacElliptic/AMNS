...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15330133497183739967UL) + ((((uint64_t)op[1] * 11232131588037336444UL) + ((uint64_t)op[2] * 16573287700858326208UL) + ((uint64_t)op[3] * 11428430107267506624UL) + ((uint64_t)op[4] * 14981354462409991744UL) + ((uint64_t)op[5] * 14098255663379004048UL) + ((uint64_t)op[6] * 5063226485578656970UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 5063226485578656970UL) + ((uint64_t)op[1] * 15330133497183739967UL) + ((((uint64_t)op[2] * 11232131588037336444UL) + ((uint64_t)op[3] * 16573287700858326208UL) + ((uint64_t)op[4] * 11428430107267506624UL) + ((uint64_t)op[5] * 14981354462409991744UL) + ((uint64_t)op[6] * 14098255663379004048UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 14098255663379004048UL) + ((uint64_t)op[1] * 5063226485578656970UL) + ((uint64_t)op[2] * 15330133497183739967UL) + ((((uint64_t)op[3] * 11232131588037336444UL) + ((uint64_t)op[4] * 16573287700858326208UL) + ((uint64_t)op[5] * 11428430107267506624UL) + ((uint64_t)op[6] * 14981354462409991744UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 14981354462409991744UL) + ((uint64_t)op[1] * 14098255663379004048UL) + ((uint64_t)op[2] * 5063226485578656970UL) + ((uint64_t)op[3] * 15330133497183739967UL) + ((((uint64_t)op[4] * 11232131588037336444UL) + ((uint64_t)op[5] * 16573287700858326208UL) + ((uint64_t)op[6] * 11428430107267506624UL)) * 18446744073709551608);
	tmp_q[4] = ((uint64_t)op[0] * 11428430107267506624UL) + ((uint64_t)op[1] * 14981354462409991744UL) + ((uint64_t)op[2] * 14098255663379004048UL) + ((uint64_t)op[3] * 5063226485578656970UL) + ((uint64_t)op[4] * 15330133497183739967UL) + ((((uint64_t)op[5] * 11232131588037336444UL) + ((uint64_t)op[6] * 16573287700858326208UL)) * 18446744073709551608);
	tmp_q[5] = ((uint64_t)op[0] * 16573287700858326208UL) + ((uint64_t)op[1] * 11428430107267506624UL) + ((uint64_t)op[2] * 14981354462409991744UL) + ((uint64_t)op[3] * 14098255663379004048UL) + ((uint64_t)op[4] * 5063226485578656970UL) + ((uint64_t)op[5] * 15330133497183739967UL) + ((uint64_t)op[6] * 2376667664249066528UL);
	tmp_q[6] = ((uint64_t)op[0] * 11232131588037336444UL) + ((uint64_t)op[1] * 16573287700858326208UL) + ((uint64_t)op[2] * 11428430107267506624UL) + ((uint64_t)op[3] * 14981354462409991744UL) + ((uint64_t)op[4] * 14098255663379004048UL) + ((uint64_t)op[5] * 5063226485578656970UL) + ((uint64_t)op[6] * 15330133497183739967UL);
