...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 441064095716966617UL) + ((((uint64_t)op[1] * 11713928034962959100UL) + ((uint64_t)op[2] * 2595083198489157826UL) + ((uint64_t)op[3] * 15919067043540367174UL) + ((uint64_t)op[4] * 1915797302469859288UL) + ((uint64_t)op[5] * 13499215774431421319UL) + ((uint64_t)op[6] * 10356253790886250974UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 10356253790886250974UL) + ((uint64_t)op[1] * 441064095716966617UL) + ((((uint64_t)op[2] * 11713928034962959100UL) + ((uint64_t)op[3] * 2595083198489157826UL) + ((uint64_t)op[4] * 15919067043540367174UL) + ((uint64_t)op[5] * 1915797302469859288UL) + ((uint64_t)op[6] * 13499215774431421319UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 13499215774431421319UL) + ((uint64_t)op[1] * 10356253790886250974UL) + ((uint64_t)op[2] * 441064095716966617UL) + ((((uint64_t)op[3] * 11713928034962959100UL) + ((uint64_t)op[4] * 2595083198489157826UL) + ((uint64_t)op[5] * 15919067043540367174UL) + ((uint64_t)op[6] * 1915797302469859288UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 1915797302469859288UL) + ((uint64_t)op[1] * 13499215774431421319UL) + ((uint64_t)op[2] * 10356253790886250974UL) + ((uint64_t)op[3] * 441064095716966617UL) + ((((uint64_t)op[4] * 11713928034962959100UL) + ((uint64_t)op[5] * 2595083198489157826UL) + ((uint64_t)op[6] * 15919067043540367174UL)) * 18446744073709551614);
	tmp_q[4] = ((uint64_t)op[0] * 15919067043540367174UL) + ((uint64_t)op[1] * 1915797302469859288UL) + ((uint64_t)op[2] * 13499215774431421319UL) + ((uint64_t)op[3] * 10356253790886250974UL) + ((uint64_t)op[4] * 441064095716966617UL) + ((((uint64_t)op[5] * 11713928034962959100UL) + ((uint64_t)op[6] * 2595083198489157826UL)) * 18446744073709551614);
	tmp_q[5] = ((uint64_t)op[0] * 2595083198489157826UL) + ((uint64_t)op[1] * 15919067043540367174UL) + ((uint64_t)op[2] * 1915797302469859288UL) + ((uint64_t)op[3] * 13499215774431421319UL) + ((uint64_t)op[4] * 10356253790886250974UL) + ((uint64_t)op[5] * 441064095716966617UL) + ((uint64_t)op[6] * 13465632077493185032UL);
	tmp_q[6] = ((uint64_t)op[0] * 11713928034962959100UL) + ((uint64_t)op[1] * 2595083198489157826UL) + ((uint64_t)op[2] * 15919067043540367174UL) + ((uint64_t)op[3] * 1915797302469859288UL) + ((uint64_t)op[4] * 13499215774431421319UL) + ((uint64_t)op[5] * 10356253790886250974UL) + ((uint64_t)op[6] * 441064095716966617UL);
