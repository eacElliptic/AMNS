...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12366638602060991093UL) + ((((uint64_t)op[1] * 9520977037794501209UL) + ((uint64_t)op[2] * 8868931626286951923UL) + ((uint64_t)op[3] * 14972004792957190502UL) + ((uint64_t)op[4] * 3143752576029775864UL) + ((uint64_t)op[5] * 8881014214980167434UL) + ((uint64_t)op[6] * 2890823269783851972UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 2890823269783851972UL) + ((uint64_t)op[1] * 12366638602060991093UL) + ((((uint64_t)op[2] * 9520977037794501209UL) + ((uint64_t)op[3] * 8868931626286951923UL) + ((uint64_t)op[4] * 14972004792957190502UL) + ((uint64_t)op[5] * 3143752576029775864UL) + ((uint64_t)op[6] * 8881014214980167434UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 8881014214980167434UL) + ((uint64_t)op[1] * 2890823269783851972UL) + ((uint64_t)op[2] * 12366638602060991093UL) + ((((uint64_t)op[3] * 9520977037794501209UL) + ((uint64_t)op[4] * 8868931626286951923UL) + ((uint64_t)op[5] * 14972004792957190502UL) + ((uint64_t)op[6] * 3143752576029775864UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 3143752576029775864UL) + ((uint64_t)op[1] * 8881014214980167434UL) + ((uint64_t)op[2] * 2890823269783851972UL) + ((uint64_t)op[3] * 12366638602060991093UL) + ((((uint64_t)op[4] * 9520977037794501209UL) + ((uint64_t)op[5] * 8868931626286951923UL) + ((uint64_t)op[6] * 14972004792957190502UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 14972004792957190502UL) + ((uint64_t)op[1] * 3143752576029775864UL) + ((uint64_t)op[2] * 8881014214980167434UL) + ((uint64_t)op[3] * 2890823269783851972UL) + ((uint64_t)op[4] * 12366638602060991093UL) + ((((uint64_t)op[5] * 9520977037794501209UL) + ((uint64_t)op[6] * 8868931626286951923UL)) * 5);
	tmp_q[5] = ((uint64_t)op[0] * 8868931626286951923UL) + ((uint64_t)op[1] * 14972004792957190502UL) + ((uint64_t)op[2] * 3143752576029775864UL) + ((uint64_t)op[3] * 8881014214980167434UL) + ((uint64_t)op[4] * 2890823269783851972UL) + ((uint64_t)op[5] * 12366638602060991093UL) + ((uint64_t)op[6] * 10711397041553402813UL);
	tmp_q[6] = ((uint64_t)op[0] * 9520977037794501209UL) + ((uint64_t)op[1] * 8868931626286951923UL) + ((uint64_t)op[2] * 14972004792957190502UL) + ((uint64_t)op[3] * 3143752576029775864UL) + ((uint64_t)op[4] * 8881014214980167434UL) + ((uint64_t)op[5] * 2890823269783851972UL) + ((uint64_t)op[6] * 12366638602060991093UL);
