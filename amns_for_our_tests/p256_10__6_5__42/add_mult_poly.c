...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8167240352869218398UL) + ((((uint64_t)op[1] * 3994206445655269465UL) + ((uint64_t)op[2] * 17018313908731043829UL) + ((uint64_t)op[3] * 3062736214432702674UL) + ((uint64_t)op[4] * 5257667048907356811UL) + ((uint64_t)op[5] * 10195969764678555604UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 10195969764678555604UL) + ((uint64_t)op[1] * 8167240352869218398UL) + ((((uint64_t)op[2] * 3994206445655269465UL) + ((uint64_t)op[3] * 17018313908731043829UL) + ((uint64_t)op[4] * 3062736214432702674UL) + ((uint64_t)op[5] * 5257667048907356811UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 5257667048907356811UL) + ((uint64_t)op[1] * 10195969764678555604UL) + ((uint64_t)op[2] * 8167240352869218398UL) + ((((uint64_t)op[3] * 3994206445655269465UL) + ((uint64_t)op[4] * 17018313908731043829UL) + ((uint64_t)op[5] * 3062736214432702674UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 3062736214432702674UL) + ((uint64_t)op[1] * 5257667048907356811UL) + ((uint64_t)op[2] * 10195969764678555604UL) + ((uint64_t)op[3] * 8167240352869218398UL) + ((((uint64_t)op[4] * 3994206445655269465UL) + ((uint64_t)op[5] * 17018313908731043829UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 17018313908731043829UL) + ((uint64_t)op[1] * 3062736214432702674UL) + ((uint64_t)op[2] * 5257667048907356811UL) + ((uint64_t)op[3] * 10195969764678555604UL) + ((uint64_t)op[4] * 8167240352869218398UL) + ((uint64_t)op[5] * 1524288154566795709UL);
	tmp_q[5] = ((uint64_t)op[0] * 3994206445655269465UL) + ((uint64_t)op[1] * 17018313908731043829UL) + ((uint64_t)op[2] * 3062736214432702674UL) + ((uint64_t)op[3] * 5257667048907356811UL) + ((uint64_t)op[4] * 10195969764678555604UL) + ((uint64_t)op[5] * 8167240352869218398UL);
