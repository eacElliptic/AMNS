...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10025604067568169104UL) + ((((uint64_t)op[1] * 1768846766534990688UL) + ((uint64_t)op[2] * 12065377147136197571UL) + ((uint64_t)op[3] * 15049723021932632948UL) + ((uint64_t)op[4] * 2071234123128211692UL) + ((uint64_t)op[5] * 10353042788260867254UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 10353042788260867254UL) + ((uint64_t)op[1] * 10025604067568169104UL) + ((((uint64_t)op[2] * 1768846766534990688UL) + ((uint64_t)op[3] * 12065377147136197571UL) + ((uint64_t)op[4] * 15049723021932632948UL) + ((uint64_t)op[5] * 2071234123128211692UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 2071234123128211692UL) + ((uint64_t)op[1] * 10353042788260867254UL) + ((uint64_t)op[2] * 10025604067568169104UL) + ((((uint64_t)op[3] * 1768846766534990688UL) + ((uint64_t)op[4] * 12065377147136197571UL) + ((uint64_t)op[5] * 15049723021932632948UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 15049723021932632948UL) + ((uint64_t)op[1] * 2071234123128211692UL) + ((uint64_t)op[2] * 10353042788260867254UL) + ((uint64_t)op[3] * 10025604067568169104UL) + ((((uint64_t)op[4] * 1768846766534990688UL) + ((uint64_t)op[5] * 12065377147136197571UL)) * 7);
	tmp_q[4] = ((uint64_t)op[0] * 12065377147136197571UL) + ((uint64_t)op[1] * 15049723021932632948UL) + ((uint64_t)op[2] * 2071234123128211692UL) + ((uint64_t)op[3] * 10353042788260867254UL) + ((uint64_t)op[4] * 10025604067568169104UL) + ((uint64_t)op[5] * 12381927365744934816UL);
	tmp_q[5] = ((uint64_t)op[0] * 1768846766534990688UL) + ((uint64_t)op[1] * 12065377147136197571UL) + ((uint64_t)op[2] * 15049723021932632948UL) + ((uint64_t)op[3] * 2071234123128211692UL) + ((uint64_t)op[4] * 10353042788260867254UL) + ((uint64_t)op[5] * 10025604067568169104UL);
