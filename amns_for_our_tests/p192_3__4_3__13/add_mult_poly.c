...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17339683822227175589UL) + ((((uint64_t)op[1] * 1739419374733238386UL) + ((uint64_t)op[2] * 15368971491632665250UL) + ((uint64_t)op[3] * 8335203623384588822UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 8335203623384588822UL) + ((uint64_t)op[1] * 17339683822227175589UL) + ((((uint64_t)op[2] * 1739419374733238386UL) + ((uint64_t)op[3] * 15368971491632665250UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 15368971491632665250UL) + ((uint64_t)op[1] * 8335203623384588822UL) + ((uint64_t)op[2] * 17339683822227175589UL) + ((uint64_t)op[3] * 5218258124199715158UL);
	tmp_q[3] = ((uint64_t)op[0] * 1739419374733238386UL) + ((uint64_t)op[1] * 15368971491632665250UL) + ((uint64_t)op[2] * 8335203623384588822UL) + ((uint64_t)op[3] * 17339683822227175589UL);
