...
void init_data(){
	...
	mpz_set_str (modul_p, "14400355763731029646700842774228283055525297377320260405691675769333", 10);

	mpz_set_str (gama_pow[0], "13360496643380380892724935728748677495167296404798679180888192696127", 10);
