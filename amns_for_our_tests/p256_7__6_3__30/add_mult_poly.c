...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2271414198727012256UL) + ((((uint64_t)op[1] * 760557835416487947UL) + ((uint64_t)op[2] * 7642138296863632902UL) + ((uint64_t)op[3] * 17709806165331583967UL) + ((uint64_t)op[4] * 3758009315152150719UL) + ((uint64_t)op[5] * 2663127379175128014UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 2663127379175128014UL) + ((uint64_t)op[1] * 2271414198727012256UL) + ((((uint64_t)op[2] * 760557835416487947UL) + ((uint64_t)op[3] * 7642138296863632902UL) + ((uint64_t)op[4] * 17709806165331583967UL) + ((uint64_t)op[5] * 3758009315152150719UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 3758009315152150719UL) + ((uint64_t)op[1] * 2663127379175128014UL) + ((uint64_t)op[2] * 2271414198727012256UL) + ((((uint64_t)op[3] * 760557835416487947UL) + ((uint64_t)op[4] * 7642138296863632902UL) + ((uint64_t)op[5] * 17709806165331583967UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 17709806165331583967UL) + ((uint64_t)op[1] * 3758009315152150719UL) + ((uint64_t)op[2] * 2663127379175128014UL) + ((uint64_t)op[3] * 2271414198727012256UL) + ((((uint64_t)op[4] * 760557835416487947UL) + ((uint64_t)op[5] * 7642138296863632902UL)) * 3);
	tmp_q[4] = ((uint64_t)op[0] * 7642138296863632902UL) + ((uint64_t)op[1] * 17709806165331583967UL) + ((uint64_t)op[2] * 3758009315152150719UL) + ((uint64_t)op[3] * 2663127379175128014UL) + ((uint64_t)op[4] * 2271414198727012256UL) + ((uint64_t)op[5] * 2281673506249463841UL);
	tmp_q[5] = ((uint64_t)op[0] * 760557835416487947UL) + ((uint64_t)op[1] * 7642138296863632902UL) + ((uint64_t)op[2] * 17709806165331583967UL) + ((uint64_t)op[3] * 3758009315152150719UL) + ((uint64_t)op[4] * 2663127379175128014UL) + ((uint64_t)op[5] * 2271414198727012256UL);
