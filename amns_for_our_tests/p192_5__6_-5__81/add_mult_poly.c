...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1130872062525751682UL) + ((((uint64_t)op[1] * 137897617545420950UL) + ((uint64_t)op[2] * 4470426268912178369UL) + ((uint64_t)op[3] * 4809881377296675994UL) + ((uint64_t)op[4] * 1564642001959410790UL) + ((uint64_t)op[5] * 13915225196054344066UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 13915225196054344066UL) + ((uint64_t)op[1] * 1130872062525751682UL) + ((((uint64_t)op[2] * 137897617545420950UL) + ((uint64_t)op[3] * 4470426268912178369UL) + ((uint64_t)op[4] * 4809881377296675994UL) + ((uint64_t)op[5] * 1564642001959410790UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 1564642001959410790UL) + ((uint64_t)op[1] * 13915225196054344066UL) + ((uint64_t)op[2] * 1130872062525751682UL) + ((((uint64_t)op[3] * 137897617545420950UL) + ((uint64_t)op[4] * 4470426268912178369UL) + ((uint64_t)op[5] * 4809881377296675994UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 4809881377296675994UL) + ((uint64_t)op[1] * 1564642001959410790UL) + ((uint64_t)op[2] * 13915225196054344066UL) + ((uint64_t)op[3] * 1130872062525751682UL) + ((((uint64_t)op[4] * 137897617545420950UL) + ((uint64_t)op[5] * 4470426268912178369UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 4470426268912178369UL) + ((uint64_t)op[1] * 4809881377296675994UL) + ((uint64_t)op[2] * 1564642001959410790UL) + ((uint64_t)op[3] * 13915225196054344066UL) + ((uint64_t)op[4] * 1130872062525751682UL) + ((uint64_t)op[5] * 17757255985982446866UL);
	tmp_q[5] = ((uint64_t)op[0] * 137897617545420950UL) + ((uint64_t)op[1] * 4470426268912178369UL) + ((uint64_t)op[2] * 4809881377296675994UL) + ((uint64_t)op[3] * 1564642001959410790UL) + ((uint64_t)op[4] * 13915225196054344066UL) + ((uint64_t)op[5] * 1130872062525751682UL);
