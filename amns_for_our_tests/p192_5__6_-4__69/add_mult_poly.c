...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14797556216954371743UL) + ((((uint64_t)op[1] * 16597099642605312028UL) + ((uint64_t)op[2] * 15288955346350477994UL) + ((uint64_t)op[3] * 13344300417214127032UL) + ((uint64_t)op[4] * 16153895952179370705UL) + ((uint64_t)op[5] * 2299387236972839734UL)) * 18446744073709551612);
	tmp_q[1] = ((uint64_t)op[0] * 2299387236972839734UL) + ((uint64_t)op[1] * 14797556216954371743UL) + ((((uint64_t)op[2] * 16597099642605312028UL) + ((uint64_t)op[3] * 15288955346350477994UL) + ((uint64_t)op[4] * 13344300417214127032UL) + ((uint64_t)op[5] * 16153895952179370705UL)) * 18446744073709551612);
	tmp_q[2] = ((uint64_t)op[0] * 16153895952179370705UL) + ((uint64_t)op[1] * 2299387236972839734UL) + ((uint64_t)op[2] * 14797556216954371743UL) + ((((uint64_t)op[3] * 16597099642605312028UL) + ((uint64_t)op[4] * 15288955346350477994UL) + ((uint64_t)op[5] * 13344300417214127032UL)) * 18446744073709551612);
	tmp_q[3] = ((uint64_t)op[0] * 13344300417214127032UL) + ((uint64_t)op[1] * 16153895952179370705UL) + ((uint64_t)op[2] * 2299387236972839734UL) + ((uint64_t)op[3] * 14797556216954371743UL) + ((((uint64_t)op[4] * 16597099642605312028UL) + ((uint64_t)op[5] * 15288955346350477994UL)) * 18446744073709551612);
	tmp_q[4] = ((uint64_t)op[0] * 15288955346350477994UL) + ((uint64_t)op[1] * 13344300417214127032UL) + ((uint64_t)op[2] * 16153895952179370705UL) + ((uint64_t)op[3] * 2299387236972839734UL) + ((uint64_t)op[4] * 14797556216954371743UL) + ((uint64_t)op[5] * 7398577724416958352UL);
	tmp_q[5] = ((uint64_t)op[0] * 16597099642605312028UL) + ((uint64_t)op[1] * 15288955346350477994UL) + ((uint64_t)op[2] * 13344300417214127032UL) + ((uint64_t)op[3] * 16153895952179370705UL) + ((uint64_t)op[4] * 2299387236972839734UL) + ((uint64_t)op[5] * 14797556216954371743UL);
