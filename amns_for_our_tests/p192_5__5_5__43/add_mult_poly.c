...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1944507284282689804UL) + ((((uint64_t)op[1] * 109462678467589714UL) + ((uint64_t)op[2] * 17721894720324557568UL) + ((uint64_t)op[3] * 9509411241765944216UL) + ((uint64_t)op[4] * 2391181026293009425UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 2391181026293009425UL) + ((uint64_t)op[1] * 1944507284282689804UL) + ((((uint64_t)op[2] * 109462678467589714UL) + ((uint64_t)op[3] * 17721894720324557568UL) + ((uint64_t)op[4] * 9509411241765944216UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 9509411241765944216UL) + ((uint64_t)op[1] * 2391181026293009425UL) + ((uint64_t)op[2] * 1944507284282689804UL) + ((((uint64_t)op[3] * 109462678467589714UL) + ((uint64_t)op[4] * 17721894720324557568UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 17721894720324557568UL) + ((uint64_t)op[1] * 9509411241765944216UL) + ((uint64_t)op[2] * 2391181026293009425UL) + ((uint64_t)op[3] * 1944507284282689804UL) + ((uint64_t)op[4] * 547313392337948570UL);
	tmp_q[4] = ((uint64_t)op[0] * 109462678467589714UL) + ((uint64_t)op[1] * 17721894720324557568UL) + ((uint64_t)op[2] * 9509411241765944216UL) + ((uint64_t)op[3] * 2391181026293009425UL) + ((uint64_t)op[4] * 1944507284282689804UL);
