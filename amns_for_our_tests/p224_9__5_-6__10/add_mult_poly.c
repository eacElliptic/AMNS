...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14041789153136027673UL) + ((((uint64_t)op[1] * 2637214354641604698UL) + ((uint64_t)op[2] * 6482987377102316880UL) + ((uint64_t)op[3] * 10776279500635454412UL) + ((uint64_t)op[4] * 13506383178365550079UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 13506383178365550079UL) + ((uint64_t)op[1] * 14041789153136027673UL) + ((((uint64_t)op[2] * 2637214354641604698UL) + ((uint64_t)op[3] * 6482987377102316880UL) + ((uint64_t)op[4] * 10776279500635454412UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 10776279500635454412UL) + ((uint64_t)op[1] * 13506383178365550079UL) + ((uint64_t)op[2] * 14041789153136027673UL) + ((((uint64_t)op[3] * 2637214354641604698UL) + ((uint64_t)op[4] * 6482987377102316880UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 6482987377102316880UL) + ((uint64_t)op[1] * 10776279500635454412UL) + ((uint64_t)op[2] * 13506383178365550079UL) + ((uint64_t)op[3] * 14041789153136027673UL) + ((uint64_t)op[4] * 2623457945859923428UL);
	tmp_q[4] = ((uint64_t)op[0] * 2637214354641604698UL) + ((uint64_t)op[1] * 6482987377102316880UL) + ((uint64_t)op[2] * 10776279500635454412UL) + ((uint64_t)op[3] * 13506383178365550079UL) + ((uint64_t)op[4] * 14041789153136027673UL);
