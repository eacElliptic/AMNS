...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16936283791067095213UL) + ((((uint64_t)op[1] * 17627454774789180721UL) + ((uint64_t)op[2] * 2738991742243588126UL) + ((uint64_t)op[3] * 844687849023206254UL) + ((uint64_t)op[4] * 15864829387662470891UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 15864829387662470891UL) + ((uint64_t)op[1] * 16936283791067095213UL) + ((((uint64_t)op[2] * 17627454774789180721UL) + ((uint64_t)op[3] * 2738991742243588126UL) + ((uint64_t)op[4] * 844687849023206254UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 844687849023206254UL) + ((uint64_t)op[1] * 15864829387662470891UL) + ((uint64_t)op[2] * 16936283791067095213UL) + ((((uint64_t)op[3] * 17627454774789180721UL) + ((uint64_t)op[4] * 2738991742243588126UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 2738991742243588126UL) + ((uint64_t)op[1] * 844687849023206254UL) + ((uint64_t)op[2] * 15864829387662470891UL) + ((uint64_t)op[3] * 16936283791067095213UL) + ((uint64_t)op[4] * 12711718981266955351UL);
	tmp_q[4] = ((uint64_t)op[0] * 17627454774789180721UL) + ((uint64_t)op[1] * 2738991742243588126UL) + ((uint64_t)op[2] * 844687849023206254UL) + ((uint64_t)op[3] * 15864829387662470891UL) + ((uint64_t)op[4] * 16936283791067095213UL);
