...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 4175107013283860159UL) + ((((uint64_t)op[1] * 15855452744906097831UL) + ((uint64_t)op[2] * 15249416208318797670UL) + ((uint64_t)op[3] * 3818519472201137565UL) + ((uint64_t)op[4] * 15411742774886212473UL) + ((uint64_t)op[5] * 8988401048272133952UL) + ((uint64_t)op[6] * 15246660488433576457UL) + ((uint64_t)op[7] * 8055584786198834919UL) + ((uint64_t)op[8] * 1183786549986879857UL) + ((uint64_t)op[9] * 2200782638380713544UL) + ((uint64_t)op[10] * 7256247525221878254UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 7256247525221878254UL) + ((uint64_t)op[1] * 4175107013283860159UL) + ((((uint64_t)op[2] * 15855452744906097831UL) + ((uint64_t)op[3] * 15249416208318797670UL) + ((uint64_t)op[4] * 3818519472201137565UL) + ((uint64_t)op[5] * 15411742774886212473UL) + ((uint64_t)op[6] * 8988401048272133952UL) + ((uint64_t)op[7] * 15246660488433576457UL) + ((uint64_t)op[8] * 8055584786198834919UL) + ((uint64_t)op[9] * 1183786549986879857UL) + ((uint64_t)op[10] * 2200782638380713544UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 2200782638380713544UL) + ((uint64_t)op[1] * 7256247525221878254UL) + ((uint64_t)op[2] * 4175107013283860159UL) + ((((uint64_t)op[3] * 15855452744906097831UL) + ((uint64_t)op[4] * 15249416208318797670UL) + ((uint64_t)op[5] * 3818519472201137565UL) + ((uint64_t)op[6] * 15411742774886212473UL) + ((uint64_t)op[7] * 8988401048272133952UL) + ((uint64_t)op[8] * 15246660488433576457UL) + ((uint64_t)op[9] * 8055584786198834919UL) + ((uint64_t)op[10] * 1183786549986879857UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 1183786549986879857UL) + ((uint64_t)op[1] * 2200782638380713544UL) + ((uint64_t)op[2] * 7256247525221878254UL) + ((uint64_t)op[3] * 4175107013283860159UL) + ((((uint64_t)op[4] * 15855452744906097831UL) + ((uint64_t)op[5] * 15249416208318797670UL) + ((uint64_t)op[6] * 3818519472201137565UL) + ((uint64_t)op[7] * 15411742774886212473UL) + ((uint64_t)op[8] * 8988401048272133952UL) + ((uint64_t)op[9] * 15246660488433576457UL) + ((uint64_t)op[10] * 8055584786198834919UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 8055584786198834919UL) + ((uint64_t)op[1] * 1183786549986879857UL) + ((uint64_t)op[2] * 2200782638380713544UL) + ((uint64_t)op[3] * 7256247525221878254UL) + ((uint64_t)op[4] * 4175107013283860159UL) + ((((uint64_t)op[5] * 15855452744906097831UL) + ((uint64_t)op[6] * 15249416208318797670UL) + ((uint64_t)op[7] * 3818519472201137565UL) + ((uint64_t)op[8] * 15411742774886212473UL) + ((uint64_t)op[9] * 8988401048272133952UL) + ((uint64_t)op[10] * 15246660488433576457UL)) * 6);
	tmp_q[5] = ((uint64_t)op[0] * 15246660488433576457UL) + ((uint64_t)op[1] * 8055584786198834919UL) + ((uint64_t)op[2] * 1183786549986879857UL) + ((uint64_t)op[3] * 2200782638380713544UL) + ((uint64_t)op[4] * 7256247525221878254UL) + ((uint64_t)op[5] * 4175107013283860159UL) + ((((uint64_t)op[6] * 15855452744906097831UL) + ((uint64_t)op[7] * 15249416208318797670UL) + ((uint64_t)op[8] * 3818519472201137565UL) + ((uint64_t)op[9] * 15411742774886212473UL) + ((uint64_t)op[10] * 8988401048272133952UL)) * 6);
	tmp_q[6] = ((uint64_t)op[0] * 8988401048272133952UL) + ((uint64_t)op[1] * 15246660488433576457UL) + ((uint64_t)op[2] * 8055584786198834919UL) + ((uint64_t)op[3] * 1183786549986879857UL) + ((uint64_t)op[4] * 2200782638380713544UL) + ((uint64_t)op[5] * 7256247525221878254UL) + ((uint64_t)op[6] * 4175107013283860159UL) + ((((uint64_t)op[7] * 15855452744906097831UL) + ((uint64_t)op[8] * 15249416208318797670UL) + ((uint64_t)op[9] * 3818519472201137565UL) + ((uint64_t)op[10] * 15411742774886212473UL)) * 6);
	tmp_q[7] = ((uint64_t)op[0] * 15411742774886212473UL) + ((uint64_t)op[1] * 8988401048272133952UL) + ((uint64_t)op[2] * 15246660488433576457UL) + ((uint64_t)op[3] * 8055584786198834919UL) + ((uint64_t)op[4] * 1183786549986879857UL) + ((uint64_t)op[5] * 2200782638380713544UL) + ((uint64_t)op[6] * 7256247525221878254UL) + ((uint64_t)op[7] * 4175107013283860159UL) + ((((uint64_t)op[8] * 15855452744906097831UL) + ((uint64_t)op[9] * 15249416208318797670UL) + ((uint64_t)op[10] * 3818519472201137565UL)) * 6);
	tmp_q[8] = ((uint64_t)op[0] * 3818519472201137565UL) + ((uint64_t)op[1] * 15411742774886212473UL) + ((uint64_t)op[2] * 8988401048272133952UL) + ((uint64_t)op[3] * 15246660488433576457UL) + ((uint64_t)op[4] * 8055584786198834919UL) + ((uint64_t)op[5] * 1183786549986879857UL) + ((uint64_t)op[6] * 2200782638380713544UL) + ((uint64_t)op[7] * 7256247525221878254UL) + ((uint64_t)op[8] * 4175107013283860159UL) + ((((uint64_t)op[9] * 15855452744906097831UL) + ((uint64_t)op[10] * 15249416208318797670UL)) * 6);
	tmp_q[9] = ((uint64_t)op[0] * 15249416208318797670UL) + ((uint64_t)op[1] * 3818519472201137565UL) + ((uint64_t)op[2] * 15411742774886212473UL) + ((uint64_t)op[3] * 8988401048272133952UL) + ((uint64_t)op[4] * 15246660488433576457UL) + ((uint64_t)op[5] * 8055584786198834919UL) + ((uint64_t)op[6] * 1183786549986879857UL) + ((uint64_t)op[7] * 2200782638380713544UL) + ((uint64_t)op[8] * 7256247525221878254UL) + ((uint64_t)op[9] * 4175107013283860159UL) + ((uint64_t)op[10] * 2898996100888828906UL);
	tmp_q[10] = ((uint64_t)op[0] * 15855452744906097831UL) + ((uint64_t)op[1] * 15249416208318797670UL) + ((uint64_t)op[2] * 3818519472201137565UL) + ((uint64_t)op[3] * 15411742774886212473UL) + ((uint64_t)op[4] * 8988401048272133952UL) + ((uint64_t)op[5] * 15246660488433576457UL) + ((uint64_t)op[6] * 8055584786198834919UL) + ((uint64_t)op[7] * 1183786549986879857UL) + ((uint64_t)op[8] * 2200782638380713544UL) + ((uint64_t)op[9] * 7256247525221878254UL) + ((uint64_t)op[10] * 4175107013283860159UL);
