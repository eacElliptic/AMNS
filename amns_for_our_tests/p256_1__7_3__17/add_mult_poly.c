...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8016070588041942479UL) + ((((uint64_t)op[1] * 18157510457872760563UL) + ((uint64_t)op[2] * 1248398865873478504UL) + ((uint64_t)op[3] * 8712575983539471666UL) + ((uint64_t)op[4] * 2812375495804466932UL) + ((uint64_t)op[5] * 2808138930377981944UL) + ((uint64_t)op[6] * 2061044213351788755UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 2061044213351788755UL) + ((uint64_t)op[1] * 8016070588041942479UL) + ((((uint64_t)op[2] * 18157510457872760563UL) + ((uint64_t)op[3] * 1248398865873478504UL) + ((uint64_t)op[4] * 8712575983539471666UL) + ((uint64_t)op[5] * 2812375495804466932UL) + ((uint64_t)op[6] * 2808138930377981944UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 2808138930377981944UL) + ((uint64_t)op[1] * 2061044213351788755UL) + ((uint64_t)op[2] * 8016070588041942479UL) + ((((uint64_t)op[3] * 18157510457872760563UL) + ((uint64_t)op[4] * 1248398865873478504UL) + ((uint64_t)op[5] * 8712575983539471666UL) + ((uint64_t)op[6] * 2812375495804466932UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 2812375495804466932UL) + ((uint64_t)op[1] * 2808138930377981944UL) + ((uint64_t)op[2] * 2061044213351788755UL) + ((uint64_t)op[3] * 8016070588041942479UL) + ((((uint64_t)op[4] * 18157510457872760563UL) + ((uint64_t)op[5] * 1248398865873478504UL) + ((uint64_t)op[6] * 8712575983539471666UL)) * 3);
	tmp_q[4] = ((uint64_t)op[0] * 8712575983539471666UL) + ((uint64_t)op[1] * 2812375495804466932UL) + ((uint64_t)op[2] * 2808138930377981944UL) + ((uint64_t)op[3] * 2061044213351788755UL) + ((uint64_t)op[4] * 8016070588041942479UL) + ((((uint64_t)op[5] * 18157510457872760563UL) + ((uint64_t)op[6] * 1248398865873478504UL)) * 3);
	tmp_q[5] = ((uint64_t)op[0] * 1248398865873478504UL) + ((uint64_t)op[1] * 8712575983539471666UL) + ((uint64_t)op[2] * 2812375495804466932UL) + ((uint64_t)op[3] * 2808138930377981944UL) + ((uint64_t)op[4] * 2061044213351788755UL) + ((uint64_t)op[5] * 8016070588041942479UL) + ((uint64_t)op[6] * 17579043226199178457UL);
	tmp_q[6] = ((uint64_t)op[0] * 18157510457872760563UL) + ((uint64_t)op[1] * 1248398865873478504UL) + ((uint64_t)op[2] * 8712575983539471666UL) + ((uint64_t)op[3] * 2812375495804466932UL) + ((uint64_t)op[4] * 2808138930377981944UL) + ((uint64_t)op[5] * 2061044213351788755UL) + ((uint64_t)op[6] * 8016070588041942479UL);
