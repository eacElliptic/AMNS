...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10989058781331808562UL) + ((((uint64_t)op[1] * 16668988953857012131UL) + ((uint64_t)op[2] * 16555481205034928901UL) + ((uint64_t)op[3] * 13733906492677102022UL) + ((uint64_t)op[4] * 6180145741674497743UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 6180145741674497743UL) + ((uint64_t)op[1] * 10989058781331808562UL) + ((((uint64_t)op[2] * 16668988953857012131UL) + ((uint64_t)op[3] * 16555481205034928901UL) + ((uint64_t)op[4] * 13733906492677102022UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 13733906492677102022UL) + ((uint64_t)op[1] * 6180145741674497743UL) + ((uint64_t)op[2] * 10989058781331808562UL) + ((((uint64_t)op[3] * 16668988953857012131UL) + ((uint64_t)op[4] * 16555481205034928901UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 16555481205034928901UL) + ((uint64_t)op[1] * 13733906492677102022UL) + ((uint64_t)op[2] * 6180145741674497743UL) + ((uint64_t)op[3] * 10989058781331808562UL) + ((uint64_t)op[4] * 12444285838967776395UL);
	tmp_q[4] = ((uint64_t)op[0] * 16668988953857012131UL) + ((uint64_t)op[1] * 16555481205034928901UL) + ((uint64_t)op[2] * 13733906492677102022UL) + ((uint64_t)op[3] * 6180145741674497743UL) + ((uint64_t)op[4] * 10989058781331808562UL);
