...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12243695279473825223UL) + ((((uint64_t)op[1] * 7953255564012478468UL) + ((uint64_t)op[2] * 10458323379115823329UL) + ((uint64_t)op[3] * 522080697455257982UL) + ((uint64_t)op[4] * 14401118761468768990UL) + ((uint64_t)op[5] * 10581324494460732639UL) + ((uint64_t)op[6] * 6024154042657686016UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 6024154042657686016UL) + ((uint64_t)op[1] * 12243695279473825223UL) + ((((uint64_t)op[2] * 7953255564012478468UL) + ((uint64_t)op[3] * 10458323379115823329UL) + ((uint64_t)op[4] * 522080697455257982UL) + ((uint64_t)op[5] * 14401118761468768990UL) + ((uint64_t)op[6] * 10581324494460732639UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 10581324494460732639UL) + ((uint64_t)op[1] * 6024154042657686016UL) + ((uint64_t)op[2] * 12243695279473825223UL) + ((((uint64_t)op[3] * 7953255564012478468UL) + ((uint64_t)op[4] * 10458323379115823329UL) + ((uint64_t)op[5] * 522080697455257982UL) + ((uint64_t)op[6] * 14401118761468768990UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 14401118761468768990UL) + ((uint64_t)op[1] * 10581324494460732639UL) + ((uint64_t)op[2] * 6024154042657686016UL) + ((uint64_t)op[3] * 12243695279473825223UL) + ((((uint64_t)op[4] * 7953255564012478468UL) + ((uint64_t)op[5] * 10458323379115823329UL) + ((uint64_t)op[6] * 522080697455257982UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 522080697455257982UL) + ((uint64_t)op[1] * 14401118761468768990UL) + ((uint64_t)op[2] * 10581324494460732639UL) + ((uint64_t)op[3] * 6024154042657686016UL) + ((uint64_t)op[4] * 12243695279473825223UL) + ((((uint64_t)op[5] * 7953255564012478468UL) + ((uint64_t)op[6] * 10458323379115823329UL)) * 18446744073709551611);
	tmp_q[5] = ((uint64_t)op[0] * 10458323379115823329UL) + ((uint64_t)op[1] * 522080697455257982UL) + ((uint64_t)op[2] * 14401118761468768990UL) + ((uint64_t)op[3] * 10581324494460732639UL) + ((uint64_t)op[4] * 6024154042657686016UL) + ((uint64_t)op[5] * 12243695279473825223UL) + ((uint64_t)op[6] * 15573954401066262508UL);
	tmp_q[6] = ((uint64_t)op[0] * 7953255564012478468UL) + ((uint64_t)op[1] * 10458323379115823329UL) + ((uint64_t)op[2] * 522080697455257982UL) + ((uint64_t)op[3] * 14401118761468768990UL) + ((uint64_t)op[4] * 10581324494460732639UL) + ((uint64_t)op[5] * 6024154042657686016UL) + ((uint64_t)op[6] * 12243695279473825223UL);
