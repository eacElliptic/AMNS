...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8480622740363442556UL) + ((((uint64_t)op[1] * 7551210121468643236UL) + ((uint64_t)op[2] * 1081984875998596112UL) + ((uint64_t)op[3] * 6564201043064967934UL) + ((uint64_t)op[4] * 6655490725082937513UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 6655490725082937513UL) + ((uint64_t)op[1] * 8480622740363442556UL) + ((((uint64_t)op[2] * 7551210121468643236UL) + ((uint64_t)op[3] * 1081984875998596112UL) + ((uint64_t)op[4] * 6564201043064967934UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 6564201043064967934UL) + ((uint64_t)op[1] * 6655490725082937513UL) + ((uint64_t)op[2] * 8480622740363442556UL) + ((((uint64_t)op[3] * 7551210121468643236UL) + ((uint64_t)op[4] * 1081984875998596112UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 1081984875998596112UL) + ((uint64_t)op[1] * 6564201043064967934UL) + ((uint64_t)op[2] * 6655490725082937513UL) + ((uint64_t)op[3] * 8480622740363442556UL) + ((uint64_t)op[4] * 15964982702861399420UL);
	tmp_q[4] = ((uint64_t)op[0] * 7551210121468643236UL) + ((uint64_t)op[1] * 1081984875998596112UL) + ((uint64_t)op[2] * 6564201043064967934UL) + ((uint64_t)op[3] * 6655490725082937513UL) + ((uint64_t)op[4] * 8480622740363442556UL);
