...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 123144168212773009UL) + ((((uint64_t)op[1] * 8806707552010751307UL) + ((uint64_t)op[2] * 10949218139033142301UL) + ((uint64_t)op[3] * 14068911125844779210UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 14068911125844779210UL) + ((uint64_t)op[1] * 123144168212773009UL) + ((((uint64_t)op[2] * 8806707552010751307UL) + ((uint64_t)op[3] * 10949218139033142301UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 10949218139033142301UL) + ((uint64_t)op[1] * 14068911125844779210UL) + ((uint64_t)op[2] * 123144168212773009UL) + ((uint64_t)op[3] * 7140049612634653303UL);
	tmp_q[3] = ((uint64_t)op[0] * 8806707552010751307UL) + ((uint64_t)op[1] * 10949218139033142301UL) + ((uint64_t)op[2] * 14068911125844779210UL) + ((uint64_t)op[3] * 123144168212773009UL);
