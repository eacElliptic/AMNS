...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17493852481073253701UL) + ((((uint64_t)op[1] * 7539161922189180709UL) + ((uint64_t)op[2] * 13177702079143760662UL) + ((uint64_t)op[3] * 15476203833329720976UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 15476203833329720976UL) + ((uint64_t)op[1] * 17493852481073253701UL) + ((((uint64_t)op[2] * 7539161922189180709UL) + ((uint64_t)op[3] * 13177702079143760662UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 13177702079143760662UL) + ((uint64_t)op[1] * 15476203833329720976UL) + ((uint64_t)op[2] * 17493852481073253701UL) + ((uint64_t)op[3] * 15078323844378361418UL);
	tmp_q[3] = ((uint64_t)op[0] * 7539161922189180709UL) + ((uint64_t)op[1] * 13177702079143760662UL) + ((uint64_t)op[2] * 15476203833329720976UL) + ((uint64_t)op[3] * 17493852481073253701UL);
