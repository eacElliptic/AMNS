...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1280257968292407261UL) + ((((uint64_t)op[1] * 5260337844790398935UL) + ((uint64_t)op[2] * 14674995656935540949UL) + ((uint64_t)op[3] * 7785467125808292232UL) + ((uint64_t)op[4] * 12960043309879026576UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 12960043309879026576UL) + ((uint64_t)op[1] * 1280257968292407261UL) + ((((uint64_t)op[2] * 5260337844790398935UL) + ((uint64_t)op[3] * 14674995656935540949UL) + ((uint64_t)op[4] * 7785467125808292232UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 7785467125808292232UL) + ((uint64_t)op[1] * 12960043309879026576UL) + ((uint64_t)op[2] * 1280257968292407261UL) + ((((uint64_t)op[3] * 5260337844790398935UL) + ((uint64_t)op[4] * 14674995656935540949UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 14674995656935540949UL) + ((uint64_t)op[1] * 7785467125808292232UL) + ((uint64_t)op[2] * 12960043309879026576UL) + ((uint64_t)op[3] * 1280257968292407261UL) + ((uint64_t)op[4] * 2665730539338354811UL);
	tmp_q[4] = ((uint64_t)op[0] * 5260337844790398935UL) + ((uint64_t)op[1] * 14674995656935540949UL) + ((uint64_t)op[2] * 7785467125808292232UL) + ((uint64_t)op[3] * 12960043309879026576UL) + ((uint64_t)op[4] * 1280257968292407261UL);
