...
void init_data(){
	...
	mpz_set_str (modul_p, "3844039641823142029856488575827193117469505372209938906901", 10);

	mpz_set_str (gama_pow[0], "3606292775709121977955152727124976131979327565496905963828", 10);
