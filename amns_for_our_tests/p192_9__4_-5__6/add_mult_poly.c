...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8532055964494855364UL) + ((((uint64_t)op[1] * 7061921910345267132UL) + ((uint64_t)op[2] * 15983345233586727290UL) + ((uint64_t)op[3] * 7233631952836303329UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 7233631952836303329UL) + ((uint64_t)op[1] * 8532055964494855364UL) + ((((uint64_t)op[2] * 7061921910345267132UL) + ((uint64_t)op[3] * 15983345233586727290UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 15983345233586727290UL) + ((uint64_t)op[1] * 7233631952836303329UL) + ((uint64_t)op[2] * 8532055964494855364UL) + ((uint64_t)op[3] * 1583878595692767572UL);
	tmp_q[3] = ((uint64_t)op[0] * 7061921910345267132UL) + ((uint64_t)op[1] * 15983345233586727290UL) + ((uint64_t)op[2] * 7233631952836303329UL) + ((uint64_t)op[3] * 8532055964494855364UL);
