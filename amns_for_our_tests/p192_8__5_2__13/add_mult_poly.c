...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7090203833090788053UL) + ((((uint64_t)op[1] * 2447963226155318043UL) + ((uint64_t)op[2] * 16137091674848377615UL) + ((uint64_t)op[3] * 6867876411598675384UL) + ((uint64_t)op[4] * 9012062649379767563UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 9012062649379767563UL) + ((uint64_t)op[1] * 7090203833090788053UL) + ((((uint64_t)op[2] * 2447963226155318043UL) + ((uint64_t)op[3] * 16137091674848377615UL) + ((uint64_t)op[4] * 6867876411598675384UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 6867876411598675384UL) + ((uint64_t)op[1] * 9012062649379767563UL) + ((uint64_t)op[2] * 7090203833090788053UL) + ((((uint64_t)op[3] * 2447963226155318043UL) + ((uint64_t)op[4] * 16137091674848377615UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 16137091674848377615UL) + ((uint64_t)op[1] * 6867876411598675384UL) + ((uint64_t)op[2] * 9012062649379767563UL) + ((uint64_t)op[3] * 7090203833090788053UL) + ((uint64_t)op[4] * 4895926452310636086UL);
	tmp_q[4] = ((uint64_t)op[0] * 2447963226155318043UL) + ((uint64_t)op[1] * 16137091674848377615UL) + ((uint64_t)op[2] * 6867876411598675384UL) + ((uint64_t)op[3] * 9012062649379767563UL) + ((uint64_t)op[4] * 7090203833090788053UL);
