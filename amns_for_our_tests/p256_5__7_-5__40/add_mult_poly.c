...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 4884016891187191485UL) + ((((uint64_t)op[1] * 5021725240399061340UL) + ((uint64_t)op[2] * 15012549801849715720UL) + ((uint64_t)op[3] * 12822131132697692655UL) + ((uint64_t)op[4] * 15249841159600559473UL) + ((uint64_t)op[5] * 13405109528684442954UL) + ((uint64_t)op[6] * 2729522111123861822UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 2729522111123861822UL) + ((uint64_t)op[1] * 4884016891187191485UL) + ((((uint64_t)op[2] * 5021725240399061340UL) + ((uint64_t)op[3] * 15012549801849715720UL) + ((uint64_t)op[4] * 12822131132697692655UL) + ((uint64_t)op[5] * 15249841159600559473UL) + ((uint64_t)op[6] * 13405109528684442954UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 13405109528684442954UL) + ((uint64_t)op[1] * 2729522111123861822UL) + ((uint64_t)op[2] * 4884016891187191485UL) + ((((uint64_t)op[3] * 5021725240399061340UL) + ((uint64_t)op[4] * 15012549801849715720UL) + ((uint64_t)op[5] * 12822131132697692655UL) + ((uint64_t)op[6] * 15249841159600559473UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 15249841159600559473UL) + ((uint64_t)op[1] * 13405109528684442954UL) + ((uint64_t)op[2] * 2729522111123861822UL) + ((uint64_t)op[3] * 4884016891187191485UL) + ((((uint64_t)op[4] * 5021725240399061340UL) + ((uint64_t)op[5] * 15012549801849715720UL) + ((uint64_t)op[6] * 12822131132697692655UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 12822131132697692655UL) + ((uint64_t)op[1] * 15249841159600559473UL) + ((uint64_t)op[2] * 13405109528684442954UL) + ((uint64_t)op[3] * 2729522111123861822UL) + ((uint64_t)op[4] * 4884016891187191485UL) + ((((uint64_t)op[5] * 5021725240399061340UL) + ((uint64_t)op[6] * 15012549801849715720UL)) * 18446744073709551611);
	tmp_q[5] = ((uint64_t)op[0] * 15012549801849715720UL) + ((uint64_t)op[1] * 12822131132697692655UL) + ((uint64_t)op[2] * 15249841159600559473UL) + ((uint64_t)op[3] * 13405109528684442954UL) + ((uint64_t)op[4] * 2729522111123861822UL) + ((uint64_t)op[5] * 4884016891187191485UL) + ((uint64_t)op[6] * 11784861945423796532UL);
	tmp_q[6] = ((uint64_t)op[0] * 5021725240399061340UL) + ((uint64_t)op[1] * 15012549801849715720UL) + ((uint64_t)op[2] * 12822131132697692655UL) + ((uint64_t)op[3] * 15249841159600559473UL) + ((uint64_t)op[4] * 13405109528684442954UL) + ((uint64_t)op[5] * 2729522111123861822UL) + ((uint64_t)op[6] * 4884016891187191485UL);
