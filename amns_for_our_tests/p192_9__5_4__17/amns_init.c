...
void init_data(){
	...
	mpz_set_str (modul_p, "4311849391271764194313243886006129219423568781541358055807", 10);

	mpz_set_str (gama_pow[0], "2130714214676452602225120019646322493415547702729862996306", 10);
