...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8936213679215798929UL) + ((((uint64_t)op[1] * 4237868564112465652UL) + ((uint64_t)op[2] * 18335586376971336939UL) + ((uint64_t)op[3] * 18274258011644698120UL) + ((uint64_t)op[4] * 7087716609532428871UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 7087716609532428871UL) + ((uint64_t)op[1] * 8936213679215798929UL) + ((((uint64_t)op[2] * 4237868564112465652UL) + ((uint64_t)op[3] * 18335586376971336939UL) + ((uint64_t)op[4] * 18274258011644698120UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 18274258011644698120UL) + ((uint64_t)op[1] * 7087716609532428871UL) + ((uint64_t)op[2] * 8936213679215798929UL) + ((((uint64_t)op[3] * 4237868564112465652UL) + ((uint64_t)op[4] * 18335586376971336939UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 18335586376971336939UL) + ((uint64_t)op[1] * 18274258011644698120UL) + ((uint64_t)op[2] * 7087716609532428871UL) + ((uint64_t)op[3] * 8936213679215798929UL) + ((uint64_t)op[4] * 2742598746852776644UL);
	tmp_q[4] = ((uint64_t)op[0] * 4237868564112465652UL) + ((uint64_t)op[1] * 18335586376971336939UL) + ((uint64_t)op[2] * 18274258011644698120UL) + ((uint64_t)op[3] * 7087716609532428871UL) + ((uint64_t)op[4] * 8936213679215798929UL);
