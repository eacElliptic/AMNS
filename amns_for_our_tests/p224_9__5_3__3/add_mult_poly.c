...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10110151339252671524UL) + ((((uint64_t)op[1] * 13265581455848362782UL) + ((uint64_t)op[2] * 8500272620505367746UL) + ((uint64_t)op[3] * 2176884133784493775UL) + ((uint64_t)op[4] * 16445353490661335824UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 16445353490661335824UL) + ((uint64_t)op[1] * 10110151339252671524UL) + ((((uint64_t)op[2] * 13265581455848362782UL) + ((uint64_t)op[3] * 8500272620505367746UL) + ((uint64_t)op[4] * 2176884133784493775UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 2176884133784493775UL) + ((uint64_t)op[1] * 16445353490661335824UL) + ((uint64_t)op[2] * 10110151339252671524UL) + ((((uint64_t)op[3] * 13265581455848362782UL) + ((uint64_t)op[4] * 8500272620505367746UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 8500272620505367746UL) + ((uint64_t)op[1] * 2176884133784493775UL) + ((uint64_t)op[2] * 16445353490661335824UL) + ((uint64_t)op[3] * 10110151339252671524UL) + ((uint64_t)op[4] * 2903256220125985114UL);
	tmp_q[4] = ((uint64_t)op[0] * 13265581455848362782UL) + ((uint64_t)op[1] * 8500272620505367746UL) + ((uint64_t)op[2] * 2176884133784493775UL) + ((uint64_t)op[3] * 16445353490661335824UL) + ((uint64_t)op[4] * 10110151339252671524UL);
