...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16076652406789321057UL) + ((((uint64_t)op[1] * 9400046213309496156UL) + ((uint64_t)op[2] * 10327085587740370851UL) + ((uint64_t)op[3] * 336759785962681541UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 336759785962681541UL) + ((uint64_t)op[1] * 16076652406789321057UL) + ((((uint64_t)op[2] * 9400046213309496156UL) + ((uint64_t)op[3] * 10327085587740370851UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 10327085587740370851UL) + ((uint64_t)op[1] * 336759785962681541UL) + ((uint64_t)op[2] * 16076652406789321057UL) + ((uint64_t)op[3] * 9753394566218936852UL);
	tmp_q[3] = ((uint64_t)op[0] * 9400046213309496156UL) + ((uint64_t)op[1] * 10327085587740370851UL) + ((uint64_t)op[2] * 336759785962681541UL) + ((uint64_t)op[3] * 16076652406789321057UL);
