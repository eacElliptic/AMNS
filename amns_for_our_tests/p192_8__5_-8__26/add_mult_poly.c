...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10964997203208157677UL) + ((((uint64_t)op[1] * 2941296632547710039UL) + ((uint64_t)op[2] * 10324545219416756958UL) + ((uint64_t)op[3] * 16490706402757709402UL) + ((uint64_t)op[4] * 12474460275086649199UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 12474460275086649199UL) + ((uint64_t)op[1] * 10964997203208157677UL) + ((((uint64_t)op[2] * 2941296632547710039UL) + ((uint64_t)op[3] * 10324545219416756958UL) + ((uint64_t)op[4] * 16490706402757709402UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 16490706402757709402UL) + ((uint64_t)op[1] * 12474460275086649199UL) + ((uint64_t)op[2] * 10964997203208157677UL) + ((((uint64_t)op[3] * 2941296632547710039UL) + ((uint64_t)op[4] * 10324545219416756958UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 10324545219416756958UL) + ((uint64_t)op[1] * 16490706402757709402UL) + ((uint64_t)op[2] * 12474460275086649199UL) + ((uint64_t)op[3] * 10964997203208157677UL) + ((uint64_t)op[4] * 13363115087037422920UL);
	tmp_q[4] = ((uint64_t)op[0] * 2941296632547710039UL) + ((uint64_t)op[1] * 10324545219416756958UL) + ((uint64_t)op[2] * 16490706402757709402UL) + ((uint64_t)op[3] * 12474460275086649199UL) + ((uint64_t)op[4] * 10964997203208157677UL);
