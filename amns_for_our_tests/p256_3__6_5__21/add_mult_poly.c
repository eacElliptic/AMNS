...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3052189181426001864UL) + ((((uint64_t)op[1] * 3125428820988755517UL) + ((uint64_t)op[2] * 16853876782361603059UL) + ((uint64_t)op[3] * 10694720006058051538UL) + ((uint64_t)op[4] * 2883560345167318135UL) + ((uint64_t)op[5] * 14968472398854843700UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 14968472398854843700UL) + ((uint64_t)op[1] * 3052189181426001864UL) + ((((uint64_t)op[2] * 3125428820988755517UL) + ((uint64_t)op[3] * 16853876782361603059UL) + ((uint64_t)op[4] * 10694720006058051538UL) + ((uint64_t)op[5] * 2883560345167318135UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 2883560345167318135UL) + ((uint64_t)op[1] * 14968472398854843700UL) + ((uint64_t)op[2] * 3052189181426001864UL) + ((((uint64_t)op[3] * 3125428820988755517UL) + ((uint64_t)op[4] * 16853876782361603059UL) + ((uint64_t)op[5] * 10694720006058051538UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 10694720006058051538UL) + ((uint64_t)op[1] * 2883560345167318135UL) + ((uint64_t)op[2] * 14968472398854843700UL) + ((uint64_t)op[3] * 3052189181426001864UL) + ((((uint64_t)op[4] * 3125428820988755517UL) + ((uint64_t)op[5] * 16853876782361603059UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 16853876782361603059UL) + ((uint64_t)op[1] * 10694720006058051538UL) + ((uint64_t)op[2] * 2883560345167318135UL) + ((uint64_t)op[3] * 14968472398854843700UL) + ((uint64_t)op[4] * 3052189181426001864UL) + ((uint64_t)op[5] * 15627144104943777585UL);
	tmp_q[5] = ((uint64_t)op[0] * 3125428820988755517UL) + ((uint64_t)op[1] * 16853876782361603059UL) + ((uint64_t)op[2] * 10694720006058051538UL) + ((uint64_t)op[3] * 2883560345167318135UL) + ((uint64_t)op[4] * 14968472398854843700UL) + ((uint64_t)op[5] * 3052189181426001864UL);
