...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16501328160651383777UL) + ((((uint64_t)op[1] * 5619189061324267436UL) + ((uint64_t)op[2] * 1985945785608092665UL) + ((uint64_t)op[3] * 3743977005044407174UL) + ((uint64_t)op[4] * 14146863575974876062UL) + ((uint64_t)op[5] * 15486429424858541259UL)) * 18446744073709551615);
	tmp_q[1] = ((uint64_t)op[0] * 15486429424858541259UL) + ((uint64_t)op[1] * 16501328160651383777UL) + ((((uint64_t)op[2] * 5619189061324267436UL) + ((uint64_t)op[3] * 1985945785608092665UL) + ((uint64_t)op[4] * 3743977005044407174UL) + ((uint64_t)op[5] * 14146863575974876062UL)) * 18446744073709551615);
	tmp_q[2] = ((uint64_t)op[0] * 14146863575974876062UL) + ((uint64_t)op[1] * 15486429424858541259UL) + ((uint64_t)op[2] * 16501328160651383777UL) + ((((uint64_t)op[3] * 5619189061324267436UL) + ((uint64_t)op[4] * 1985945785608092665UL) + ((uint64_t)op[5] * 3743977005044407174UL)) * 18446744073709551615);
	tmp_q[3] = ((uint64_t)op[0] * 3743977005044407174UL) + ((uint64_t)op[1] * 14146863575974876062UL) + ((uint64_t)op[2] * 15486429424858541259UL) + ((uint64_t)op[3] * 16501328160651383777UL) + ((((uint64_t)op[4] * 5619189061324267436UL) + ((uint64_t)op[5] * 1985945785608092665UL)) * 18446744073709551615);
	tmp_q[4] = ((uint64_t)op[0] * 1985945785608092665UL) + ((uint64_t)op[1] * 3743977005044407174UL) + ((uint64_t)op[2] * 14146863575974876062UL) + ((uint64_t)op[3] * 15486429424858541259UL) + ((uint64_t)op[4] * 16501328160651383777UL) + ((uint64_t)op[5] * 12827555012385284180UL);
	tmp_q[5] = ((uint64_t)op[0] * 5619189061324267436UL) + ((uint64_t)op[1] * 1985945785608092665UL) + ((uint64_t)op[2] * 3743977005044407174UL) + ((uint64_t)op[3] * 14146863575974876062UL) + ((uint64_t)op[4] * 15486429424858541259UL) + ((uint64_t)op[5] * 16501328160651383777UL);
