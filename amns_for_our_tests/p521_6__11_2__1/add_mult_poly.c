...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14270945964062237637UL) + ((((uint64_t)op[1] * 2669329516822033678UL) + ((uint64_t)op[2] * 6428241729418801186UL) + ((uint64_t)op[3] * 13568889618045874363UL) + ((uint64_t)op[4] * 6266122766916322633UL) + ((uint64_t)op[5] * 11363757983100489948UL) + ((uint64_t)op[6] * 18213052050245282063UL) + ((uint64_t)op[7] * 3119192727961219111UL) + ((uint64_t)op[8] * 11203697977268914367UL) + ((uint64_t)op[9] * 11861273293012357964UL) + ((uint64_t)op[10] * 7678327490110268915UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 7678327490110268915UL) + ((uint64_t)op[1] * 14270945964062237637UL) + ((((uint64_t)op[2] * 2669329516822033678UL) + ((uint64_t)op[3] * 6428241729418801186UL) + ((uint64_t)op[4] * 13568889618045874363UL) + ((uint64_t)op[5] * 6266122766916322633UL) + ((uint64_t)op[6] * 11363757983100489948UL) + ((uint64_t)op[7] * 18213052050245282063UL) + ((uint64_t)op[8] * 3119192727961219111UL) + ((uint64_t)op[9] * 11203697977268914367UL) + ((uint64_t)op[10] * 11861273293012357964UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 11861273293012357964UL) + ((uint64_t)op[1] * 7678327490110268915UL) + ((uint64_t)op[2] * 14270945964062237637UL) + ((((uint64_t)op[3] * 2669329516822033678UL) + ((uint64_t)op[4] * 6428241729418801186UL) + ((uint64_t)op[5] * 13568889618045874363UL) + ((uint64_t)op[6] * 6266122766916322633UL) + ((uint64_t)op[7] * 11363757983100489948UL) + ((uint64_t)op[8] * 18213052050245282063UL) + ((uint64_t)op[9] * 3119192727961219111UL) + ((uint64_t)op[10] * 11203697977268914367UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 11203697977268914367UL) + ((uint64_t)op[1] * 11861273293012357964UL) + ((uint64_t)op[2] * 7678327490110268915UL) + ((uint64_t)op[3] * 14270945964062237637UL) + ((((uint64_t)op[4] * 2669329516822033678UL) + ((uint64_t)op[5] * 6428241729418801186UL) + ((uint64_t)op[6] * 13568889618045874363UL) + ((uint64_t)op[7] * 6266122766916322633UL) + ((uint64_t)op[8] * 11363757983100489948UL) + ((uint64_t)op[9] * 18213052050245282063UL) + ((uint64_t)op[10] * 3119192727961219111UL)) * 2);
	tmp_q[4] = ((uint64_t)op[0] * 3119192727961219111UL) + ((uint64_t)op[1] * 11203697977268914367UL) + ((uint64_t)op[2] * 11861273293012357964UL) + ((uint64_t)op[3] * 7678327490110268915UL) + ((uint64_t)op[4] * 14270945964062237637UL) + ((((uint64_t)op[5] * 2669329516822033678UL) + ((uint64_t)op[6] * 6428241729418801186UL) + ((uint64_t)op[7] * 13568889618045874363UL) + ((uint64_t)op[8] * 6266122766916322633UL) + ((uint64_t)op[9] * 11363757983100489948UL) + ((uint64_t)op[10] * 18213052050245282063UL)) * 2);
	tmp_q[5] = ((uint64_t)op[0] * 18213052050245282063UL) + ((uint64_t)op[1] * 3119192727961219111UL) + ((uint64_t)op[2] * 11203697977268914367UL) + ((uint64_t)op[3] * 11861273293012357964UL) + ((uint64_t)op[4] * 7678327490110268915UL) + ((uint64_t)op[5] * 14270945964062237637UL) + ((((uint64_t)op[6] * 2669329516822033678UL) + ((uint64_t)op[7] * 6428241729418801186UL) + ((uint64_t)op[8] * 13568889618045874363UL) + ((uint64_t)op[9] * 6266122766916322633UL) + ((uint64_t)op[10] * 11363757983100489948UL)) * 2);
	tmp_q[6] = ((uint64_t)op[0] * 11363757983100489948UL) + ((uint64_t)op[1] * 18213052050245282063UL) + ((uint64_t)op[2] * 3119192727961219111UL) + ((uint64_t)op[3] * 11203697977268914367UL) + ((uint64_t)op[4] * 11861273293012357964UL) + ((uint64_t)op[5] * 7678327490110268915UL) + ((uint64_t)op[6] * 14270945964062237637UL) + ((((uint64_t)op[7] * 2669329516822033678UL) + ((uint64_t)op[8] * 6428241729418801186UL) + ((uint64_t)op[9] * 13568889618045874363UL) + ((uint64_t)op[10] * 6266122766916322633UL)) * 2);
	tmp_q[7] = ((uint64_t)op[0] * 6266122766916322633UL) + ((uint64_t)op[1] * 11363757983100489948UL) + ((uint64_t)op[2] * 18213052050245282063UL) + ((uint64_t)op[3] * 3119192727961219111UL) + ((uint64_t)op[4] * 11203697977268914367UL) + ((uint64_t)op[5] * 11861273293012357964UL) + ((uint64_t)op[6] * 7678327490110268915UL) + ((uint64_t)op[7] * 14270945964062237637UL) + ((((uint64_t)op[8] * 2669329516822033678UL) + ((uint64_t)op[9] * 6428241729418801186UL) + ((uint64_t)op[10] * 13568889618045874363UL)) * 2);
	tmp_q[8] = ((uint64_t)op[0] * 13568889618045874363UL) + ((uint64_t)op[1] * 6266122766916322633UL) + ((uint64_t)op[2] * 11363757983100489948UL) + ((uint64_t)op[3] * 18213052050245282063UL) + ((uint64_t)op[4] * 3119192727961219111UL) + ((uint64_t)op[5] * 11203697977268914367UL) + ((uint64_t)op[6] * 11861273293012357964UL) + ((uint64_t)op[7] * 7678327490110268915UL) + ((uint64_t)op[8] * 14270945964062237637UL) + ((((uint64_t)op[9] * 2669329516822033678UL) + ((uint64_t)op[10] * 6428241729418801186UL)) * 2);
	tmp_q[9] = ((uint64_t)op[0] * 6428241729418801186UL) + ((uint64_t)op[1] * 13568889618045874363UL) + ((uint64_t)op[2] * 6266122766916322633UL) + ((uint64_t)op[3] * 11363757983100489948UL) + ((uint64_t)op[4] * 18213052050245282063UL) + ((uint64_t)op[5] * 3119192727961219111UL) + ((uint64_t)op[6] * 11203697977268914367UL) + ((uint64_t)op[7] * 11861273293012357964UL) + ((uint64_t)op[8] * 7678327490110268915UL) + ((uint64_t)op[9] * 14270945964062237637UL) + ((uint64_t)op[10] * 5338659033644067356UL);
	tmp_q[10] = ((uint64_t)op[0] * 2669329516822033678UL) + ((uint64_t)op[1] * 6428241729418801186UL) + ((uint64_t)op[2] * 13568889618045874363UL) + ((uint64_t)op[3] * 6266122766916322633UL) + ((uint64_t)op[4] * 11363757983100489948UL) + ((uint64_t)op[5] * 18213052050245282063UL) + ((uint64_t)op[6] * 3119192727961219111UL) + ((uint64_t)op[7] * 11203697977268914367UL) + ((uint64_t)op[8] * 11861273293012357964UL) + ((uint64_t)op[9] * 7678327490110268915UL) + ((uint64_t)op[10] * 14270945964062237637UL);
