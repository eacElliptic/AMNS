...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7949500195748670399UL) + ((((uint64_t)op[1] * 11508540266256035712UL) + ((uint64_t)op[2] * 2910597786613483084UL) + ((uint64_t)op[3] * 10844027450928495672UL) + ((uint64_t)op[4] * 4629500499677767908UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 4629500499677767908UL) + ((uint64_t)op[1] * 7949500195748670399UL) + ((((uint64_t)op[2] * 11508540266256035712UL) + ((uint64_t)op[3] * 2910597786613483084UL) + ((uint64_t)op[4] * 10844027450928495672UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 10844027450928495672UL) + ((uint64_t)op[1] * 4629500499677767908UL) + ((uint64_t)op[2] * 7949500195748670399UL) + ((((uint64_t)op[3] * 11508540266256035712UL) + ((uint64_t)op[4] * 2910597786613483084UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 2910597786613483084UL) + ((uint64_t)op[1] * 10844027450928495672UL) + ((uint64_t)op[2] * 4629500499677767908UL) + ((uint64_t)op[3] * 7949500195748670399UL) + ((uint64_t)op[4] * 4570336458802519808UL);
	tmp_q[4] = ((uint64_t)op[0] * 11508540266256035712UL) + ((uint64_t)op[1] * 2910597786613483084UL) + ((uint64_t)op[2] * 10844027450928495672UL) + ((uint64_t)op[3] * 4629500499677767908UL) + ((uint64_t)op[4] * 7949500195748670399UL);
