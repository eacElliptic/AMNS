...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1087855895187421433UL) + ((((uint64_t)op[1] * 5541422521209204799UL) + ((uint64_t)op[2] * 6413469279688305091UL) + ((uint64_t)op[3] * 10382851671687677184UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 10382851671687677184UL) + ((uint64_t)op[1] * 1087855895187421433UL) + ((((uint64_t)op[2] * 5541422521209204799UL) + ((uint64_t)op[3] * 6413469279688305091UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 6413469279688305091UL) + ((uint64_t)op[1] * 10382851671687677184UL) + ((uint64_t)op[2] * 1087855895187421433UL) + ((uint64_t)op[3] * 11082845042418409598UL);
	tmp_q[3] = ((uint64_t)op[0] * 5541422521209204799UL) + ((uint64_t)op[1] * 6413469279688305091UL) + ((uint64_t)op[2] * 10382851671687677184UL) + ((uint64_t)op[3] * 1087855895187421433UL);
