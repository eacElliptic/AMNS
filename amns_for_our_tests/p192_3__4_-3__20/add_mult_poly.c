...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7637438941218181584UL) + ((((uint64_t)op[1] * 9494184720497282212UL) + ((uint64_t)op[2] * 4388948116003344717UL) + ((uint64_t)op[3] * 16503404963382636992UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 16503404963382636992UL) + ((uint64_t)op[1] * 7637438941218181584UL) + ((((uint64_t)op[2] * 9494184720497282212UL) + ((uint64_t)op[3] * 4388948116003344717UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 4388948116003344717UL) + ((uint64_t)op[1] * 16503404963382636992UL) + ((uint64_t)op[2] * 7637438941218181584UL) + ((uint64_t)op[3] * 8410933985927256596UL);
	tmp_q[3] = ((uint64_t)op[0] * 9494184720497282212UL) + ((uint64_t)op[1] * 4388948116003344717UL) + ((uint64_t)op[2] * 16503404963382636992UL) + ((uint64_t)op[3] * 7637438941218181584UL);
