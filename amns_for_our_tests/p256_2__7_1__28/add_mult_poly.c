...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14430079939325993909UL) + ((uint64_t)op[1] * 16734810617739159705UL) + ((uint64_t)op[2] * 9691824520417780814UL) + ((uint64_t)op[3] * 1513090461220109411UL) + ((uint64_t)op[4] * 5370257491773867677UL) + ((uint64_t)op[5] * 14652896196379461299UL) + ((uint64_t)op[6] * 17542931759218350854UL);
	tmp_q[1] = ((uint64_t)op[0] * 17542931759218350854UL) + ((uint64_t)op[1] * 14430079939325993909UL) + ((uint64_t)op[2] * 16734810617739159705UL) + ((uint64_t)op[3] * 9691824520417780814UL) + ((uint64_t)op[4] * 1513090461220109411UL) + ((uint64_t)op[5] * 5370257491773867677UL) + ((uint64_t)op[6] * 14652896196379461299UL);
	tmp_q[2] = ((uint64_t)op[0] * 14652896196379461299UL) + ((uint64_t)op[1] * 17542931759218350854UL) + ((uint64_t)op[2] * 14430079939325993909UL) + ((uint64_t)op[3] * 16734810617739159705UL) + ((uint64_t)op[4] * 9691824520417780814UL) + ((uint64_t)op[5] * 1513090461220109411UL) + ((uint64_t)op[6] * 5370257491773867677UL);
	tmp_q[3] = ((uint64_t)op[0] * 5370257491773867677UL) + ((uint64_t)op[1] * 14652896196379461299UL) + ((uint64_t)op[2] * 17542931759218350854UL) + ((uint64_t)op[3] * 14430079939325993909UL) + ((uint64_t)op[4] * 16734810617739159705UL) + ((uint64_t)op[5] * 9691824520417780814UL) + ((uint64_t)op[6] * 1513090461220109411UL);
	tmp_q[4] = ((uint64_t)op[0] * 1513090461220109411UL) + ((uint64_t)op[1] * 5370257491773867677UL) + ((uint64_t)op[2] * 14652896196379461299UL) + ((uint64_t)op[3] * 17542931759218350854UL) + ((uint64_t)op[4] * 14430079939325993909UL) + ((uint64_t)op[5] * 16734810617739159705UL) + ((uint64_t)op[6] * 9691824520417780814UL);
	tmp_q[5] = ((uint64_t)op[0] * 9691824520417780814UL) + ((uint64_t)op[1] * 1513090461220109411UL) + ((uint64_t)op[2] * 5370257491773867677UL) + ((uint64_t)op[3] * 14652896196379461299UL) + ((uint64_t)op[4] * 17542931759218350854UL) + ((uint64_t)op[5] * 14430079939325993909UL) + ((uint64_t)op[6] * 16734810617739159705UL);
	tmp_q[6] = ((uint64_t)op[0] * 16734810617739159705UL) + ((uint64_t)op[1] * 9691824520417780814UL) + ((uint64_t)op[2] * 1513090461220109411UL) + ((uint64_t)op[3] * 5370257491773867677UL) + ((uint64_t)op[4] * 14652896196379461299UL) + ((uint64_t)op[5] * 17542931759218350854UL) + ((uint64_t)op[6] * 14430079939325993909UL);
