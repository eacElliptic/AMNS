...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3467738515399735100UL) + ((((uint64_t)op[1] * 5481740930395249026UL) + ((uint64_t)op[2] * 14031911644075044449UL) + ((uint64_t)op[3] * 6297156649723115876UL) + ((uint64_t)op[4] * 15179555547092503325UL) + ((uint64_t)op[5] * 14142017263886853389UL) + ((uint64_t)op[6] * 8381729802404767769UL) + ((uint64_t)op[7] * 243034440342256713UL) + ((uint64_t)op[8] * 1664513833014065963UL) + ((uint64_t)op[9] * 8138829103953240050UL) + ((uint64_t)op[10] * 18441144822691474903UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 18441144822691474903UL) + ((uint64_t)op[1] * 3467738515399735100UL) + ((((uint64_t)op[2] * 5481740930395249026UL) + ((uint64_t)op[3] * 14031911644075044449UL) + ((uint64_t)op[4] * 6297156649723115876UL) + ((uint64_t)op[5] * 15179555547092503325UL) + ((uint64_t)op[6] * 14142017263886853389UL) + ((uint64_t)op[7] * 8381729802404767769UL) + ((uint64_t)op[8] * 243034440342256713UL) + ((uint64_t)op[9] * 1664513833014065963UL) + ((uint64_t)op[10] * 8138829103953240050UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 8138829103953240050UL) + ((uint64_t)op[1] * 18441144822691474903UL) + ((uint64_t)op[2] * 3467738515399735100UL) + ((((uint64_t)op[3] * 5481740930395249026UL) + ((uint64_t)op[4] * 14031911644075044449UL) + ((uint64_t)op[5] * 6297156649723115876UL) + ((uint64_t)op[6] * 15179555547092503325UL) + ((uint64_t)op[7] * 14142017263886853389UL) + ((uint64_t)op[8] * 8381729802404767769UL) + ((uint64_t)op[9] * 243034440342256713UL) + ((uint64_t)op[10] * 1664513833014065963UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 1664513833014065963UL) + ((uint64_t)op[1] * 8138829103953240050UL) + ((uint64_t)op[2] * 18441144822691474903UL) + ((uint64_t)op[3] * 3467738515399735100UL) + ((((uint64_t)op[4] * 5481740930395249026UL) + ((uint64_t)op[5] * 14031911644075044449UL) + ((uint64_t)op[6] * 6297156649723115876UL) + ((uint64_t)op[7] * 15179555547092503325UL) + ((uint64_t)op[8] * 14142017263886853389UL) + ((uint64_t)op[9] * 8381729802404767769UL) + ((uint64_t)op[10] * 243034440342256713UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 243034440342256713UL) + ((uint64_t)op[1] * 1664513833014065963UL) + ((uint64_t)op[2] * 8138829103953240050UL) + ((uint64_t)op[3] * 18441144822691474903UL) + ((uint64_t)op[4] * 3467738515399735100UL) + ((((uint64_t)op[5] * 5481740930395249026UL) + ((uint64_t)op[6] * 14031911644075044449UL) + ((uint64_t)op[7] * 6297156649723115876UL) + ((uint64_t)op[8] * 15179555547092503325UL) + ((uint64_t)op[9] * 14142017263886853389UL) + ((uint64_t)op[10] * 8381729802404767769UL)) * 5);
	tmp_q[5] = ((uint64_t)op[0] * 8381729802404767769UL) + ((uint64_t)op[1] * 243034440342256713UL) + ((uint64_t)op[2] * 1664513833014065963UL) + ((uint64_t)op[3] * 8138829103953240050UL) + ((uint64_t)op[4] * 18441144822691474903UL) + ((uint64_t)op[5] * 3467738515399735100UL) + ((((uint64_t)op[6] * 5481740930395249026UL) + ((uint64_t)op[7] * 14031911644075044449UL) + ((uint64_t)op[8] * 6297156649723115876UL) + ((uint64_t)op[9] * 15179555547092503325UL) + ((uint64_t)op[10] * 14142017263886853389UL)) * 5);
	tmp_q[6] = ((uint64_t)op[0] * 14142017263886853389UL) + ((uint64_t)op[1] * 8381729802404767769UL) + ((uint64_t)op[2] * 243034440342256713UL) + ((uint64_t)op[3] * 1664513833014065963UL) + ((uint64_t)op[4] * 8138829103953240050UL) + ((uint64_t)op[5] * 18441144822691474903UL) + ((uint64_t)op[6] * 3467738515399735100UL) + ((((uint64_t)op[7] * 5481740930395249026UL) + ((uint64_t)op[8] * 14031911644075044449UL) + ((uint64_t)op[9] * 6297156649723115876UL) + ((uint64_t)op[10] * 15179555547092503325UL)) * 5);
	tmp_q[7] = ((uint64_t)op[0] * 15179555547092503325UL) + ((uint64_t)op[1] * 14142017263886853389UL) + ((uint64_t)op[2] * 8381729802404767769UL) + ((uint64_t)op[3] * 243034440342256713UL) + ((uint64_t)op[4] * 1664513833014065963UL) + ((uint64_t)op[5] * 8138829103953240050UL) + ((uint64_t)op[6] * 18441144822691474903UL) + ((uint64_t)op[7] * 3467738515399735100UL) + ((((uint64_t)op[8] * 5481740930395249026UL) + ((uint64_t)op[9] * 14031911644075044449UL) + ((uint64_t)op[10] * 6297156649723115876UL)) * 5);
	tmp_q[8] = ((uint64_t)op[0] * 6297156649723115876UL) + ((uint64_t)op[1] * 15179555547092503325UL) + ((uint64_t)op[2] * 14142017263886853389UL) + ((uint64_t)op[3] * 8381729802404767769UL) + ((uint64_t)op[4] * 243034440342256713UL) + ((uint64_t)op[5] * 1664513833014065963UL) + ((uint64_t)op[6] * 8138829103953240050UL) + ((uint64_t)op[7] * 18441144822691474903UL) + ((uint64_t)op[8] * 3467738515399735100UL) + ((((uint64_t)op[9] * 5481740930395249026UL) + ((uint64_t)op[10] * 14031911644075044449UL)) * 5);
	tmp_q[9] = ((uint64_t)op[0] * 14031911644075044449UL) + ((uint64_t)op[1] * 6297156649723115876UL) + ((uint64_t)op[2] * 15179555547092503325UL) + ((uint64_t)op[3] * 14142017263886853389UL) + ((uint64_t)op[4] * 8381729802404767769UL) + ((uint64_t)op[5] * 243034440342256713UL) + ((uint64_t)op[6] * 1664513833014065963UL) + ((uint64_t)op[7] * 8138829103953240050UL) + ((uint64_t)op[8] * 18441144822691474903UL) + ((uint64_t)op[9] * 3467738515399735100UL) + ((uint64_t)op[10] * 8961960578266693514UL);
	tmp_q[10] = ((uint64_t)op[0] * 5481740930395249026UL) + ((uint64_t)op[1] * 14031911644075044449UL) + ((uint64_t)op[2] * 6297156649723115876UL) + ((uint64_t)op[3] * 15179555547092503325UL) + ((uint64_t)op[4] * 14142017263886853389UL) + ((uint64_t)op[5] * 8381729802404767769UL) + ((uint64_t)op[6] * 243034440342256713UL) + ((uint64_t)op[7] * 1664513833014065963UL) + ((uint64_t)op[8] * 8138829103953240050UL) + ((uint64_t)op[9] * 18441144822691474903UL) + ((uint64_t)op[10] * 3467738515399735100UL);
