...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15074114780743224916UL) + ((((uint64_t)op[1] * 17456093136004733486UL) + ((uint64_t)op[2] * 6779787018165932578UL) + ((uint64_t)op[3] * 2978177403483349772UL) + ((uint64_t)op[4] * 313785734392067445UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 313785734392067445UL) + ((uint64_t)op[1] * 15074114780743224916UL) + ((((uint64_t)op[2] * 17456093136004733486UL) + ((uint64_t)op[3] * 6779787018165932578UL) + ((uint64_t)op[4] * 2978177403483349772UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 2978177403483349772UL) + ((uint64_t)op[1] * 313785734392067445UL) + ((uint64_t)op[2] * 15074114780743224916UL) + ((((uint64_t)op[3] * 17456093136004733486UL) + ((uint64_t)op[4] * 6779787018165932578UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 6779787018165932578UL) + ((uint64_t)op[1] * 2978177403483349772UL) + ((uint64_t)op[2] * 313785734392067445UL) + ((uint64_t)op[3] * 15074114780743224916UL) + ((uint64_t)op[4] * 4953254688524090650UL);
	tmp_q[4] = ((uint64_t)op[0] * 17456093136004733486UL) + ((uint64_t)op[1] * 6779787018165932578UL) + ((uint64_t)op[2] * 2978177403483349772UL) + ((uint64_t)op[3] * 313785734392067445UL) + ((uint64_t)op[4] * 15074114780743224916UL);
