...
void init_data(){
	...
	mpz_set_str (modul_p, "5586813758178031381954288472151500116531339198329727352161", 10);

	mpz_set_str (gama_pow[0], "2471533555212767093296217676200624181718562983213583506889", 10);
