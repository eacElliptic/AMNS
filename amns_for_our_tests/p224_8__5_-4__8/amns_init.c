...
void init_data(){
	...
	mpz_set_str (modul_p, "13754587292924424404169422123714852109009842673653096894209648133687", 10);

	mpz_set_str (gama_pow[0], "13619799911861553725707342013593212248158380182283568600549809276245", 10);
