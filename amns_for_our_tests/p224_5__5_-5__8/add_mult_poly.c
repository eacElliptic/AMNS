...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 332569916037684463UL) + ((((uint64_t)op[1] * 8601912738712445750UL) + ((uint64_t)op[2] * 1665871752822393707UL) + ((uint64_t)op[3] * 16945593411965097423UL) + ((uint64_t)op[4] * 11694318740217316340UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 11694318740217316340UL) + ((uint64_t)op[1] * 332569916037684463UL) + ((((uint64_t)op[2] * 8601912738712445750UL) + ((uint64_t)op[3] * 1665871752822393707UL) + ((uint64_t)op[4] * 16945593411965097423UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 16945593411965097423UL) + ((uint64_t)op[1] * 11694318740217316340UL) + ((uint64_t)op[2] * 332569916037684463UL) + ((((uint64_t)op[3] * 8601912738712445750UL) + ((uint64_t)op[4] * 1665871752822393707UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 1665871752822393707UL) + ((uint64_t)op[1] * 16945593411965097423UL) + ((uint64_t)op[2] * 11694318740217316340UL) + ((uint64_t)op[3] * 332569916037684463UL) + ((uint64_t)op[4] * 12330668527566426098UL);
	tmp_q[4] = ((uint64_t)op[0] * 8601912738712445750UL) + ((uint64_t)op[1] * 1665871752822393707UL) + ((uint64_t)op[2] * 16945593411965097423UL) + ((uint64_t)op[3] * 11694318740217316340UL) + ((uint64_t)op[4] * 332569916037684463UL);
