...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14841648182991122707UL) + ((((uint64_t)op[1] * 17005299622032109353UL) + ((uint64_t)op[2] * 15455983127868570401UL) + ((uint64_t)op[3] * 14031017329540387614UL) + ((uint64_t)op[4] * 1417022121757378615UL) + ((uint64_t)op[5] * 10367248199616527435UL)) * 8);
	tmp_q[1] = ((uint64_t)op[0] * 10367248199616527435UL) + ((uint64_t)op[1] * 14841648182991122707UL) + ((((uint64_t)op[2] * 17005299622032109353UL) + ((uint64_t)op[3] * 15455983127868570401UL) + ((uint64_t)op[4] * 14031017329540387614UL) + ((uint64_t)op[5] * 1417022121757378615UL)) * 8);
	tmp_q[2] = ((uint64_t)op[0] * 1417022121757378615UL) + ((uint64_t)op[1] * 10367248199616527435UL) + ((uint64_t)op[2] * 14841648182991122707UL) + ((((uint64_t)op[3] * 17005299622032109353UL) + ((uint64_t)op[4] * 15455983127868570401UL) + ((uint64_t)op[5] * 14031017329540387614UL)) * 8);
	tmp_q[3] = ((uint64_t)op[0] * 14031017329540387614UL) + ((uint64_t)op[1] * 1417022121757378615UL) + ((uint64_t)op[2] * 10367248199616527435UL) + ((uint64_t)op[3] * 14841648182991122707UL) + ((((uint64_t)op[4] * 17005299622032109353UL) + ((uint64_t)op[5] * 15455983127868570401UL)) * 8);
	tmp_q[4] = ((uint64_t)op[0] * 15455983127868570401UL) + ((uint64_t)op[1] * 14031017329540387614UL) + ((uint64_t)op[2] * 1417022121757378615UL) + ((uint64_t)op[3] * 10367248199616527435UL) + ((uint64_t)op[4] * 14841648182991122707UL) + ((uint64_t)op[5] * 6915188460290013512UL);
	tmp_q[5] = ((uint64_t)op[0] * 17005299622032109353UL) + ((uint64_t)op[1] * 15455983127868570401UL) + ((uint64_t)op[2] * 14031017329540387614UL) + ((uint64_t)op[3] * 1417022121757378615UL) + ((uint64_t)op[4] * 10367248199616527435UL) + ((uint64_t)op[5] * 14841648182991122707UL);
