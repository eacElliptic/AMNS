...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8476779484070440184UL) + ((((uint64_t)op[1] * 13929704599282112998UL) + ((uint64_t)op[2] * 17546553678431452673UL) + ((uint64_t)op[3] * 10673261226861977802UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 10673261226861977802UL) + ((uint64_t)op[1] * 8476779484070440184UL) + ((((uint64_t)op[2] * 13929704599282112998UL) + ((uint64_t)op[3] * 17546553678431452673UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 17546553678431452673UL) + ((uint64_t)op[1] * 10673261226861977802UL) + ((uint64_t)op[2] * 8476779484070440184UL) + ((uint64_t)op[3] * 13172532247282518710UL);
	tmp_q[3] = ((uint64_t)op[0] * 13929704599282112998UL) + ((uint64_t)op[1] * 17546553678431452673UL) + ((uint64_t)op[2] * 10673261226861977802UL) + ((uint64_t)op[3] * 8476779484070440184UL);
