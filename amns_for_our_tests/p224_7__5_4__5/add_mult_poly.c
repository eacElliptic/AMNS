...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10548136847017986467UL) + ((((uint64_t)op[1] * 3287711773104531336UL) + ((uint64_t)op[2] * 7852265130802090293UL) + ((uint64_t)op[3] * 12040240318732937989UL) + ((uint64_t)op[4] * 5555820543469565491UL)) * 4);
	tmp_q[1] = ((uint64_t)op[0] * 5555820543469565491UL) + ((uint64_t)op[1] * 10548136847017986467UL) + ((((uint64_t)op[2] * 3287711773104531336UL) + ((uint64_t)op[3] * 7852265130802090293UL) + ((uint64_t)op[4] * 12040240318732937989UL)) * 4);
	tmp_q[2] = ((uint64_t)op[0] * 12040240318732937989UL) + ((uint64_t)op[1] * 5555820543469565491UL) + ((uint64_t)op[2] * 10548136847017986467UL) + ((((uint64_t)op[3] * 3287711773104531336UL) + ((uint64_t)op[4] * 7852265130802090293UL)) * 4);
	tmp_q[3] = ((uint64_t)op[0] * 7852265130802090293UL) + ((uint64_t)op[1] * 12040240318732937989UL) + ((uint64_t)op[2] * 5555820543469565491UL) + ((uint64_t)op[3] * 10548136847017986467UL) + ((uint64_t)op[4] * 13150847092418125344UL);
	tmp_q[4] = ((uint64_t)op[0] * 3287711773104531336UL) + ((uint64_t)op[1] * 7852265130802090293UL) + ((uint64_t)op[2] * 12040240318732937989UL) + ((uint64_t)op[3] * 5555820543469565491UL) + ((uint64_t)op[4] * 10548136847017986467UL);
