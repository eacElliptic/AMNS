...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1850973340442256379UL) + ((((uint64_t)op[1] * 12136052694525203682UL) + ((uint64_t)op[2] * 12442399374321008199UL) + ((uint64_t)op[3] * 7164986631605735321UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 7164986631605735321UL) + ((uint64_t)op[1] * 1850973340442256379UL) + ((((uint64_t)op[2] * 12136052694525203682UL) + ((uint64_t)op[3] * 12442399374321008199UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 12442399374321008199UL) + ((uint64_t)op[1] * 7164986631605735321UL) + ((uint64_t)op[2] * 1850973340442256379UL) + ((uint64_t)op[3] * 13592042886055680240UL);
	tmp_q[3] = ((uint64_t)op[0] * 12136052694525203682UL) + ((uint64_t)op[1] * 12442399374321008199UL) + ((uint64_t)op[2] * 7164986631605735321UL) + ((uint64_t)op[3] * 1850973340442256379UL);
