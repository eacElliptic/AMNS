...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9501015672110835UL) + ((((uint64_t)op[1] * 3818240667842655101UL) + ((uint64_t)op[2] * 16284782288700349892UL) + ((uint64_t)op[3] * 14432223613525247941UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 14432223613525247941UL) + ((uint64_t)op[1] * 9501015672110835UL) + ((((uint64_t)op[2] * 3818240667842655101UL) + ((uint64_t)op[3] * 16284782288700349892UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 16284782288700349892UL) + ((uint64_t)op[1] * 14432223613525247941UL) + ((uint64_t)op[2] * 9501015672110835UL) + ((uint64_t)op[3] * 4462699933346378990UL);
	tmp_q[3] = ((uint64_t)op[0] * 3818240667842655101UL) + ((uint64_t)op[1] * 16284782288700349892UL) + ((uint64_t)op[2] * 14432223613525247941UL) + ((uint64_t)op[3] * 9501015672110835UL);
