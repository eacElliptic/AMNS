...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17938432657587224280UL) + ((((uint64_t)op[1] * 3057272475926735445UL) + ((uint64_t)op[2] * 5974536014431696765UL) + ((uint64_t)op[3] * 15697300765962808534UL) + ((uint64_t)op[4] * 3024244479734952129UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 3024244479734952129UL) + ((uint64_t)op[1] * 17938432657587224280UL) + ((((uint64_t)op[2] * 3057272475926735445UL) + ((uint64_t)op[3] * 5974536014431696765UL) + ((uint64_t)op[4] * 15697300765962808534UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 15697300765962808534UL) + ((uint64_t)op[1] * 3024244479734952129UL) + ((uint64_t)op[2] * 17938432657587224280UL) + ((((uint64_t)op[3] * 3057272475926735445UL) + ((uint64_t)op[4] * 5974536014431696765UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 5974536014431696765UL) + ((uint64_t)op[1] * 15697300765962808534UL) + ((uint64_t)op[2] * 3024244479734952129UL) + ((uint64_t)op[3] * 17938432657587224280UL) + ((uint64_t)op[4] * 3160381694075874391UL);
	tmp_q[4] = ((uint64_t)op[0] * 3057272475926735445UL) + ((uint64_t)op[1] * 5974536014431696765UL) + ((uint64_t)op[2] * 15697300765962808534UL) + ((uint64_t)op[3] * 3024244479734952129UL) + ((uint64_t)op[4] * 17938432657587224280UL);
