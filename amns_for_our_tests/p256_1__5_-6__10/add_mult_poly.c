...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13320673746643996695UL) + ((((uint64_t)op[1] * 15955617255134629844UL) + ((uint64_t)op[2] * 11197639827285054900UL) + ((uint64_t)op[3] * 4089899347276311051UL) + ((uint64_t)op[4] * 15593017805403906106UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 15593017805403906106UL) + ((uint64_t)op[1] * 13320673746643996695UL) + ((((uint64_t)op[2] * 15955617255134629844UL) + ((uint64_t)op[3] * 11197639827285054900UL) + ((uint64_t)op[4] * 4089899347276311051UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 4089899347276311051UL) + ((uint64_t)op[1] * 15593017805403906106UL) + ((uint64_t)op[2] * 13320673746643996695UL) + ((((uint64_t)op[3] * 15955617255134629844UL) + ((uint64_t)op[4] * 11197639827285054900UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 11197639827285054900UL) + ((uint64_t)op[1] * 4089899347276311051UL) + ((uint64_t)op[2] * 15593017805403906106UL) + ((uint64_t)op[3] * 13320673746643996695UL) + ((uint64_t)op[4] * 14946760911449530632UL);
	tmp_q[4] = ((uint64_t)op[0] * 15955617255134629844UL) + ((uint64_t)op[1] * 11197639827285054900UL) + ((uint64_t)op[2] * 4089899347276311051UL) + ((uint64_t)op[3] * 15593017805403906106UL) + ((uint64_t)op[4] * 13320673746643996695UL);
