...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 18281979083909087635UL) + ((((uint64_t)op[1] * 10432693181201018504UL) + ((uint64_t)op[2] * 2207732639735558995UL) + ((uint64_t)op[3] * 5135659752509949940UL) + ((uint64_t)op[4] * 17926323916765344497UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 17926323916765344497UL) + ((uint64_t)op[1] * 18281979083909087635UL) + ((((uint64_t)op[2] * 10432693181201018504UL) + ((uint64_t)op[3] * 2207732639735558995UL) + ((uint64_t)op[4] * 5135659752509949940UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 5135659752509949940UL) + ((uint64_t)op[1] * 17926323916765344497UL) + ((uint64_t)op[2] * 18281979083909087635UL) + ((((uint64_t)op[3] * 10432693181201018504UL) + ((uint64_t)op[4] * 2207732639735558995UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 2207732639735558995UL) + ((uint64_t)op[1] * 5135659752509949940UL) + ((uint64_t)op[2] * 17926323916765344497UL) + ((uint64_t)op[3] * 18281979083909087635UL) + ((uint64_t)op[4] * 15269977758585989288UL);
	tmp_q[4] = ((uint64_t)op[0] * 10432693181201018504UL) + ((uint64_t)op[1] * 2207732639735558995UL) + ((uint64_t)op[2] * 5135659752509949940UL) + ((uint64_t)op[3] * 17926323916765344497UL) + ((uint64_t)op[4] * 18281979083909087635UL);
