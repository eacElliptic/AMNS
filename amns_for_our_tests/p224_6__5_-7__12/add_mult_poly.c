...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6359187557528796305UL) + ((((uint64_t)op[1] * 3783363769431763111UL) + ((uint64_t)op[2] * 4142988075308204600UL) + ((uint64_t)op[3] * 10174773227776121047UL) + ((uint64_t)op[4] * 9436479881568804916UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 9436479881568804916UL) + ((uint64_t)op[1] * 6359187557528796305UL) + ((((uint64_t)op[2] * 3783363769431763111UL) + ((uint64_t)op[3] * 4142988075308204600UL) + ((uint64_t)op[4] * 10174773227776121047UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 10174773227776121047UL) + ((uint64_t)op[1] * 9436479881568804916UL) + ((uint64_t)op[2] * 6359187557528796305UL) + ((((uint64_t)op[3] * 3783363769431763111UL) + ((uint64_t)op[4] * 4142988075308204600UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 4142988075308204600UL) + ((uint64_t)op[1] * 10174773227776121047UL) + ((uint64_t)op[2] * 9436479881568804916UL) + ((uint64_t)op[3] * 6359187557528796305UL) + ((uint64_t)op[4] * 10409941761396761455UL);
	tmp_q[4] = ((uint64_t)op[0] * 3783363769431763111UL) + ((uint64_t)op[1] * 4142988075308204600UL) + ((uint64_t)op[2] * 10174773227776121047UL) + ((uint64_t)op[3] * 9436479881568804916UL) + ((uint64_t)op[4] * 6359187557528796305UL);
