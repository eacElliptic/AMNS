...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1657262359104878967UL) + ((((uint64_t)op[1] * 12801301339534847489UL) + ((uint64_t)op[2] * 6111486186946653963UL) + ((uint64_t)op[3] * 16495131515819765716UL) + ((uint64_t)op[4] * 1136973404002880274UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 1136973404002880274UL) + ((uint64_t)op[1] * 1657262359104878967UL) + ((((uint64_t)op[2] * 12801301339534847489UL) + ((uint64_t)op[3] * 6111486186946653963UL) + ((uint64_t)op[4] * 16495131515819765716UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 16495131515819765716UL) + ((uint64_t)op[1] * 1136973404002880274UL) + ((uint64_t)op[2] * 1657262359104878967UL) + ((((uint64_t)op[3] * 12801301339534847489UL) + ((uint64_t)op[4] * 6111486186946653963UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 6111486186946653963UL) + ((uint64_t)op[1] * 16495131515819765716UL) + ((uint64_t)op[2] * 1136973404002880274UL) + ((uint64_t)op[3] * 1657262359104878967UL) + ((uint64_t)op[4] * 3020831742370878470UL);
	tmp_q[4] = ((uint64_t)op[0] * 12801301339534847489UL) + ((uint64_t)op[1] * 6111486186946653963UL) + ((uint64_t)op[2] * 16495131515819765716UL) + ((uint64_t)op[3] * 1136973404002880274UL) + ((uint64_t)op[4] * 1657262359104878967UL);
