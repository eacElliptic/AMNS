...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12461641886127938505UL) + ((((uint64_t)op[1] * 18104258453495208669UL) + ((uint64_t)op[2] * 7042999826177049946UL) + ((uint64_t)op[3] * 2867085358695916190UL) + ((uint64_t)op[4] * 18204834474542347176UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 18204834474542347176UL) + ((uint64_t)op[1] * 12461641886127938505UL) + ((((uint64_t)op[2] * 18104258453495208669UL) + ((uint64_t)op[3] * 7042999826177049946UL) + ((uint64_t)op[4] * 2867085358695916190UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 2867085358695916190UL) + ((uint64_t)op[1] * 18204834474542347176UL) + ((uint64_t)op[2] * 12461641886127938505UL) + ((((uint64_t)op[3] * 18104258453495208669UL) + ((uint64_t)op[4] * 7042999826177049946UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 7042999826177049946UL) + ((uint64_t)op[1] * 2867085358695916190UL) + ((uint64_t)op[2] * 18204834474542347176UL) + ((uint64_t)op[3] * 12461641886127938505UL) + ((uint64_t)op[4] * 16391830352423493934UL);
	tmp_q[4] = ((uint64_t)op[0] * 18104258453495208669UL) + ((uint64_t)op[1] * 7042999826177049946UL) + ((uint64_t)op[2] * 2867085358695916190UL) + ((uint64_t)op[3] * 18204834474542347176UL) + ((uint64_t)op[4] * 12461641886127938505UL);
