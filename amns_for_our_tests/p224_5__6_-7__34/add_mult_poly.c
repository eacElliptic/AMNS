...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3141692149071644925UL) + ((((uint64_t)op[1] * 9092417665089363646UL) + ((uint64_t)op[2] * 12296337649898852326UL) + ((uint64_t)op[3] * 5506697994273937117UL) + ((uint64_t)op[4] * 17491480678112287984UL) + ((uint64_t)op[5] * 1283543349682411111UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 1283543349682411111UL) + ((uint64_t)op[1] * 3141692149071644925UL) + ((((uint64_t)op[2] * 9092417665089363646UL) + ((uint64_t)op[3] * 12296337649898852326UL) + ((uint64_t)op[4] * 5506697994273937117UL) + ((uint64_t)op[5] * 17491480678112287984UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 17491480678112287984UL) + ((uint64_t)op[1] * 1283543349682411111UL) + ((uint64_t)op[2] * 3141692149071644925UL) + ((((uint64_t)op[3] * 9092417665089363646UL) + ((uint64_t)op[4] * 12296337649898852326UL) + ((uint64_t)op[5] * 5506697994273937117UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 5506697994273937117UL) + ((uint64_t)op[1] * 17491480678112287984UL) + ((uint64_t)op[2] * 1283543349682411111UL) + ((uint64_t)op[3] * 3141692149071644925UL) + ((((uint64_t)op[4] * 9092417665089363646UL) + ((uint64_t)op[5] * 12296337649898852326UL)) * 18446744073709551609);
	tmp_q[4] = ((uint64_t)op[0] * 12296337649898852326UL) + ((uint64_t)op[1] * 5506697994273937117UL) + ((uint64_t)op[2] * 17491480678112287984UL) + ((uint64_t)op[3] * 1283543349682411111UL) + ((uint64_t)op[4] * 3141692149071644925UL) + ((uint64_t)op[5] * 10140052639212660942UL);
	tmp_q[5] = ((uint64_t)op[0] * 9092417665089363646UL) + ((uint64_t)op[1] * 12296337649898852326UL) + ((uint64_t)op[2] * 5506697994273937117UL) + ((uint64_t)op[3] * 17491480678112287984UL) + ((uint64_t)op[4] * 1283543349682411111UL) + ((uint64_t)op[5] * 3141692149071644925UL);
