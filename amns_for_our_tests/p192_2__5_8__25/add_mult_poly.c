...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14617475749330751917UL) + ((((uint64_t)op[1] * 11208600313900092258UL) + ((uint64_t)op[2] * 16655566602296539342UL) + ((uint64_t)op[3] * 14227300269943098882UL) + ((uint64_t)op[4] * 9384256597321380847UL)) * 8);
	tmp_q[1] = ((uint64_t)op[0] * 9384256597321380847UL) + ((uint64_t)op[1] * 14617475749330751917UL) + ((((uint64_t)op[2] * 11208600313900092258UL) + ((uint64_t)op[3] * 16655566602296539342UL) + ((uint64_t)op[4] * 14227300269943098882UL)) * 8);
	tmp_q[2] = ((uint64_t)op[0] * 14227300269943098882UL) + ((uint64_t)op[1] * 9384256597321380847UL) + ((uint64_t)op[2] * 14617475749330751917UL) + ((((uint64_t)op[3] * 11208600313900092258UL) + ((uint64_t)op[4] * 16655566602296539342UL)) * 8);
	tmp_q[3] = ((uint64_t)op[0] * 16655566602296539342UL) + ((uint64_t)op[1] * 14227300269943098882UL) + ((uint64_t)op[2] * 9384256597321380847UL) + ((uint64_t)op[3] * 14617475749330751917UL) + ((uint64_t)op[4] * 15881826216362531600UL);
	tmp_q[4] = ((uint64_t)op[0] * 11208600313900092258UL) + ((uint64_t)op[1] * 16655566602296539342UL) + ((uint64_t)op[2] * 14227300269943098882UL) + ((uint64_t)op[3] * 9384256597321380847UL) + ((uint64_t)op[4] * 14617475749330751917UL);
