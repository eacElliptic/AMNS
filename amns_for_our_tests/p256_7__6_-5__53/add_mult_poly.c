...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 202279029393143836UL) + ((((uint64_t)op[1] * 10684728608295967750UL) + ((uint64_t)op[2] * 10988194759665313797UL) + ((uint64_t)op[3] * 6691589402014324214UL) + ((uint64_t)op[4] * 17860494095774620318UL) + ((uint64_t)op[5] * 14812327051859616540UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 14812327051859616540UL) + ((uint64_t)op[1] * 202279029393143836UL) + ((((uint64_t)op[2] * 10684728608295967750UL) + ((uint64_t)op[3] * 10988194759665313797UL) + ((uint64_t)op[4] * 6691589402014324214UL) + ((uint64_t)op[5] * 17860494095774620318UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 17860494095774620318UL) + ((uint64_t)op[1] * 14812327051859616540UL) + ((uint64_t)op[2] * 202279029393143836UL) + ((((uint64_t)op[3] * 10684728608295967750UL) + ((uint64_t)op[4] * 10988194759665313797UL) + ((uint64_t)op[5] * 6691589402014324214UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 6691589402014324214UL) + ((uint64_t)op[1] * 17860494095774620318UL) + ((uint64_t)op[2] * 14812327051859616540UL) + ((uint64_t)op[3] * 202279029393143836UL) + ((((uint64_t)op[4] * 10684728608295967750UL) + ((uint64_t)op[5] * 10988194759665313797UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 10988194759665313797UL) + ((uint64_t)op[1] * 6691589402014324214UL) + ((uint64_t)op[2] * 17860494095774620318UL) + ((uint64_t)op[3] * 14812327051859616540UL) + ((uint64_t)op[4] * 202279029393143836UL) + ((uint64_t)op[5] * 1916589179648816098UL);
	tmp_q[5] = ((uint64_t)op[0] * 10684728608295967750UL) + ((uint64_t)op[1] * 10988194759665313797UL) + ((uint64_t)op[2] * 6691589402014324214UL) + ((uint64_t)op[3] * 17860494095774620318UL) + ((uint64_t)op[4] * 14812327051859616540UL) + ((uint64_t)op[5] * 202279029393143836UL);
