...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3016134816167093049UL) + ((((uint64_t)op[1] * 13900702924615419586UL) + ((uint64_t)op[2] * 8065225529987208589UL) + ((uint64_t)op[3] * 15994458192359243209UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 15994458192359243209UL) + ((uint64_t)op[1] * 3016134816167093049UL) + ((((uint64_t)op[2] * 13900702924615419586UL) + ((uint64_t)op[3] * 8065225529987208589UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 8065225529987208589UL) + ((uint64_t)op[1] * 15994458192359243209UL) + ((uint64_t)op[2] * 3016134816167093049UL) + ((uint64_t)op[3] * 8829502820855240564UL);
	tmp_q[3] = ((uint64_t)op[0] * 13900702924615419586UL) + ((uint64_t)op[1] * 8065225529987208589UL) + ((uint64_t)op[2] * 15994458192359243209UL) + ((uint64_t)op[3] * 3016134816167093049UL);
