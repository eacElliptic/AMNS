...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12193335726171937046UL) + ((((uint64_t)op[1] * 4604370317748314554UL) + ((uint64_t)op[2] * 15778762711439728060UL) + ((uint64_t)op[3] * 10660634921625913408UL) + ((uint64_t)op[4] * 14683229265290804864UL) + ((uint64_t)op[5] * 8069215419833767991UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 8069215419833767991UL) + ((uint64_t)op[1] * 12193335726171937046UL) + ((((uint64_t)op[2] * 4604370317748314554UL) + ((uint64_t)op[3] * 15778762711439728060UL) + ((uint64_t)op[4] * 10660634921625913408UL) + ((uint64_t)op[5] * 14683229265290804864UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 14683229265290804864UL) + ((uint64_t)op[1] * 8069215419833767991UL) + ((uint64_t)op[2] * 12193335726171937046UL) + ((((uint64_t)op[3] * 4604370317748314554UL) + ((uint64_t)op[4] * 15778762711439728060UL) + ((uint64_t)op[5] * 10660634921625913408UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 10660634921625913408UL) + ((uint64_t)op[1] * 14683229265290804864UL) + ((uint64_t)op[2] * 8069215419833767991UL) + ((uint64_t)op[3] * 12193335726171937046UL) + ((((uint64_t)op[4] * 4604370317748314554UL) + ((uint64_t)op[5] * 15778762711439728060UL)) * 18446744073709551611);
	tmp_q[4] = ((uint64_t)op[0] * 15778762711439728060UL) + ((uint64_t)op[1] * 10660634921625913408UL) + ((uint64_t)op[2] * 14683229265290804864UL) + ((uint64_t)op[3] * 8069215419833767991UL) + ((uint64_t)op[4] * 12193335726171937046UL) + ((uint64_t)op[5] * 13871636558677530462UL);
	tmp_q[5] = ((uint64_t)op[0] * 4604370317748314554UL) + ((uint64_t)op[1] * 15778762711439728060UL) + ((uint64_t)op[2] * 10660634921625913408UL) + ((uint64_t)op[3] * 14683229265290804864UL) + ((uint64_t)op[4] * 8069215419833767991UL) + ((uint64_t)op[5] * 12193335726171937046UL);
