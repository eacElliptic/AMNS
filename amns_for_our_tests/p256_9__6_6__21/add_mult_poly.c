...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14038851869899999509UL) + ((((uint64_t)op[1] * 12982573072644405378UL) + ((uint64_t)op[2] * 5414994660439508063UL) + ((uint64_t)op[3] * 3873425678447965854UL) + ((uint64_t)op[4] * 1087406978345860525UL) + ((uint64_t)op[5] * 16567929738647538952UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 16567929738647538952UL) + ((uint64_t)op[1] * 14038851869899999509UL) + ((((uint64_t)op[2] * 12982573072644405378UL) + ((uint64_t)op[3] * 5414994660439508063UL) + ((uint64_t)op[4] * 3873425678447965854UL) + ((uint64_t)op[5] * 1087406978345860525UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 1087406978345860525UL) + ((uint64_t)op[1] * 16567929738647538952UL) + ((uint64_t)op[2] * 14038851869899999509UL) + ((((uint64_t)op[3] * 12982573072644405378UL) + ((uint64_t)op[4] * 5414994660439508063UL) + ((uint64_t)op[5] * 3873425678447965854UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 3873425678447965854UL) + ((uint64_t)op[1] * 1087406978345860525UL) + ((uint64_t)op[2] * 16567929738647538952UL) + ((uint64_t)op[3] * 14038851869899999509UL) + ((((uint64_t)op[4] * 12982573072644405378UL) + ((uint64_t)op[5] * 5414994660439508063UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 5414994660439508063UL) + ((uint64_t)op[1] * 3873425678447965854UL) + ((uint64_t)op[2] * 1087406978345860525UL) + ((uint64_t)op[3] * 16567929738647538952UL) + ((uint64_t)op[4] * 14038851869899999509UL) + ((uint64_t)op[5] * 4108462141028225804UL);
	tmp_q[5] = ((uint64_t)op[0] * 12982573072644405378UL) + ((uint64_t)op[1] * 5414994660439508063UL) + ((uint64_t)op[2] * 3873425678447965854UL) + ((uint64_t)op[3] * 1087406978345860525UL) + ((uint64_t)op[4] * 16567929738647538952UL) + ((uint64_t)op[5] * 14038851869899999509UL);
