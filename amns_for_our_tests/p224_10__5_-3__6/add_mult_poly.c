...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14598551433453741301UL) + ((((uint64_t)op[1] * 4170843000761427489UL) + ((uint64_t)op[2] * 2114234097026144643UL) + ((uint64_t)op[3] * 10496868331823263852UL) + ((uint64_t)op[4] * 10570775247676002692UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 10570775247676002692UL) + ((uint64_t)op[1] * 14598551433453741301UL) + ((((uint64_t)op[2] * 4170843000761427489UL) + ((uint64_t)op[3] * 2114234097026144643UL) + ((uint64_t)op[4] * 10496868331823263852UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 10496868331823263852UL) + ((uint64_t)op[1] * 10570775247676002692UL) + ((uint64_t)op[2] * 14598551433453741301UL) + ((((uint64_t)op[3] * 4170843000761427489UL) + ((uint64_t)op[4] * 2114234097026144643UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 2114234097026144643UL) + ((uint64_t)op[1] * 10496868331823263852UL) + ((uint64_t)op[2] * 10570775247676002692UL) + ((uint64_t)op[3] * 14598551433453741301UL) + ((uint64_t)op[4] * 5934215071425269149UL);
	tmp_q[4] = ((uint64_t)op[0] * 4170843000761427489UL) + ((uint64_t)op[1] * 2114234097026144643UL) + ((uint64_t)op[2] * 10496868331823263852UL) + ((uint64_t)op[3] * 10570775247676002692UL) + ((uint64_t)op[4] * 14598551433453741301UL);
