...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13279358067829522519UL) + ((((uint64_t)op[1] * 13274244754311024516UL) + ((uint64_t)op[2] * 4584812469225090194UL) + ((uint64_t)op[3] * 1737248872695764413UL) + ((uint64_t)op[4] * 9009244745279465861UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 9009244745279465861UL) + ((uint64_t)op[1] * 13279358067829522519UL) + ((((uint64_t)op[2] * 13274244754311024516UL) + ((uint64_t)op[3] * 4584812469225090194UL) + ((uint64_t)op[4] * 1737248872695764413UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 1737248872695764413UL) + ((uint64_t)op[1] * 9009244745279465861UL) + ((uint64_t)op[2] * 13279358067829522519UL) + ((((uint64_t)op[3] * 13274244754311024516UL) + ((uint64_t)op[4] * 4584812469225090194UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 4584812469225090194UL) + ((uint64_t)op[1] * 1737248872695764413UL) + ((uint64_t)op[2] * 9009244745279465861UL) + ((uint64_t)op[3] * 13279358067829522519UL) + ((uint64_t)op[4] * 11030991550426467732UL);
	tmp_q[4] = ((uint64_t)op[0] * 13274244754311024516UL) + ((uint64_t)op[1] * 4584812469225090194UL) + ((uint64_t)op[2] * 1737248872695764413UL) + ((uint64_t)op[3] * 9009244745279465861UL) + ((uint64_t)op[4] * 13279358067829522519UL);
