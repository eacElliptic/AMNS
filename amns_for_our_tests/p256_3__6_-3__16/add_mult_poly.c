...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 400482793683452116UL) + ((((uint64_t)op[1] * 18083451779074172861UL) + ((uint64_t)op[2] * 376339896896434186UL) + ((uint64_t)op[3] * 7547738250208679868UL) + ((uint64_t)op[4] * 10958077207646776032UL) + ((uint64_t)op[5] * 3892862502125001380UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 3892862502125001380UL) + ((uint64_t)op[1] * 400482793683452116UL) + ((((uint64_t)op[2] * 18083451779074172861UL) + ((uint64_t)op[3] * 376339896896434186UL) + ((uint64_t)op[4] * 7547738250208679868UL) + ((uint64_t)op[5] * 10958077207646776032UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 10958077207646776032UL) + ((uint64_t)op[1] * 3892862502125001380UL) + ((uint64_t)op[2] * 400482793683452116UL) + ((((uint64_t)op[3] * 18083451779074172861UL) + ((uint64_t)op[4] * 376339896896434186UL) + ((uint64_t)op[5] * 7547738250208679868UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 7547738250208679868UL) + ((uint64_t)op[1] * 10958077207646776032UL) + ((uint64_t)op[2] * 3892862502125001380UL) + ((uint64_t)op[3] * 400482793683452116UL) + ((((uint64_t)op[4] * 18083451779074172861UL) + ((uint64_t)op[5] * 376339896896434186UL)) * 18446744073709551613);
	tmp_q[4] = ((uint64_t)op[0] * 376339896896434186UL) + ((uint64_t)op[1] * 7547738250208679868UL) + ((uint64_t)op[2] * 10958077207646776032UL) + ((uint64_t)op[3] * 3892862502125001380UL) + ((uint64_t)op[4] * 400482793683452116UL) + ((uint64_t)op[5] * 1089876883906136265UL);
	tmp_q[5] = ((uint64_t)op[0] * 18083451779074172861UL) + ((uint64_t)op[1] * 376339896896434186UL) + ((uint64_t)op[2] * 7547738250208679868UL) + ((uint64_t)op[3] * 10958077207646776032UL) + ((uint64_t)op[4] * 3892862502125001380UL) + ((uint64_t)op[5] * 400482793683452116UL);
