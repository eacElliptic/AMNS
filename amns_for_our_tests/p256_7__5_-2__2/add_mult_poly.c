...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 8235005651471161903UL) + ((((uint64_t)op[1] * 9844552618811596192UL) + ((uint64_t)op[2] * 1080428859911704776UL) + ((uint64_t)op[3] * 15196391513201044442UL) + ((uint64_t)op[4] * 9904469176338393826UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 9904469176338393826UL) + ((uint64_t)op[1] * 8235005651471161903UL) + ((((uint64_t)op[2] * 9844552618811596192UL) + ((uint64_t)op[3] * 1080428859911704776UL) + ((uint64_t)op[4] * 15196391513201044442UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 15196391513201044442UL) + ((uint64_t)op[1] * 9904469176338393826UL) + ((uint64_t)op[2] * 8235005651471161903UL) + ((((uint64_t)op[3] * 9844552618811596192UL) + ((uint64_t)op[4] * 1080428859911704776UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 1080428859911704776UL) + ((uint64_t)op[1] * 15196391513201044442UL) + ((uint64_t)op[2] * 9904469176338393826UL) + ((uint64_t)op[3] * 8235005651471161903UL) + ((uint64_t)op[4] * 17204382909795910848UL);
	tmp_q[4] = ((uint64_t)op[0] * 9844552618811596192UL) + ((uint64_t)op[1] * 1080428859911704776UL) + ((uint64_t)op[2] * 15196391513201044442UL) + ((uint64_t)op[3] * 9904469176338393826UL) + ((uint64_t)op[4] * 8235005651471161903UL);
