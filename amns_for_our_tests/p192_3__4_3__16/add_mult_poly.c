...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17452808223785974636UL) + ((((uint64_t)op[1] * 15125950455534606000UL) + ((uint64_t)op[2] * 10872905950601895525UL) + ((uint64_t)op[3] * 3168901441469103192UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 3168901441469103192UL) + ((uint64_t)op[1] * 17452808223785974636UL) + ((((uint64_t)op[2] * 15125950455534606000UL) + ((uint64_t)op[3] * 10872905950601895525UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 10872905950601895525UL) + ((uint64_t)op[1] * 3168901441469103192UL) + ((uint64_t)op[2] * 17452808223785974636UL) + ((uint64_t)op[3] * 8484363219184714768UL);
	tmp_q[3] = ((uint64_t)op[0] * 15125950455534606000UL) + ((uint64_t)op[1] * 10872905950601895525UL) + ((uint64_t)op[2] * 3168901441469103192UL) + ((uint64_t)op[3] * 17452808223785974636UL);
