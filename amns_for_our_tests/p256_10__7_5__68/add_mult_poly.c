...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14789674838022521054UL) + ((((uint64_t)op[1] * 16104516398327938680UL) + ((uint64_t)op[2] * 8702694276730258045UL) + ((uint64_t)op[3] * 7152085864099246027UL) + ((uint64_t)op[4] * 1722144059715207438UL) + ((uint64_t)op[5] * 5595590847197166008UL) + ((uint64_t)op[6] * 956957109263926451UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 956957109263926451UL) + ((uint64_t)op[1] * 14789674838022521054UL) + ((((uint64_t)op[2] * 16104516398327938680UL) + ((uint64_t)op[3] * 8702694276730258045UL) + ((uint64_t)op[4] * 7152085864099246027UL) + ((uint64_t)op[5] * 1722144059715207438UL) + ((uint64_t)op[6] * 5595590847197166008UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 5595590847197166008UL) + ((uint64_t)op[1] * 956957109263926451UL) + ((uint64_t)op[2] * 14789674838022521054UL) + ((((uint64_t)op[3] * 16104516398327938680UL) + ((uint64_t)op[4] * 8702694276730258045UL) + ((uint64_t)op[5] * 7152085864099246027UL) + ((uint64_t)op[6] * 1722144059715207438UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 1722144059715207438UL) + ((uint64_t)op[1] * 5595590847197166008UL) + ((uint64_t)op[2] * 956957109263926451UL) + ((uint64_t)op[3] * 14789674838022521054UL) + ((((uint64_t)op[4] * 16104516398327938680UL) + ((uint64_t)op[5] * 8702694276730258045UL) + ((uint64_t)op[6] * 7152085864099246027UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 7152085864099246027UL) + ((uint64_t)op[1] * 1722144059715207438UL) + ((uint64_t)op[2] * 5595590847197166008UL) + ((uint64_t)op[3] * 956957109263926451UL) + ((uint64_t)op[4] * 14789674838022521054UL) + ((((uint64_t)op[5] * 16104516398327938680UL) + ((uint64_t)op[6] * 8702694276730258045UL)) * 5);
	tmp_q[5] = ((uint64_t)op[0] * 8702694276730258045UL) + ((uint64_t)op[1] * 7152085864099246027UL) + ((uint64_t)op[2] * 1722144059715207438UL) + ((uint64_t)op[3] * 5595590847197166008UL) + ((uint64_t)op[4] * 956957109263926451UL) + ((uint64_t)op[5] * 14789674838022521054UL) + ((uint64_t)op[6] * 6735605696801486936UL);
	tmp_q[6] = ((uint64_t)op[0] * 16104516398327938680UL) + ((uint64_t)op[1] * 8702694276730258045UL) + ((uint64_t)op[2] * 7152085864099246027UL) + ((uint64_t)op[3] * 1722144059715207438UL) + ((uint64_t)op[4] * 5595590847197166008UL) + ((uint64_t)op[5] * 956957109263926451UL) + ((uint64_t)op[6] * 14789674838022521054UL);
