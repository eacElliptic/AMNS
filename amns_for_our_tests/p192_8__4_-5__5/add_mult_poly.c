...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6182643620071944580UL) + ((((uint64_t)op[1] * 6990009530491510386UL) + ((uint64_t)op[2] * 10180133008080713771UL) + ((uint64_t)op[3] * 3851488405833242332UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 3851488405833242332UL) + ((uint64_t)op[1] * 6182643620071944580UL) + ((((uint64_t)op[2] * 6990009530491510386UL) + ((uint64_t)op[3] * 10180133008080713771UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 10180133008080713771UL) + ((uint64_t)op[1] * 3851488405833242332UL) + ((uint64_t)op[2] * 6182643620071944580UL) + ((uint64_t)op[3] * 1943440494961551302UL);
	tmp_q[3] = ((uint64_t)op[0] * 6990009530491510386UL) + ((uint64_t)op[1] * 10180133008080713771UL) + ((uint64_t)op[2] * 3851488405833242332UL) + ((uint64_t)op[3] * 6182643620071944580UL);
