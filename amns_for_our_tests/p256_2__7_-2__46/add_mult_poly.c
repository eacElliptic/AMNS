...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 4004608668380506021UL) + ((((uint64_t)op[1] * 17470037176701142165UL) + ((uint64_t)op[2] * 9255199444158421220UL) + ((uint64_t)op[3] * 7762837648205015073UL) + ((uint64_t)op[4] * 8330064425871501239UL) + ((uint64_t)op[5] * 8762077322514291215UL) + ((uint64_t)op[6] * 16764280232001760870UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 16764280232001760870UL) + ((uint64_t)op[1] * 4004608668380506021UL) + ((((uint64_t)op[2] * 17470037176701142165UL) + ((uint64_t)op[3] * 9255199444158421220UL) + ((uint64_t)op[4] * 7762837648205015073UL) + ((uint64_t)op[5] * 8330064425871501239UL) + ((uint64_t)op[6] * 8762077322514291215UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 8762077322514291215UL) + ((uint64_t)op[1] * 16764280232001760870UL) + ((uint64_t)op[2] * 4004608668380506021UL) + ((((uint64_t)op[3] * 17470037176701142165UL) + ((uint64_t)op[4] * 9255199444158421220UL) + ((uint64_t)op[5] * 7762837648205015073UL) + ((uint64_t)op[6] * 8330064425871501239UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 8330064425871501239UL) + ((uint64_t)op[1] * 8762077322514291215UL) + ((uint64_t)op[2] * 16764280232001760870UL) + ((uint64_t)op[3] * 4004608668380506021UL) + ((((uint64_t)op[4] * 17470037176701142165UL) + ((uint64_t)op[5] * 9255199444158421220UL) + ((uint64_t)op[6] * 7762837648205015073UL)) * 18446744073709551614);
	tmp_q[4] = ((uint64_t)op[0] * 7762837648205015073UL) + ((uint64_t)op[1] * 8330064425871501239UL) + ((uint64_t)op[2] * 8762077322514291215UL) + ((uint64_t)op[3] * 16764280232001760870UL) + ((uint64_t)op[4] * 4004608668380506021UL) + ((((uint64_t)op[5] * 17470037176701142165UL) + ((uint64_t)op[6] * 9255199444158421220UL)) * 18446744073709551614);
	tmp_q[5] = ((uint64_t)op[0] * 9255199444158421220UL) + ((uint64_t)op[1] * 7762837648205015073UL) + ((uint64_t)op[2] * 8330064425871501239UL) + ((uint64_t)op[3] * 8762077322514291215UL) + ((uint64_t)op[4] * 16764280232001760870UL) + ((uint64_t)op[5] * 4004608668380506021UL) + ((uint64_t)op[6] * 1953413794016818902UL);
	tmp_q[6] = ((uint64_t)op[0] * 17470037176701142165UL) + ((uint64_t)op[1] * 9255199444158421220UL) + ((uint64_t)op[2] * 7762837648205015073UL) + ((uint64_t)op[3] * 8330064425871501239UL) + ((uint64_t)op[4] * 8762077322514291215UL) + ((uint64_t)op[5] * 16764280232001760870UL) + ((uint64_t)op[6] * 4004608668380506021UL);
