...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 7399373302649539965UL) + ((((uint64_t)op[1] * 8750362454291745138UL) + ((uint64_t)op[2] * 556469831145731517UL) + ((uint64_t)op[3] * 8273128618328176456UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 8273128618328176456UL) + ((uint64_t)op[1] * 7399373302649539965UL) + ((((uint64_t)op[2] * 8750362454291745138UL) + ((uint64_t)op[3] * 556469831145731517UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 556469831145731517UL) + ((uint64_t)op[1] * 8273128618328176456UL) + ((uint64_t)op[2] * 7399373302649539965UL) + ((uint64_t)op[3] * 2838057495378184020UL);
	tmp_q[3] = ((uint64_t)op[0] * 8750362454291745138UL) + ((uint64_t)op[1] * 556469831145731517UL) + ((uint64_t)op[2] * 8273128618328176456UL) + ((uint64_t)op[3] * 7399373302649539965UL);
