...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 6756916771150368586UL) + ((((uint64_t)op[1] * 18008140516569145115UL) + ((uint64_t)op[2] * 1853429344320218400UL) + ((uint64_t)op[3] * 3863300392085240473UL) + ((uint64_t)op[4] * 10532152271113566967UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 10532152271113566967UL) + ((uint64_t)op[1] * 6756916771150368586UL) + ((((uint64_t)op[2] * 18008140516569145115UL) + ((uint64_t)op[3] * 1853429344320218400UL) + ((uint64_t)op[4] * 3863300392085240473UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 3863300392085240473UL) + ((uint64_t)op[1] * 10532152271113566967UL) + ((uint64_t)op[2] * 6756916771150368586UL) + ((((uint64_t)op[3] * 18008140516569145115UL) + ((uint64_t)op[4] * 1853429344320218400UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 1853429344320218400UL) + ((uint64_t)op[1] * 3863300392085240473UL) + ((uint64_t)op[2] * 10532152271113566967UL) + ((uint64_t)op[3] * 6756916771150368586UL) + ((uint64_t)op[4] * 3070224899982845507UL);
	tmp_q[4] = ((uint64_t)op[0] * 18008140516569145115UL) + ((uint64_t)op[1] * 1853429344320218400UL) + ((uint64_t)op[2] * 3863300392085240473UL) + ((uint64_t)op[3] * 10532152271113566967UL) + ((uint64_t)op[4] * 6756916771150368586UL);
