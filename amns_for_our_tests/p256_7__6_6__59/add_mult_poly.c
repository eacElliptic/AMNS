...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12887550317802635751UL) + ((((uint64_t)op[1] * 15801168389286851165UL) + ((uint64_t)op[2] * 9193304728557722979UL) + ((uint64_t)op[3] * 227132465910925275UL) + ((uint64_t)op[4] * 1869716529831958480UL) + ((uint64_t)op[5] * 10114258534547562201UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 10114258534547562201UL) + ((uint64_t)op[1] * 12887550317802635751UL) + ((((uint64_t)op[2] * 15801168389286851165UL) + ((uint64_t)op[3] * 9193304728557722979UL) + ((uint64_t)op[4] * 227132465910925275UL) + ((uint64_t)op[5] * 1869716529831958480UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 1869716529831958480UL) + ((uint64_t)op[1] * 10114258534547562201UL) + ((uint64_t)op[2] * 12887550317802635751UL) + ((((uint64_t)op[3] * 15801168389286851165UL) + ((uint64_t)op[4] * 9193304728557722979UL) + ((uint64_t)op[5] * 227132465910925275UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 227132465910925275UL) + ((uint64_t)op[1] * 1869716529831958480UL) + ((uint64_t)op[2] * 10114258534547562201UL) + ((uint64_t)op[3] * 12887550317802635751UL) + ((((uint64_t)op[4] * 15801168389286851165UL) + ((uint64_t)op[5] * 9193304728557722979UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 9193304728557722979UL) + ((uint64_t)op[1] * 227132465910925275UL) + ((uint64_t)op[2] * 1869716529831958480UL) + ((uint64_t)op[3] * 10114258534547562201UL) + ((uint64_t)op[4] * 12887550317802635751UL) + ((uint64_t)op[5] * 2573289967173348910UL);
	tmp_q[5] = ((uint64_t)op[0] * 15801168389286851165UL) + ((uint64_t)op[1] * 9193304728557722979UL) + ((uint64_t)op[2] * 227132465910925275UL) + ((uint64_t)op[3] * 1869716529831958480UL) + ((uint64_t)op[4] * 10114258534547562201UL) + ((uint64_t)op[5] * 12887550317802635751UL);
