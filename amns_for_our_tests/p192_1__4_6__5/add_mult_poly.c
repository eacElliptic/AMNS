...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13091267069098031831UL) + ((((uint64_t)op[1] * 13009479956951123814UL) + ((uint64_t)op[2] * 15190433451074585641UL) + ((uint64_t)op[3] * 15565834001691479546UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 15565834001691479546UL) + ((uint64_t)op[1] * 13091267069098031831UL) + ((((uint64_t)op[2] * 13009479956951123814UL) + ((uint64_t)op[3] * 15190433451074585641UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 15190433451074585641UL) + ((uint64_t)op[1] * 15565834001691479546UL) + ((uint64_t)op[2] * 13091267069098031831UL) + ((uint64_t)op[3] * 4269903446868536420UL);
	tmp_q[3] = ((uint64_t)op[0] * 13009479956951123814UL) + ((uint64_t)op[1] * 15190433451074585641UL) + ((uint64_t)op[2] * 15565834001691479546UL) + ((uint64_t)op[3] * 13091267069098031831UL);
