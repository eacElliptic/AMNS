...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15429312352470756473UL) + ((((uint64_t)op[1] * 13571914704634587412UL) + ((uint64_t)op[2] * 10953565645552929745UL) + ((uint64_t)op[3] * 13690863825093704465UL) + ((uint64_t)op[4] * 10440917558708850964UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 10440917558708850964UL) + ((uint64_t)op[1] * 15429312352470756473UL) + ((((uint64_t)op[2] * 13571914704634587412UL) + ((uint64_t)op[3] * 10953565645552929745UL) + ((uint64_t)op[4] * 13690863825093704465UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 13690863825093704465UL) + ((uint64_t)op[1] * 10440917558708850964UL) + ((uint64_t)op[2] * 15429312352470756473UL) + ((((uint64_t)op[3] * 13571914704634587412UL) + ((uint64_t)op[4] * 10953565645552929745UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 10953565645552929745UL) + ((uint64_t)op[1] * 13690863825093704465UL) + ((uint64_t)op[2] * 10440917558708850964UL) + ((uint64_t)op[3] * 15429312352470756473UL) + ((uint64_t)op[4] * 2105146805180610400UL);
	tmp_q[4] = ((uint64_t)op[0] * 13571914704634587412UL) + ((uint64_t)op[1] * 10953565645552929745UL) + ((uint64_t)op[2] * 13690863825093704465UL) + ((uint64_t)op[3] * 10440917558708850964UL) + ((uint64_t)op[4] * 15429312352470756473UL);
