...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12835325256630276401UL) + ((((uint64_t)op[1] * 2178275878485539606UL) + ((uint64_t)op[2] * 1824363964429944477UL) + ((uint64_t)op[3] * 13319290999106622943UL) + ((uint64_t)op[4] * 11777954582957269110UL) + ((uint64_t)op[5] * 4409162516987859136UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 4409162516987859136UL) + ((uint64_t)op[1] * 12835325256630276401UL) + ((((uint64_t)op[2] * 2178275878485539606UL) + ((uint64_t)op[3] * 1824363964429944477UL) + ((uint64_t)op[4] * 13319290999106622943UL) + ((uint64_t)op[5] * 11777954582957269110UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 11777954582957269110UL) + ((uint64_t)op[1] * 4409162516987859136UL) + ((uint64_t)op[2] * 12835325256630276401UL) + ((((uint64_t)op[3] * 2178275878485539606UL) + ((uint64_t)op[4] * 1824363964429944477UL) + ((uint64_t)op[5] * 13319290999106622943UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 13319290999106622943UL) + ((uint64_t)op[1] * 11777954582957269110UL) + ((uint64_t)op[2] * 4409162516987859136UL) + ((uint64_t)op[3] * 12835325256630276401UL) + ((((uint64_t)op[4] * 2178275878485539606UL) + ((uint64_t)op[5] * 1824363964429944477UL)) * 2);
	tmp_q[4] = ((uint64_t)op[0] * 1824363964429944477UL) + ((uint64_t)op[1] * 13319290999106622943UL) + ((uint64_t)op[2] * 11777954582957269110UL) + ((uint64_t)op[3] * 4409162516987859136UL) + ((uint64_t)op[4] * 12835325256630276401UL) + ((uint64_t)op[5] * 4356551756971079212UL);
	tmp_q[5] = ((uint64_t)op[0] * 2178275878485539606UL) + ((uint64_t)op[1] * 1824363964429944477UL) + ((uint64_t)op[2] * 13319290999106622943UL) + ((uint64_t)op[3] * 11777954582957269110UL) + ((uint64_t)op[4] * 4409162516987859136UL) + ((uint64_t)op[5] * 12835325256630276401UL);
