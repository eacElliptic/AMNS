...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9097175789421631260UL) + ((uint64_t)op[1] * 15163691219178405610UL) + ((uint64_t)op[2] * 10665478298589194960UL) + ((uint64_t)op[3] * 2653727700720135763UL) + ((uint64_t)op[4] * 17283093195760273600UL) + ((uint64_t)op[5] * 16592940551822490080UL) + ((uint64_t)op[6] * 2330869539346075192UL);
	tmp_q[1] = ((uint64_t)op[0] * 2330869539346075192UL) + ((uint64_t)op[1] * 9097175789421631260UL) + ((uint64_t)op[2] * 15163691219178405610UL) + ((uint64_t)op[3] * 10665478298589194960UL) + ((uint64_t)op[4] * 2653727700720135763UL) + ((uint64_t)op[5] * 17283093195760273600UL) + ((uint64_t)op[6] * 16592940551822490080UL);
	tmp_q[2] = ((uint64_t)op[0] * 16592940551822490080UL) + ((uint64_t)op[1] * 2330869539346075192UL) + ((uint64_t)op[2] * 9097175789421631260UL) + ((uint64_t)op[3] * 15163691219178405610UL) + ((uint64_t)op[4] * 10665478298589194960UL) + ((uint64_t)op[5] * 2653727700720135763UL) + ((uint64_t)op[6] * 17283093195760273600UL);
	tmp_q[3] = ((uint64_t)op[0] * 17283093195760273600UL) + ((uint64_t)op[1] * 16592940551822490080UL) + ((uint64_t)op[2] * 2330869539346075192UL) + ((uint64_t)op[3] * 9097175789421631260UL) + ((uint64_t)op[4] * 15163691219178405610UL) + ((uint64_t)op[5] * 10665478298589194960UL) + ((uint64_t)op[6] * 2653727700720135763UL);
	tmp_q[4] = ((uint64_t)op[0] * 2653727700720135763UL) + ((uint64_t)op[1] * 17283093195760273600UL) + ((uint64_t)op[2] * 16592940551822490080UL) + ((uint64_t)op[3] * 2330869539346075192UL) + ((uint64_t)op[4] * 9097175789421631260UL) + ((uint64_t)op[5] * 15163691219178405610UL) + ((uint64_t)op[6] * 10665478298589194960UL);
	tmp_q[5] = ((uint64_t)op[0] * 10665478298589194960UL) + ((uint64_t)op[1] * 2653727700720135763UL) + ((uint64_t)op[2] * 17283093195760273600UL) + ((uint64_t)op[3] * 16592940551822490080UL) + ((uint64_t)op[4] * 2330869539346075192UL) + ((uint64_t)op[5] * 9097175789421631260UL) + ((uint64_t)op[6] * 15163691219178405610UL);
	tmp_q[6] = ((uint64_t)op[0] * 15163691219178405610UL) + ((uint64_t)op[1] * 10665478298589194960UL) + ((uint64_t)op[2] * 2653727700720135763UL) + ((uint64_t)op[3] * 17283093195760273600UL) + ((uint64_t)op[4] * 16592940551822490080UL) + ((uint64_t)op[5] * 2330869539346075192UL) + ((uint64_t)op[6] * 9097175789421631260UL);
