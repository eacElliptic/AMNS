...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1416592627865738674UL) + ((((uint64_t)op[1] * 11579722785296112707UL) + ((uint64_t)op[2] * 10925725988745179052UL) + ((uint64_t)op[3] * 15873765058505837619UL) + ((uint64_t)op[4] * 2846478071156066215UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 2846478071156066215UL) + ((uint64_t)op[1] * 1416592627865738674UL) + ((((uint64_t)op[2] * 11579722785296112707UL) + ((uint64_t)op[3] * 10925725988745179052UL) + ((uint64_t)op[4] * 15873765058505837619UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 15873765058505837619UL) + ((uint64_t)op[1] * 2846478071156066215UL) + ((uint64_t)op[2] * 1416592627865738674UL) + ((((uint64_t)op[3] * 11579722785296112707UL) + ((uint64_t)op[4] * 10925725988745179052UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 10925725988745179052UL) + ((uint64_t)op[1] * 15873765058505837619UL) + ((uint64_t)op[2] * 2846478071156066215UL) + ((uint64_t)op[3] * 1416592627865738674UL) + ((uint64_t)op[4] * 7271083202234582485UL);
	tmp_q[4] = ((uint64_t)op[0] * 11579722785296112707UL) + ((uint64_t)op[1] * 10925725988745179052UL) + ((uint64_t)op[2] * 15873765058505837619UL) + ((uint64_t)op[3] * 2846478071156066215UL) + ((uint64_t)op[4] * 1416592627865738674UL);
