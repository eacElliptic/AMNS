...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 18256110393538185054UL) + ((((uint64_t)op[1] * 17542299348823240442UL) + ((uint64_t)op[2] * 232097748770364067UL) + ((uint64_t)op[3] * 590771894327583448UL) + ((uint64_t)op[4] * 14182573698899986417UL) + ((uint64_t)op[5] * 4218663228302568947UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 4218663228302568947UL) + ((uint64_t)op[1] * 18256110393538185054UL) + ((((uint64_t)op[2] * 17542299348823240442UL) + ((uint64_t)op[3] * 232097748770364067UL) + ((uint64_t)op[4] * 590771894327583448UL) + ((uint64_t)op[5] * 14182573698899986417UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 14182573698899986417UL) + ((uint64_t)op[1] * 4218663228302568947UL) + ((uint64_t)op[2] * 18256110393538185054UL) + ((((uint64_t)op[3] * 17542299348823240442UL) + ((uint64_t)op[4] * 232097748770364067UL) + ((uint64_t)op[5] * 590771894327583448UL)) * 7);
	tmp_q[3] = ((uint64_t)op[0] * 590771894327583448UL) + ((uint64_t)op[1] * 14182573698899986417UL) + ((uint64_t)op[2] * 4218663228302568947UL) + ((uint64_t)op[3] * 18256110393538185054UL) + ((((uint64_t)op[4] * 17542299348823240442UL) + ((uint64_t)op[5] * 232097748770364067UL)) * 7);
	tmp_q[4] = ((uint64_t)op[0] * 232097748770364067UL) + ((uint64_t)op[1] * 590771894327583448UL) + ((uint64_t)op[2] * 14182573698899986417UL) + ((uint64_t)op[3] * 4218663228302568947UL) + ((uint64_t)op[4] * 18256110393538185054UL) + ((uint64_t)op[5] * 12115630999505373398UL);
	tmp_q[5] = ((uint64_t)op[0] * 17542299348823240442UL) + ((uint64_t)op[1] * 232097748770364067UL) + ((uint64_t)op[2] * 590771894327583448UL) + ((uint64_t)op[3] * 14182573698899986417UL) + ((uint64_t)op[4] * 4218663228302568947UL) + ((uint64_t)op[5] * 18256110393538185054UL);
