...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 207000411646587965UL) + ((((uint64_t)op[1] * 4788883052351719064UL) + ((uint64_t)op[2] * 5877309459636118592UL) + ((uint64_t)op[3] * 15891548897771325670UL) + ((uint64_t)op[4] * 3676128987081672850UL) + ((uint64_t)op[5] * 751512056603050238UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 751512056603050238UL) + ((uint64_t)op[1] * 207000411646587965UL) + ((((uint64_t)op[2] * 4788883052351719064UL) + ((uint64_t)op[3] * 5877309459636118592UL) + ((uint64_t)op[4] * 15891548897771325670UL) + ((uint64_t)op[5] * 3676128987081672850UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 3676128987081672850UL) + ((uint64_t)op[1] * 751512056603050238UL) + ((uint64_t)op[2] * 207000411646587965UL) + ((((uint64_t)op[3] * 4788883052351719064UL) + ((uint64_t)op[4] * 5877309459636118592UL) + ((uint64_t)op[5] * 15891548897771325670UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 15891548897771325670UL) + ((uint64_t)op[1] * 3676128987081672850UL) + ((uint64_t)op[2] * 751512056603050238UL) + ((uint64_t)op[3] * 207000411646587965UL) + ((((uint64_t)op[4] * 4788883052351719064UL) + ((uint64_t)op[5] * 5877309459636118592UL)) * 3);
	tmp_q[4] = ((uint64_t)op[0] * 5877309459636118592UL) + ((uint64_t)op[1] * 15891548897771325670UL) + ((uint64_t)op[2] * 3676128987081672850UL) + ((uint64_t)op[3] * 751512056603050238UL) + ((uint64_t)op[4] * 207000411646587965UL) + ((uint64_t)op[5] * 14366649157055157192UL);
	tmp_q[5] = ((uint64_t)op[0] * 4788883052351719064UL) + ((uint64_t)op[1] * 5877309459636118592UL) + ((uint64_t)op[2] * 15891548897771325670UL) + ((uint64_t)op[3] * 3676128987081672850UL) + ((uint64_t)op[4] * 751512056603050238UL) + ((uint64_t)op[5] * 207000411646587965UL);
