...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11118434160020890875UL) + ((((uint64_t)op[1] * 14370409012785167890UL) + ((uint64_t)op[2] * 11280585496994559162UL) + ((uint64_t)op[3] * 12204392295438114394UL) + ((uint64_t)op[4] * 15231046508282432444UL) + ((uint64_t)op[5] * 12167477915755237047UL) + ((uint64_t)op[6] * 3315797584159701340UL) + ((uint64_t)op[7] * 14947172906696856941UL) + ((uint64_t)op[8] * 4548703377943878928UL) + ((uint64_t)op[9] * 15208459982896985771UL) + ((uint64_t)op[10] * 11354158387663622410UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 11354158387663622410UL) + ((uint64_t)op[1] * 11118434160020890875UL) + ((((uint64_t)op[2] * 14370409012785167890UL) + ((uint64_t)op[3] * 11280585496994559162UL) + ((uint64_t)op[4] * 12204392295438114394UL) + ((uint64_t)op[5] * 15231046508282432444UL) + ((uint64_t)op[6] * 12167477915755237047UL) + ((uint64_t)op[7] * 3315797584159701340UL) + ((uint64_t)op[8] * 14947172906696856941UL) + ((uint64_t)op[9] * 4548703377943878928UL) + ((uint64_t)op[10] * 15208459982896985771UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 15208459982896985771UL) + ((uint64_t)op[1] * 11354158387663622410UL) + ((uint64_t)op[2] * 11118434160020890875UL) + ((((uint64_t)op[3] * 14370409012785167890UL) + ((uint64_t)op[4] * 11280585496994559162UL) + ((uint64_t)op[5] * 12204392295438114394UL) + ((uint64_t)op[6] * 15231046508282432444UL) + ((uint64_t)op[7] * 12167477915755237047UL) + ((uint64_t)op[8] * 3315797584159701340UL) + ((uint64_t)op[9] * 14947172906696856941UL) + ((uint64_t)op[10] * 4548703377943878928UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 4548703377943878928UL) + ((uint64_t)op[1] * 15208459982896985771UL) + ((uint64_t)op[2] * 11354158387663622410UL) + ((uint64_t)op[3] * 11118434160020890875UL) + ((((uint64_t)op[4] * 14370409012785167890UL) + ((uint64_t)op[5] * 11280585496994559162UL) + ((uint64_t)op[6] * 12204392295438114394UL) + ((uint64_t)op[7] * 15231046508282432444UL) + ((uint64_t)op[8] * 12167477915755237047UL) + ((uint64_t)op[9] * 3315797584159701340UL) + ((uint64_t)op[10] * 14947172906696856941UL)) * 6);
	tmp_q[4] = ((uint64_t)op[0] * 14947172906696856941UL) + ((uint64_t)op[1] * 4548703377943878928UL) + ((uint64_t)op[2] * 15208459982896985771UL) + ((uint64_t)op[3] * 11354158387663622410UL) + ((uint64_t)op[4] * 11118434160020890875UL) + ((((uint64_t)op[5] * 14370409012785167890UL) + ((uint64_t)op[6] * 11280585496994559162UL) + ((uint64_t)op[7] * 12204392295438114394UL) + ((uint64_t)op[8] * 15231046508282432444UL) + ((uint64_t)op[9] * 12167477915755237047UL) + ((uint64_t)op[10] * 3315797584159701340UL)) * 6);
	tmp_q[5] = ((uint64_t)op[0] * 3315797584159701340UL) + ((uint64_t)op[1] * 14947172906696856941UL) + ((uint64_t)op[2] * 4548703377943878928UL) + ((uint64_t)op[3] * 15208459982896985771UL) + ((uint64_t)op[4] * 11354158387663622410UL) + ((uint64_t)op[5] * 11118434160020890875UL) + ((((uint64_t)op[6] * 14370409012785167890UL) + ((uint64_t)op[7] * 11280585496994559162UL) + ((uint64_t)op[8] * 12204392295438114394UL) + ((uint64_t)op[9] * 15231046508282432444UL) + ((uint64_t)op[10] * 12167477915755237047UL)) * 6);
	tmp_q[6] = ((uint64_t)op[0] * 12167477915755237047UL) + ((uint64_t)op[1] * 3315797584159701340UL) + ((uint64_t)op[2] * 14947172906696856941UL) + ((uint64_t)op[3] * 4548703377943878928UL) + ((uint64_t)op[4] * 15208459982896985771UL) + ((uint64_t)op[5] * 11354158387663622410UL) + ((uint64_t)op[6] * 11118434160020890875UL) + ((((uint64_t)op[7] * 14370409012785167890UL) + ((uint64_t)op[8] * 11280585496994559162UL) + ((uint64_t)op[9] * 12204392295438114394UL) + ((uint64_t)op[10] * 15231046508282432444UL)) * 6);
	tmp_q[7] = ((uint64_t)op[0] * 15231046508282432444UL) + ((uint64_t)op[1] * 12167477915755237047UL) + ((uint64_t)op[2] * 3315797584159701340UL) + ((uint64_t)op[3] * 14947172906696856941UL) + ((uint64_t)op[4] * 4548703377943878928UL) + ((uint64_t)op[5] * 15208459982896985771UL) + ((uint64_t)op[6] * 11354158387663622410UL) + ((uint64_t)op[7] * 11118434160020890875UL) + ((((uint64_t)op[8] * 14370409012785167890UL) + ((uint64_t)op[9] * 11280585496994559162UL) + ((uint64_t)op[10] * 12204392295438114394UL)) * 6);
	tmp_q[8] = ((uint64_t)op[0] * 12204392295438114394UL) + ((uint64_t)op[1] * 15231046508282432444UL) + ((uint64_t)op[2] * 12167477915755237047UL) + ((uint64_t)op[3] * 3315797584159701340UL) + ((uint64_t)op[4] * 14947172906696856941UL) + ((uint64_t)op[5] * 4548703377943878928UL) + ((uint64_t)op[6] * 15208459982896985771UL) + ((uint64_t)op[7] * 11354158387663622410UL) + ((uint64_t)op[8] * 11118434160020890875UL) + ((((uint64_t)op[9] * 14370409012785167890UL) + ((uint64_t)op[10] * 11280585496994559162UL)) * 6);
	tmp_q[9] = ((uint64_t)op[0] * 11280585496994559162UL) + ((uint64_t)op[1] * 12204392295438114394UL) + ((uint64_t)op[2] * 15231046508282432444UL) + ((uint64_t)op[3] * 12167477915755237047UL) + ((uint64_t)op[4] * 3315797584159701340UL) + ((uint64_t)op[5] * 14947172906696856941UL) + ((uint64_t)op[6] * 4548703377943878928UL) + ((uint64_t)op[7] * 15208459982896985771UL) + ((uint64_t)op[8] * 11354158387663622410UL) + ((uint64_t)op[9] * 11118434160020890875UL) + ((uint64_t)op[10] * 12435477781872800876UL);
	tmp_q[10] = ((uint64_t)op[0] * 14370409012785167890UL) + ((uint64_t)op[1] * 11280585496994559162UL) + ((uint64_t)op[2] * 12204392295438114394UL) + ((uint64_t)op[3] * 15231046508282432444UL) + ((uint64_t)op[4] * 12167477915755237047UL) + ((uint64_t)op[5] * 3315797584159701340UL) + ((uint64_t)op[6] * 14947172906696856941UL) + ((uint64_t)op[7] * 4548703377943878928UL) + ((uint64_t)op[8] * 15208459982896985771UL) + ((uint64_t)op[9] * 11354158387663622410UL) + ((uint64_t)op[10] * 11118434160020890875UL);
