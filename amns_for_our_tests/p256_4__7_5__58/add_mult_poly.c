...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11760458736486977967UL) + ((((uint64_t)op[1] * 5341312216485976680UL) + ((uint64_t)op[2] * 2892743781305468912UL) + ((uint64_t)op[3] * 14195526895692415804UL) + ((uint64_t)op[4] * 3376674554405468996UL) + ((uint64_t)op[5] * 17385515794398512118UL) + ((uint64_t)op[6] * 13119670598373045434UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 13119670598373045434UL) + ((uint64_t)op[1] * 11760458736486977967UL) + ((((uint64_t)op[2] * 5341312216485976680UL) + ((uint64_t)op[3] * 2892743781305468912UL) + ((uint64_t)op[4] * 14195526895692415804UL) + ((uint64_t)op[5] * 3376674554405468996UL) + ((uint64_t)op[6] * 17385515794398512118UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 17385515794398512118UL) + ((uint64_t)op[1] * 13119670598373045434UL) + ((uint64_t)op[2] * 11760458736486977967UL) + ((((uint64_t)op[3] * 5341312216485976680UL) + ((uint64_t)op[4] * 2892743781305468912UL) + ((uint64_t)op[5] * 14195526895692415804UL) + ((uint64_t)op[6] * 3376674554405468996UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 3376674554405468996UL) + ((uint64_t)op[1] * 17385515794398512118UL) + ((uint64_t)op[2] * 13119670598373045434UL) + ((uint64_t)op[3] * 11760458736486977967UL) + ((((uint64_t)op[4] * 5341312216485976680UL) + ((uint64_t)op[5] * 2892743781305468912UL) + ((uint64_t)op[6] * 14195526895692415804UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 14195526895692415804UL) + ((uint64_t)op[1] * 3376674554405468996UL) + ((uint64_t)op[2] * 17385515794398512118UL) + ((uint64_t)op[3] * 13119670598373045434UL) + ((uint64_t)op[4] * 11760458736486977967UL) + ((((uint64_t)op[5] * 5341312216485976680UL) + ((uint64_t)op[6] * 2892743781305468912UL)) * 5);
	tmp_q[5] = ((uint64_t)op[0] * 2892743781305468912UL) + ((uint64_t)op[1] * 14195526895692415804UL) + ((uint64_t)op[2] * 3376674554405468996UL) + ((uint64_t)op[3] * 17385515794398512118UL) + ((uint64_t)op[4] * 13119670598373045434UL) + ((uint64_t)op[5] * 11760458736486977967UL) + ((uint64_t)op[6] * 8259817008720331784UL);
	tmp_q[6] = ((uint64_t)op[0] * 5341312216485976680UL) + ((uint64_t)op[1] * 2892743781305468912UL) + ((uint64_t)op[2] * 14195526895692415804UL) + ((uint64_t)op[3] * 3376674554405468996UL) + ((uint64_t)op[4] * 17385515794398512118UL) + ((uint64_t)op[5] * 13119670598373045434UL) + ((uint64_t)op[6] * 11760458736486977967UL);
