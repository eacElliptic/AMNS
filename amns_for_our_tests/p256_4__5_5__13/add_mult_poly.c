...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 14898916436501893111UL) + ((((uint64_t)op[1] * 8125948056813920041UL) + ((uint64_t)op[2] * 4303665599163437800UL) + ((uint64_t)op[3] * 8195041702497523236UL) + ((uint64_t)op[4] * 1788688970983450585UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 1788688970983450585UL) + ((uint64_t)op[1] * 14898916436501893111UL) + ((((uint64_t)op[2] * 8125948056813920041UL) + ((uint64_t)op[3] * 4303665599163437800UL) + ((uint64_t)op[4] * 8195041702497523236UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 8195041702497523236UL) + ((uint64_t)op[1] * 1788688970983450585UL) + ((uint64_t)op[2] * 14898916436501893111UL) + ((((uint64_t)op[3] * 8125948056813920041UL) + ((uint64_t)op[4] * 4303665599163437800UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 4303665599163437800UL) + ((uint64_t)op[1] * 8195041702497523236UL) + ((uint64_t)op[2] * 1788688970983450585UL) + ((uint64_t)op[3] * 14898916436501893111UL) + ((uint64_t)op[4] * 3736252136650496973UL);
	tmp_q[4] = ((uint64_t)op[0] * 8125948056813920041UL) + ((uint64_t)op[1] * 4303665599163437800UL) + ((uint64_t)op[2] * 8195041702497523236UL) + ((uint64_t)op[3] * 1788688970983450585UL) + ((uint64_t)op[4] * 14898916436501893111UL);
