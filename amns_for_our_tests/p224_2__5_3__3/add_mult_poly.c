...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11497820160928870070UL) + ((((uint64_t)op[1] * 6056848936982990146UL) + ((uint64_t)op[2] * 2649457905012484100UL) + ((uint64_t)op[3] * 12793909848839756840UL) + ((uint64_t)op[4] * 7317066018659409575UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 7317066018659409575UL) + ((uint64_t)op[1] * 11497820160928870070UL) + ((((uint64_t)op[2] * 6056848936982990146UL) + ((uint64_t)op[3] * 2649457905012484100UL) + ((uint64_t)op[4] * 12793909848839756840UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 12793909848839756840UL) + ((uint64_t)op[1] * 7317066018659409575UL) + ((uint64_t)op[2] * 11497820160928870070UL) + ((((uint64_t)op[3] * 6056848936982990146UL) + ((uint64_t)op[4] * 2649457905012484100UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 2649457905012484100UL) + ((uint64_t)op[1] * 12793909848839756840UL) + ((uint64_t)op[2] * 7317066018659409575UL) + ((uint64_t)op[3] * 11497820160928870070UL) + ((uint64_t)op[4] * 18170546810948970438UL);
	tmp_q[4] = ((uint64_t)op[0] * 6056848936982990146UL) + ((uint64_t)op[1] * 2649457905012484100UL) + ((uint64_t)op[2] * 12793909848839756840UL) + ((uint64_t)op[3] * 7317066018659409575UL) + ((uint64_t)op[4] * 11497820160928870070UL);
