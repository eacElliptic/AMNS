...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 4817354972920368763UL) + ((((uint64_t)op[1] * 17186761801696048834UL) + ((uint64_t)op[2] * 2645640152882856394UL) + ((uint64_t)op[3] * 7642965913049164151UL) + ((uint64_t)op[4] * 15108230011247219638UL) + ((uint64_t)op[5] * 3804587530175663041UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 3804587530175663041UL) + ((uint64_t)op[1] * 4817354972920368763UL) + ((((uint64_t)op[2] * 17186761801696048834UL) + ((uint64_t)op[3] * 2645640152882856394UL) + ((uint64_t)op[4] * 7642965913049164151UL) + ((uint64_t)op[5] * 15108230011247219638UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 15108230011247219638UL) + ((uint64_t)op[1] * 3804587530175663041UL) + ((uint64_t)op[2] * 4817354972920368763UL) + ((((uint64_t)op[3] * 17186761801696048834UL) + ((uint64_t)op[4] * 2645640152882856394UL) + ((uint64_t)op[5] * 7642965913049164151UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 7642965913049164151UL) + ((uint64_t)op[1] * 15108230011247219638UL) + ((uint64_t)op[2] * 3804587530175663041UL) + ((uint64_t)op[3] * 4817354972920368763UL) + ((((uint64_t)op[4] * 17186761801696048834UL) + ((uint64_t)op[5] * 2645640152882856394UL)) * 18446744073709551610);
	tmp_q[4] = ((uint64_t)op[0] * 2645640152882856394UL) + ((uint64_t)op[1] * 7642965913049164151UL) + ((uint64_t)op[2] * 15108230011247219638UL) + ((uint64_t)op[3] * 3804587530175663041UL) + ((uint64_t)op[4] * 4817354972920368763UL) + ((uint64_t)op[5] * 7559893632081016692UL);
	tmp_q[5] = ((uint64_t)op[0] * 17186761801696048834UL) + ((uint64_t)op[1] * 2645640152882856394UL) + ((uint64_t)op[2] * 7642965913049164151UL) + ((uint64_t)op[3] * 15108230011247219638UL) + ((uint64_t)op[4] * 3804587530175663041UL) + ((uint64_t)op[5] * 4817354972920368763UL);
