...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2290818616413309808UL) + ((((uint64_t)op[1] * 8336370237140662716UL) + ((uint64_t)op[2] * 9744247013660501434UL) + ((uint64_t)op[3] * 72303295590078989UL) + ((uint64_t)op[4] * 14341044167699503212UL)) * 3);
	tmp_q[1] = ((uint64_t)op[0] * 14341044167699503212UL) + ((uint64_t)op[1] * 2290818616413309808UL) + ((((uint64_t)op[2] * 8336370237140662716UL) + ((uint64_t)op[3] * 9744247013660501434UL) + ((uint64_t)op[4] * 72303295590078989UL)) * 3);
	tmp_q[2] = ((uint64_t)op[0] * 72303295590078989UL) + ((uint64_t)op[1] * 14341044167699503212UL) + ((uint64_t)op[2] * 2290818616413309808UL) + ((((uint64_t)op[3] * 8336370237140662716UL) + ((uint64_t)op[4] * 9744247013660501434UL)) * 3);
	tmp_q[3] = ((uint64_t)op[0] * 9744247013660501434UL) + ((uint64_t)op[1] * 72303295590078989UL) + ((uint64_t)op[2] * 14341044167699503212UL) + ((uint64_t)op[3] * 2290818616413309808UL) + ((uint64_t)op[4] * 6562366637712436532UL);
	tmp_q[4] = ((uint64_t)op[0] * 8336370237140662716UL) + ((uint64_t)op[1] * 9744247013660501434UL) + ((uint64_t)op[2] * 72303295590078989UL) + ((uint64_t)op[3] * 14341044167699503212UL) + ((uint64_t)op[4] * 2290818616413309808UL);
