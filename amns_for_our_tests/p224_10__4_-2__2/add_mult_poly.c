...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16920449449254634713UL) + ((((uint64_t)op[1] * 5179664325710959257UL) + ((uint64_t)op[2] * 13138232808086653565UL) + ((uint64_t)op[3] * 17355416017557548885UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 17355416017557548885UL) + ((uint64_t)op[1] * 16920449449254634713UL) + ((((uint64_t)op[2] * 5179664325710959257UL) + ((uint64_t)op[3] * 13138232808086653565UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 13138232808086653565UL) + ((uint64_t)op[1] * 17355416017557548885UL) + ((uint64_t)op[2] * 16920449449254634713UL) + ((uint64_t)op[3] * 8087415422287633102UL);
	tmp_q[3] = ((uint64_t)op[0] * 5179664325710959257UL) + ((uint64_t)op[1] * 13138232808086653565UL) + ((uint64_t)op[2] * 17355416017557548885UL) + ((uint64_t)op[3] * 16920449449254634713UL);
