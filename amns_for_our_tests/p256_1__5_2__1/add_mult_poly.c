...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 5301032509380282291UL) + ((((uint64_t)op[1] * 3124695337509347320UL) + ((uint64_t)op[2] * 15494556806292442872UL) + ((uint64_t)op[3] * 13958515158544392168UL) + ((uint64_t)op[4] * 12020688878985909955UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 12020688878985909955UL) + ((uint64_t)op[1] * 5301032509380282291UL) + ((((uint64_t)op[2] * 3124695337509347320UL) + ((uint64_t)op[3] * 15494556806292442872UL) + ((uint64_t)op[4] * 13958515158544392168UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 13958515158544392168UL) + ((uint64_t)op[1] * 12020688878985909955UL) + ((uint64_t)op[2] * 5301032509380282291UL) + ((((uint64_t)op[3] * 3124695337509347320UL) + ((uint64_t)op[4] * 15494556806292442872UL)) * 2);
	tmp_q[3] = ((uint64_t)op[0] * 15494556806292442872UL) + ((uint64_t)op[1] * 13958515158544392168UL) + ((uint64_t)op[2] * 12020688878985909955UL) + ((uint64_t)op[3] * 5301032509380282291UL) + ((uint64_t)op[4] * 6249390675018694640UL);
	tmp_q[4] = ((uint64_t)op[0] * 3124695337509347320UL) + ((uint64_t)op[1] * 15494556806292442872UL) + ((uint64_t)op[2] * 13958515158544392168UL) + ((uint64_t)op[3] * 12020688878985909955UL) + ((uint64_t)op[4] * 5301032509380282291UL);
