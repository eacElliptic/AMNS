...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 1091806108157038851UL) + ((((uint64_t)op[1] * 13244924903913436920UL) + ((uint64_t)op[2] * 10610118658184290042UL) + ((uint64_t)op[3] * 11319813189168859160UL) + ((uint64_t)op[4] * 108426929825813072UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 108426929825813072UL) + ((uint64_t)op[1] * 1091806108157038851UL) + ((((uint64_t)op[2] * 13244924903913436920UL) + ((uint64_t)op[3] * 10610118658184290042UL) + ((uint64_t)op[4] * 11319813189168859160UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 11319813189168859160UL) + ((uint64_t)op[1] * 108426929825813072UL) + ((uint64_t)op[2] * 1091806108157038851UL) + ((((uint64_t)op[3] * 13244924903913436920UL) + ((uint64_t)op[4] * 10610118658184290042UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 10610118658184290042UL) + ((uint64_t)op[1] * 11319813189168859160UL) + ((uint64_t)op[2] * 108426929825813072UL) + ((uint64_t)op[3] * 1091806108157038851UL) + ((uint64_t)op[4] * 15605457509388344088UL);
	tmp_q[4] = ((uint64_t)op[0] * 13244924903913436920UL) + ((uint64_t)op[1] * 10610118658184290042UL) + ((uint64_t)op[2] * 11319813189168859160UL) + ((uint64_t)op[3] * 108426929825813072UL) + ((uint64_t)op[4] * 1091806108157038851UL);
