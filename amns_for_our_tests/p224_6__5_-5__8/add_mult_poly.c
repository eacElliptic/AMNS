...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13433522329571912164UL) + ((((uint64_t)op[1] * 17537490936792489UL) + ((uint64_t)op[2] * 12644411276158374577UL) + ((uint64_t)op[3] * 933767410996483208UL) + ((uint64_t)op[4] * 1294729954333581439UL)) * 18446744073709551611);
	tmp_q[1] = ((uint64_t)op[0] * 1294729954333581439UL) + ((uint64_t)op[1] * 13433522329571912164UL) + ((((uint64_t)op[2] * 17537490936792489UL) + ((uint64_t)op[3] * 12644411276158374577UL) + ((uint64_t)op[4] * 933767410996483208UL)) * 18446744073709551611);
	tmp_q[2] = ((uint64_t)op[0] * 933767410996483208UL) + ((uint64_t)op[1] * 1294729954333581439UL) + ((uint64_t)op[2] * 13433522329571912164UL) + ((((uint64_t)op[3] * 17537490936792489UL) + ((uint64_t)op[4] * 12644411276158374577UL)) * 18446744073709551611);
	tmp_q[3] = ((uint64_t)op[0] * 12644411276158374577UL) + ((uint64_t)op[1] * 933767410996483208UL) + ((uint64_t)op[2] * 1294729954333581439UL) + ((uint64_t)op[3] * 13433522329571912164UL) + ((uint64_t)op[4] * 18359056619025589171UL);
	tmp_q[4] = ((uint64_t)op[0] * 17537490936792489UL) + ((uint64_t)op[1] * 12644411276158374577UL) + ((uint64_t)op[2] * 933767410996483208UL) + ((uint64_t)op[3] * 1294729954333581439UL) + ((uint64_t)op[4] * 13433522329571912164UL);
