...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 72580153127500891UL) + ((((uint64_t)op[1] * 8468214800066082966UL) + ((uint64_t)op[2] * 18390807749916286942UL) + ((uint64_t)op[3] * 12115706106394598320UL) + ((uint64_t)op[4] * 15547668736217743001UL) + ((uint64_t)op[5] * 13275765700778003002UL) + ((uint64_t)op[6] * 11233929671896301954UL)) * 18446744073709551610);
	tmp_q[1] = ((uint64_t)op[0] * 11233929671896301954UL) + ((uint64_t)op[1] * 72580153127500891UL) + ((((uint64_t)op[2] * 8468214800066082966UL) + ((uint64_t)op[3] * 18390807749916286942UL) + ((uint64_t)op[4] * 12115706106394598320UL) + ((uint64_t)op[5] * 15547668736217743001UL) + ((uint64_t)op[6] * 13275765700778003002UL)) * 18446744073709551610);
	tmp_q[2] = ((uint64_t)op[0] * 13275765700778003002UL) + ((uint64_t)op[1] * 11233929671896301954UL) + ((uint64_t)op[2] * 72580153127500891UL) + ((((uint64_t)op[3] * 8468214800066082966UL) + ((uint64_t)op[4] * 18390807749916286942UL) + ((uint64_t)op[5] * 12115706106394598320UL) + ((uint64_t)op[6] * 15547668736217743001UL)) * 18446744073709551610);
	tmp_q[3] = ((uint64_t)op[0] * 15547668736217743001UL) + ((uint64_t)op[1] * 13275765700778003002UL) + ((uint64_t)op[2] * 11233929671896301954UL) + ((uint64_t)op[3] * 72580153127500891UL) + ((((uint64_t)op[4] * 8468214800066082966UL) + ((uint64_t)op[5] * 18390807749916286942UL) + ((uint64_t)op[6] * 12115706106394598320UL)) * 18446744073709551610);
	tmp_q[4] = ((uint64_t)op[0] * 12115706106394598320UL) + ((uint64_t)op[1] * 15547668736217743001UL) + ((uint64_t)op[2] * 13275765700778003002UL) + ((uint64_t)op[3] * 11233929671896301954UL) + ((uint64_t)op[4] * 72580153127500891UL) + ((((uint64_t)op[5] * 8468214800066082966UL) + ((uint64_t)op[6] * 18390807749916286942UL)) * 18446744073709551610);
	tmp_q[5] = ((uint64_t)op[0] * 18390807749916286942UL) + ((uint64_t)op[1] * 12115706106394598320UL) + ((uint64_t)op[2] * 15547668736217743001UL) + ((uint64_t)op[3] * 13275765700778003002UL) + ((uint64_t)op[4] * 11233929671896301954UL) + ((uint64_t)op[5] * 72580153127500891UL) + ((uint64_t)op[6] * 4530943420732157052UL);
	tmp_q[6] = ((uint64_t)op[0] * 8468214800066082966UL) + ((uint64_t)op[1] * 18390807749916286942UL) + ((uint64_t)op[2] * 12115706106394598320UL) + ((uint64_t)op[3] * 15547668736217743001UL) + ((uint64_t)op[4] * 13275765700778003002UL) + ((uint64_t)op[5] * 11233929671896301954UL) + ((uint64_t)op[6] * 72580153127500891UL);
