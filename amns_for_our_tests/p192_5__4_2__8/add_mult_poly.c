...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 13751532639969874097UL) + ((((uint64_t)op[1] * 14483565883514797102UL) + ((uint64_t)op[2] * 10049030505224444234UL) + ((uint64_t)op[3] * 5199743646428897087UL)) * 2);
	tmp_q[1] = ((uint64_t)op[0] * 5199743646428897087UL) + ((uint64_t)op[1] * 13751532639969874097UL) + ((((uint64_t)op[2] * 14483565883514797102UL) + ((uint64_t)op[3] * 10049030505224444234UL)) * 2);
	tmp_q[2] = ((uint64_t)op[0] * 10049030505224444234UL) + ((uint64_t)op[1] * 5199743646428897087UL) + ((uint64_t)op[2] * 13751532639969874097UL) + ((uint64_t)op[3] * 10520387693320042588UL);
	tmp_q[3] = ((uint64_t)op[0] * 14483565883514797102UL) + ((uint64_t)op[1] * 10049030505224444234UL) + ((uint64_t)op[2] * 5199743646428897087UL) + ((uint64_t)op[3] * 13751532639969874097UL);
