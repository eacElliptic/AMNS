...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16207264174992600168UL) + ((((uint64_t)op[1] * 8970591127573584764UL) + ((uint64_t)op[2] * 5596918293932470173UL) + ((uint64_t)op[3] * 1819535322181279505UL) + ((uint64_t)op[4] * 3859559848291786738UL) + ((uint64_t)op[5] * 11298008975319909137UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 11298008975319909137UL) + ((uint64_t)op[1] * 16207264174992600168UL) + ((((uint64_t)op[2] * 8970591127573584764UL) + ((uint64_t)op[3] * 5596918293932470173UL) + ((uint64_t)op[4] * 1819535322181279505UL) + ((uint64_t)op[5] * 3859559848291786738UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 3859559848291786738UL) + ((uint64_t)op[1] * 11298008975319909137UL) + ((uint64_t)op[2] * 16207264174992600168UL) + ((((uint64_t)op[3] * 8970591127573584764UL) + ((uint64_t)op[4] * 5596918293932470173UL) + ((uint64_t)op[5] * 1819535322181279505UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 1819535322181279505UL) + ((uint64_t)op[1] * 3859559848291786738UL) + ((uint64_t)op[2] * 11298008975319909137UL) + ((uint64_t)op[3] * 16207264174992600168UL) + ((((uint64_t)op[4] * 8970591127573584764UL) + ((uint64_t)op[5] * 5596918293932470173UL)) * 18446744073709551609);
	tmp_q[4] = ((uint64_t)op[0] * 5596918293932470173UL) + ((uint64_t)op[1] * 1819535322181279505UL) + ((uint64_t)op[2] * 3859559848291786738UL) + ((uint64_t)op[3] * 11298008975319909137UL) + ((uint64_t)op[4] * 16207264174992600168UL) + ((uint64_t)op[5] * 10992838401823113116UL);
	tmp_q[5] = ((uint64_t)op[0] * 8970591127573584764UL) + ((uint64_t)op[1] * 5596918293932470173UL) + ((uint64_t)op[2] * 1819535322181279505UL) + ((uint64_t)op[3] * 3859559848291786738UL) + ((uint64_t)op[4] * 11298008975319909137UL) + ((uint64_t)op[5] * 16207264174992600168UL);
