...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3506504934515119952UL) + ((uint64_t)op[1] * 9293525270395398787UL) + ((uint64_t)op[2] * 12834557248373484595UL) + ((uint64_t)op[3] * 10185096323456504186UL) + ((uint64_t)op[4] * 1073804370678595711UL);
	tmp_q[1] = ((uint64_t)op[0] * 1073804370678595711UL) + ((uint64_t)op[1] * 3506504934515119952UL) + ((uint64_t)op[2] * 9293525270395398787UL) + ((uint64_t)op[3] * 12834557248373484595UL) + ((uint64_t)op[4] * 10185096323456504186UL);
	tmp_q[2] = ((uint64_t)op[0] * 10185096323456504186UL) + ((uint64_t)op[1] * 1073804370678595711UL) + ((uint64_t)op[2] * 3506504934515119952UL) + ((uint64_t)op[3] * 9293525270395398787UL) + ((uint64_t)op[4] * 12834557248373484595UL);
	tmp_q[3] = ((uint64_t)op[0] * 12834557248373484595UL) + ((uint64_t)op[1] * 10185096323456504186UL) + ((uint64_t)op[2] * 1073804370678595711UL) + ((uint64_t)op[3] * 3506504934515119952UL) + ((uint64_t)op[4] * 9293525270395398787UL);
	tmp_q[4] = ((uint64_t)op[0] * 9293525270395398787UL) + ((uint64_t)op[1] * 12834557248373484595UL) + ((uint64_t)op[2] * 10185096323456504186UL) + ((uint64_t)op[3] * 1073804370678595711UL) + ((uint64_t)op[4] * 3506504934515119952UL);
