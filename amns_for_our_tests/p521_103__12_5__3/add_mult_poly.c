...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11807281361146987837UL) + ((((uint64_t)op[1] * 2676797438312873888UL) + ((uint64_t)op[2] * 11806021937643102228UL) + ((uint64_t)op[3] * 5783414787514796464UL) + ((uint64_t)op[4] * 440206687894763904UL) + ((uint64_t)op[5] * 1701716881268621108UL) + ((uint64_t)op[6] * 2731250561113367518UL) + ((uint64_t)op[7] * 13986685001640419798UL) + ((uint64_t)op[8] * 16406034343609594324UL) + ((uint64_t)op[9] * 8315563058276232329UL) + ((uint64_t)op[10] * 15256327758115961151UL) + ((uint64_t)op[11] * 14727398459902332574UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 14727398459902332574UL) + ((uint64_t)op[1] * 11807281361146987837UL) + ((((uint64_t)op[2] * 2676797438312873888UL) + ((uint64_t)op[3] * 11806021937643102228UL) + ((uint64_t)op[4] * 5783414787514796464UL) + ((uint64_t)op[5] * 440206687894763904UL) + ((uint64_t)op[6] * 1701716881268621108UL) + ((uint64_t)op[7] * 2731250561113367518UL) + ((uint64_t)op[8] * 13986685001640419798UL) + ((uint64_t)op[9] * 16406034343609594324UL) + ((uint64_t)op[10] * 8315563058276232329UL) + ((uint64_t)op[11] * 15256327758115961151UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 15256327758115961151UL) + ((uint64_t)op[1] * 14727398459902332574UL) + ((uint64_t)op[2] * 11807281361146987837UL) + ((((uint64_t)op[3] * 2676797438312873888UL) + ((uint64_t)op[4] * 11806021937643102228UL) + ((uint64_t)op[5] * 5783414787514796464UL) + ((uint64_t)op[6] * 440206687894763904UL) + ((uint64_t)op[7] * 1701716881268621108UL) + ((uint64_t)op[8] * 2731250561113367518UL) + ((uint64_t)op[9] * 13986685001640419798UL) + ((uint64_t)op[10] * 16406034343609594324UL) + ((uint64_t)op[11] * 8315563058276232329UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 8315563058276232329UL) + ((uint64_t)op[1] * 15256327758115961151UL) + ((uint64_t)op[2] * 14727398459902332574UL) + ((uint64_t)op[3] * 11807281361146987837UL) + ((((uint64_t)op[4] * 2676797438312873888UL) + ((uint64_t)op[5] * 11806021937643102228UL) + ((uint64_t)op[6] * 5783414787514796464UL) + ((uint64_t)op[7] * 440206687894763904UL) + ((uint64_t)op[8] * 1701716881268621108UL) + ((uint64_t)op[9] * 2731250561113367518UL) + ((uint64_t)op[10] * 13986685001640419798UL) + ((uint64_t)op[11] * 16406034343609594324UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 16406034343609594324UL) + ((uint64_t)op[1] * 8315563058276232329UL) + ((uint64_t)op[2] * 15256327758115961151UL) + ((uint64_t)op[3] * 14727398459902332574UL) + ((uint64_t)op[4] * 11807281361146987837UL) + ((((uint64_t)op[5] * 2676797438312873888UL) + ((uint64_t)op[6] * 11806021937643102228UL) + ((uint64_t)op[7] * 5783414787514796464UL) + ((uint64_t)op[8] * 440206687894763904UL) + ((uint64_t)op[9] * 1701716881268621108UL) + ((uint64_t)op[10] * 2731250561113367518UL) + ((uint64_t)op[11] * 13986685001640419798UL)) * 5);
	tmp_q[5] = ((uint64_t)op[0] * 13986685001640419798UL) + ((uint64_t)op[1] * 16406034343609594324UL) + ((uint64_t)op[2] * 8315563058276232329UL) + ((uint64_t)op[3] * 15256327758115961151UL) + ((uint64_t)op[4] * 14727398459902332574UL) + ((uint64_t)op[5] * 11807281361146987837UL) + ((((uint64_t)op[6] * 2676797438312873888UL) + ((uint64_t)op[7] * 11806021937643102228UL) + ((uint64_t)op[8] * 5783414787514796464UL) + ((uint64_t)op[9] * 440206687894763904UL) + ((uint64_t)op[10] * 1701716881268621108UL) + ((uint64_t)op[11] * 2731250561113367518UL)) * 5);
	tmp_q[6] = ((uint64_t)op[0] * 2731250561113367518UL) + ((uint64_t)op[1] * 13986685001640419798UL) + ((uint64_t)op[2] * 16406034343609594324UL) + ((uint64_t)op[3] * 8315563058276232329UL) + ((uint64_t)op[4] * 15256327758115961151UL) + ((uint64_t)op[5] * 14727398459902332574UL) + ((uint64_t)op[6] * 11807281361146987837UL) + ((((uint64_t)op[7] * 2676797438312873888UL) + ((uint64_t)op[8] * 11806021937643102228UL) + ((uint64_t)op[9] * 5783414787514796464UL) + ((uint64_t)op[10] * 440206687894763904UL) + ((uint64_t)op[11] * 1701716881268621108UL)) * 5);
	tmp_q[7] = ((uint64_t)op[0] * 1701716881268621108UL) + ((uint64_t)op[1] * 2731250561113367518UL) + ((uint64_t)op[2] * 13986685001640419798UL) + ((uint64_t)op[3] * 16406034343609594324UL) + ((uint64_t)op[4] * 8315563058276232329UL) + ((uint64_t)op[5] * 15256327758115961151UL) + ((uint64_t)op[6] * 14727398459902332574UL) + ((uint64_t)op[7] * 11807281361146987837UL) + ((((uint64_t)op[8] * 2676797438312873888UL) + ((uint64_t)op[9] * 11806021937643102228UL) + ((uint64_t)op[10] * 5783414787514796464UL) + ((uint64_t)op[11] * 440206687894763904UL)) * 5);
	tmp_q[8] = ((uint64_t)op[0] * 440206687894763904UL) + ((uint64_t)op[1] * 1701716881268621108UL) + ((uint64_t)op[2] * 2731250561113367518UL) + ((uint64_t)op[3] * 13986685001640419798UL) + ((uint64_t)op[4] * 16406034343609594324UL) + ((uint64_t)op[5] * 8315563058276232329UL) + ((uint64_t)op[6] * 15256327758115961151UL) + ((uint64_t)op[7] * 14727398459902332574UL) + ((uint64_t)op[8] * 11807281361146987837UL) + ((((uint64_t)op[9] * 2676797438312873888UL) + ((uint64_t)op[10] * 11806021937643102228UL) + ((uint64_t)op[11] * 5783414787514796464UL)) * 5);
	tmp_q[9] = ((uint64_t)op[0] * 5783414787514796464UL) + ((uint64_t)op[1] * 440206687894763904UL) + ((uint64_t)op[2] * 1701716881268621108UL) + ((uint64_t)op[3] * 2731250561113367518UL) + ((uint64_t)op[4] * 13986685001640419798UL) + ((uint64_t)op[5] * 16406034343609594324UL) + ((uint64_t)op[6] * 8315563058276232329UL) + ((uint64_t)op[7] * 15256327758115961151UL) + ((uint64_t)op[8] * 14727398459902332574UL) + ((uint64_t)op[9] * 11807281361146987837UL) + ((((uint64_t)op[10] * 2676797438312873888UL) + ((uint64_t)op[11] * 11806021937643102228UL)) * 5);
	tmp_q[10] = ((uint64_t)op[0] * 11806021937643102228UL) + ((uint64_t)op[1] * 5783414787514796464UL) + ((uint64_t)op[2] * 440206687894763904UL) + ((uint64_t)op[3] * 1701716881268621108UL) + ((uint64_t)op[4] * 2731250561113367518UL) + ((uint64_t)op[5] * 13986685001640419798UL) + ((uint64_t)op[6] * 16406034343609594324UL) + ((uint64_t)op[7] * 8315563058276232329UL) + ((uint64_t)op[8] * 15256327758115961151UL) + ((uint64_t)op[9] * 14727398459902332574UL) + ((uint64_t)op[10] * 11807281361146987837UL) + ((uint64_t)op[11] * 13383987191564369440UL);
	tmp_q[11] = ((uint64_t)op[0] * 2676797438312873888UL) + ((uint64_t)op[1] * 11806021937643102228UL) + ((uint64_t)op[2] * 5783414787514796464UL) + ((uint64_t)op[3] * 440206687894763904UL) + ((uint64_t)op[4] * 1701716881268621108UL) + ((uint64_t)op[5] * 2731250561113367518UL) + ((uint64_t)op[6] * 13986685001640419798UL) + ((uint64_t)op[7] * 16406034343609594324UL) + ((uint64_t)op[8] * 8315563058276232329UL) + ((uint64_t)op[9] * 15256327758115961151UL) + ((uint64_t)op[10] * 14727398459902332574UL) + ((uint64_t)op[11] * 11807281361146987837UL);
