...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 12402022910929717547UL) + ((((uint64_t)op[1] * 15194874102279532933UL) + ((uint64_t)op[2] * 8018871238550895597UL) + ((uint64_t)op[3] * 16854429730970342496UL)) * 7);
	tmp_q[1] = ((uint64_t)op[0] * 16854429730970342496UL) + ((uint64_t)op[1] * 12402022910929717547UL) + ((((uint64_t)op[2] * 15194874102279532933UL) + ((uint64_t)op[3] * 8018871238550895597UL)) * 7);
	tmp_q[2] = ((uint64_t)op[0] * 8018871238550895597UL) + ((uint64_t)op[1] * 16854429730970342496UL) + ((uint64_t)op[2] * 12402022910929717547UL) + ((uint64_t)op[3] * 14130398347408972451UL);
	tmp_q[3] = ((uint64_t)op[0] * 15194874102279532933UL) + ((uint64_t)op[1] * 8018871238550895597UL) + ((uint64_t)op[2] * 16854429730970342496UL) + ((uint64_t)op[3] * 12402022910929717547UL);
