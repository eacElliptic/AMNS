...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9361872834377544726UL) + ((((uint64_t)op[1] * 16902754798594903108UL) + ((uint64_t)op[2] * 1770306974485827033UL) + ((uint64_t)op[3] * 1427000141647253323UL) + ((uint64_t)op[4] * 11704915996319895280UL) + ((uint64_t)op[5] * 7390025908651928215UL)) * 5);
	tmp_q[1] = ((uint64_t)op[0] * 7390025908651928215UL) + ((uint64_t)op[1] * 9361872834377544726UL) + ((((uint64_t)op[2] * 16902754798594903108UL) + ((uint64_t)op[3] * 1770306974485827033UL) + ((uint64_t)op[4] * 1427000141647253323UL) + ((uint64_t)op[5] * 11704915996319895280UL)) * 5);
	tmp_q[2] = ((uint64_t)op[0] * 11704915996319895280UL) + ((uint64_t)op[1] * 7390025908651928215UL) + ((uint64_t)op[2] * 9361872834377544726UL) + ((((uint64_t)op[3] * 16902754798594903108UL) + ((uint64_t)op[4] * 1770306974485827033UL) + ((uint64_t)op[5] * 1427000141647253323UL)) * 5);
	tmp_q[3] = ((uint64_t)op[0] * 1427000141647253323UL) + ((uint64_t)op[1] * 11704915996319895280UL) + ((uint64_t)op[2] * 7390025908651928215UL) + ((uint64_t)op[3] * 9361872834377544726UL) + ((((uint64_t)op[4] * 16902754798594903108UL) + ((uint64_t)op[5] * 1770306974485827033UL)) * 5);
	tmp_q[4] = ((uint64_t)op[0] * 1770306974485827033UL) + ((uint64_t)op[1] * 1427000141647253323UL) + ((uint64_t)op[2] * 11704915996319895280UL) + ((uint64_t)op[3] * 7390025908651928215UL) + ((uint64_t)op[4] * 9361872834377544726UL) + ((uint64_t)op[5] * 10726797698136309076UL);
	tmp_q[5] = ((uint64_t)op[0] * 16902754798594903108UL) + ((uint64_t)op[1] * 1770306974485827033UL) + ((uint64_t)op[2] * 1427000141647253323UL) + ((uint64_t)op[3] * 11704915996319895280UL) + ((uint64_t)op[4] * 7390025908651928215UL) + ((uint64_t)op[5] * 9361872834377544726UL);
