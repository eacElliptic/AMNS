...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9949810244425478244UL) + ((((uint64_t)op[1] * 10114157648217867058UL) + ((uint64_t)op[2] * 15501857498647101333UL) + ((uint64_t)op[3] * 4260274055664150792UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 4260274055664150792UL) + ((uint64_t)op[1] * 9949810244425478244UL) + ((((uint64_t)op[2] * 10114157648217867058UL) + ((uint64_t)op[3] * 15501857498647101333UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 15501857498647101333UL) + ((uint64_t)op[1] * 4260274055664150792UL) + ((uint64_t)op[2] * 9949810244425478244UL) + ((uint64_t)op[3] * 2987872757313137058UL);
	tmp_q[3] = ((uint64_t)op[0] * 10114157648217867058UL) + ((uint64_t)op[1] * 15501857498647101333UL) + ((uint64_t)op[2] * 4260274055664150792UL) + ((uint64_t)op[3] * 9949810244425478244UL);
