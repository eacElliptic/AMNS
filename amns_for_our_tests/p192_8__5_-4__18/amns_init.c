...
void init_data(){
	...
	mpz_set_str (modul_p, "5830763282632717895888552762252692932206993941073795083303", 10);

	mpz_set_str (gama_pow[0], "2134072795821229349442442533392509132254364374370130959211", 10);
