...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 15373292468040058611UL) + ((((uint64_t)op[1] * 627233900055171433UL) + ((uint64_t)op[2] * 7492690617753435881UL) + ((uint64_t)op[3] * 10629819008632823672UL) + ((uint64_t)op[4] * 1224708807084529435UL)) * 18446744073709551612);
	tmp_q[1] = ((uint64_t)op[0] * 1224708807084529435UL) + ((uint64_t)op[1] * 15373292468040058611UL) + ((((uint64_t)op[2] * 627233900055171433UL) + ((uint64_t)op[3] * 7492690617753435881UL) + ((uint64_t)op[4] * 10629819008632823672UL)) * 18446744073709551612);
	tmp_q[2] = ((uint64_t)op[0] * 10629819008632823672UL) + ((uint64_t)op[1] * 1224708807084529435UL) + ((uint64_t)op[2] * 15373292468040058611UL) + ((((uint64_t)op[3] * 627233900055171433UL) + ((uint64_t)op[4] * 7492690617753435881UL)) * 18446744073709551612);
	tmp_q[3] = ((uint64_t)op[0] * 7492690617753435881UL) + ((uint64_t)op[1] * 10629819008632823672UL) + ((uint64_t)op[2] * 1224708807084529435UL) + ((uint64_t)op[3] * 15373292468040058611UL) + ((uint64_t)op[4] * 15937808473488865884UL);
	tmp_q[4] = ((uint64_t)op[0] * 627233900055171433UL) + ((uint64_t)op[1] * 7492690617753435881UL) + ((uint64_t)op[2] * 10629819008632823672UL) + ((uint64_t)op[3] * 1224708807084529435UL) + ((uint64_t)op[4] * 15373292468040058611UL);
