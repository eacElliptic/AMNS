...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 16553040569207393595UL) + ((((uint64_t)op[1] * 5795943044003542573UL) + ((uint64_t)op[2] * 13098223049312673206UL) + ((uint64_t)op[3] * 558170535149685429UL) + ((uint64_t)op[4] * 1950109208658697294UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 1950109208658697294UL) + ((uint64_t)op[1] * 16553040569207393595UL) + ((((uint64_t)op[2] * 5795943044003542573UL) + ((uint64_t)op[3] * 13098223049312673206UL) + ((uint64_t)op[4] * 558170535149685429UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 558170535149685429UL) + ((uint64_t)op[1] * 1950109208658697294UL) + ((uint64_t)op[2] * 16553040569207393595UL) + ((((uint64_t)op[3] * 5795943044003542573UL) + ((uint64_t)op[4] * 13098223049312673206UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 13098223049312673206UL) + ((uint64_t)op[1] * 558170535149685429UL) + ((uint64_t)op[2] * 1950109208658697294UL) + ((uint64_t)op[3] * 16553040569207393595UL) + ((uint64_t)op[4] * 6854857985702466470UL);
	tmp_q[4] = ((uint64_t)op[0] * 5795943044003542573UL) + ((uint64_t)op[1] * 13098223049312673206UL) + ((uint64_t)op[2] * 558170535149685429UL) + ((uint64_t)op[3] * 1950109208658697294UL) + ((uint64_t)op[4] * 16553040569207393595UL);
