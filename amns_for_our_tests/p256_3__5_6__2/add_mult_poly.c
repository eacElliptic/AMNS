...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2484407108893508567UL) + ((((uint64_t)op[1] * 8103400089933420426UL) + ((uint64_t)op[2] * 10457335681589293908UL) + ((uint64_t)op[3] * 1934375871653383501UL) + ((uint64_t)op[4] * 991857428662847707UL)) * 6);
	tmp_q[1] = ((uint64_t)op[0] * 991857428662847707UL) + ((uint64_t)op[1] * 2484407108893508567UL) + ((((uint64_t)op[2] * 8103400089933420426UL) + ((uint64_t)op[3] * 10457335681589293908UL) + ((uint64_t)op[4] * 1934375871653383501UL)) * 6);
	tmp_q[2] = ((uint64_t)op[0] * 1934375871653383501UL) + ((uint64_t)op[1] * 991857428662847707UL) + ((uint64_t)op[2] * 2484407108893508567UL) + ((((uint64_t)op[3] * 8103400089933420426UL) + ((uint64_t)op[4] * 10457335681589293908UL)) * 6);
	tmp_q[3] = ((uint64_t)op[0] * 10457335681589293908UL) + ((uint64_t)op[1] * 1934375871653383501UL) + ((uint64_t)op[2] * 991857428662847707UL) + ((uint64_t)op[3] * 2484407108893508567UL) + ((uint64_t)op[4] * 11726912392181419324UL);
	tmp_q[4] = ((uint64_t)op[0] * 8103400089933420426UL) + ((uint64_t)op[1] * 10457335681589293908UL) + ((uint64_t)op[2] * 1934375871653383501UL) + ((uint64_t)op[3] * 991857428662847707UL) + ((uint64_t)op[4] * 2484407108893508567UL);
