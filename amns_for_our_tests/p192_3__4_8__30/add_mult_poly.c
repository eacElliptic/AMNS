...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 9416337760774105379UL) + ((((uint64_t)op[1] * 14436572743639931627UL) + ((uint64_t)op[2] * 4073334954253034391UL) + ((uint64_t)op[3] * 12698522631654315041UL)) * 8);
	tmp_q[1] = ((uint64_t)op[0] * 12698522631654315041UL) + ((uint64_t)op[1] * 9416337760774105379UL) + ((((uint64_t)op[2] * 14436572743639931627UL) + ((uint64_t)op[3] * 4073334954253034391UL)) * 8);
	tmp_q[2] = ((uint64_t)op[0] * 4073334954253034391UL) + ((uint64_t)op[1] * 12698522631654315041UL) + ((uint64_t)op[2] * 9416337760774105379UL) + ((uint64_t)op[3] * 4812117506862143320UL);
	tmp_q[3] = ((uint64_t)op[0] * 14436572743639931627UL) + ((uint64_t)op[1] * 4073334954253034391UL) + ((uint64_t)op[2] * 12698522631654315041UL) + ((uint64_t)op[3] * 9416337760774105379UL);
