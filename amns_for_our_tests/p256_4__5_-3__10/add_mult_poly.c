...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10190829090422375078UL) + ((((uint64_t)op[1] * 2293705044633696915UL) + ((uint64_t)op[2] * 3577380165238963717UL) + ((uint64_t)op[3] * 4951115511880698635UL) + ((uint64_t)op[4] * 10935977291661429982UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 10935977291661429982UL) + ((uint64_t)op[1] * 10190829090422375078UL) + ((((uint64_t)op[2] * 2293705044633696915UL) + ((uint64_t)op[3] * 3577380165238963717UL) + ((uint64_t)op[4] * 4951115511880698635UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 4951115511880698635UL) + ((uint64_t)op[1] * 10935977291661429982UL) + ((uint64_t)op[2] * 10190829090422375078UL) + ((((uint64_t)op[3] * 2293705044633696915UL) + ((uint64_t)op[4] * 3577380165238963717UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 3577380165238963717UL) + ((uint64_t)op[1] * 4951115511880698635UL) + ((uint64_t)op[2] * 10935977291661429982UL) + ((uint64_t)op[3] * 10190829090422375078UL) + ((uint64_t)op[4] * 11565628939808460871UL);
	tmp_q[4] = ((uint64_t)op[0] * 2293705044633696915UL) + ((uint64_t)op[1] * 3577380165238963717UL) + ((uint64_t)op[2] * 4951115511880698635UL) + ((uint64_t)op[3] * 10935977291661429982UL) + ((uint64_t)op[4] * 10190829090422375078UL);
