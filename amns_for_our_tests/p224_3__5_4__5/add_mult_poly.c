...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 10898085242227518497UL) + ((((uint64_t)op[1] * 11062151261059581842UL) + ((uint64_t)op[2] * 15323491107099124023UL) + ((uint64_t)op[3] * 17541879177574229834UL) + ((uint64_t)op[4] * 10751242838372843300UL)) * 4);
	tmp_q[1] = ((uint64_t)op[0] * 10751242838372843300UL) + ((uint64_t)op[1] * 10898085242227518497UL) + ((((uint64_t)op[2] * 11062151261059581842UL) + ((uint64_t)op[3] * 15323491107099124023UL) + ((uint64_t)op[4] * 17541879177574229834UL)) * 4);
	tmp_q[2] = ((uint64_t)op[0] * 17541879177574229834UL) + ((uint64_t)op[1] * 10751242838372843300UL) + ((uint64_t)op[2] * 10898085242227518497UL) + ((((uint64_t)op[3] * 11062151261059581842UL) + ((uint64_t)op[4] * 15323491107099124023UL)) * 4);
	tmp_q[3] = ((uint64_t)op[0] * 15323491107099124023UL) + ((uint64_t)op[1] * 17541879177574229834UL) + ((uint64_t)op[2] * 10751242838372843300UL) + ((uint64_t)op[3] * 10898085242227518497UL) + ((uint64_t)op[4] * 7355116896819224136UL);
	tmp_q[4] = ((uint64_t)op[0] * 11062151261059581842UL) + ((uint64_t)op[1] * 15323491107099124023UL) + ((uint64_t)op[2] * 17541879177574229834UL) + ((uint64_t)op[3] * 10751242838372843300UL) + ((uint64_t)op[4] * 10898085242227518497UL);
