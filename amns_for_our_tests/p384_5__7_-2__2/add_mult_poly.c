...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 2765297424945027721UL) + ((((uint64_t)op[1] * 3555067122660423139UL) + ((uint64_t)op[2] * 8337277765710340678UL) + ((uint64_t)op[3] * 2188661220420879889UL) + ((uint64_t)op[4] * 14045059529008350204UL) + ((uint64_t)op[5] * 1725218981391103106UL) + ((uint64_t)op[6] * 14282291802074388305UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 14282291802074388305UL) + ((uint64_t)op[1] * 2765297424945027721UL) + ((((uint64_t)op[2] * 3555067122660423139UL) + ((uint64_t)op[3] * 8337277765710340678UL) + ((uint64_t)op[4] * 2188661220420879889UL) + ((uint64_t)op[5] * 14045059529008350204UL) + ((uint64_t)op[6] * 1725218981391103106UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 1725218981391103106UL) + ((uint64_t)op[1] * 14282291802074388305UL) + ((uint64_t)op[2] * 2765297424945027721UL) + ((((uint64_t)op[3] * 3555067122660423139UL) + ((uint64_t)op[4] * 8337277765710340678UL) + ((uint64_t)op[5] * 2188661220420879889UL) + ((uint64_t)op[6] * 14045059529008350204UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 14045059529008350204UL) + ((uint64_t)op[1] * 1725218981391103106UL) + ((uint64_t)op[2] * 14282291802074388305UL) + ((uint64_t)op[3] * 2765297424945027721UL) + ((((uint64_t)op[4] * 3555067122660423139UL) + ((uint64_t)op[5] * 8337277765710340678UL) + ((uint64_t)op[6] * 2188661220420879889UL)) * 18446744073709551614);
	tmp_q[4] = ((uint64_t)op[0] * 2188661220420879889UL) + ((uint64_t)op[1] * 14045059529008350204UL) + ((uint64_t)op[2] * 1725218981391103106UL) + ((uint64_t)op[3] * 14282291802074388305UL) + ((uint64_t)op[4] * 2765297424945027721UL) + ((((uint64_t)op[5] * 3555067122660423139UL) + ((uint64_t)op[6] * 8337277765710340678UL)) * 18446744073709551614);
	tmp_q[5] = ((uint64_t)op[0] * 8337277765710340678UL) + ((uint64_t)op[1] * 2188661220420879889UL) + ((uint64_t)op[2] * 14045059529008350204UL) + ((uint64_t)op[3] * 1725218981391103106UL) + ((uint64_t)op[4] * 14282291802074388305UL) + ((uint64_t)op[5] * 2765297424945027721UL) + ((uint64_t)op[6] * 11336609828388705338UL);
	tmp_q[6] = ((uint64_t)op[0] * 3555067122660423139UL) + ((uint64_t)op[1] * 8337277765710340678UL) + ((uint64_t)op[2] * 2188661220420879889UL) + ((uint64_t)op[3] * 14045059529008350204UL) + ((uint64_t)op[4] * 1725218981391103106UL) + ((uint64_t)op[5] * 14282291802074388305UL) + ((uint64_t)op[6] * 2765297424945027721UL);
