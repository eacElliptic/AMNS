...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 11702401554406811708UL) + ((((uint64_t)op[1] * 1118751384132657635UL) + ((uint64_t)op[2] * 8883501879418707700UL) + ((uint64_t)op[3] * 7264437317426734720UL) + ((uint64_t)op[4] * 11225405670929739780UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 11225405670929739780UL) + ((uint64_t)op[1] * 11702401554406811708UL) + ((((uint64_t)op[2] * 1118751384132657635UL) + ((uint64_t)op[3] * 8883501879418707700UL) + ((uint64_t)op[4] * 7264437317426734720UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 7264437317426734720UL) + ((uint64_t)op[1] * 11225405670929739780UL) + ((uint64_t)op[2] * 11702401554406811708UL) + ((((uint64_t)op[3] * 1118751384132657635UL) + ((uint64_t)op[4] * 8883501879418707700UL)) * 18446744073709551613);
	tmp_q[3] = ((uint64_t)op[0] * 8883501879418707700UL) + ((uint64_t)op[1] * 7264437317426734720UL) + ((uint64_t)op[2] * 11225405670929739780UL) + ((uint64_t)op[3] * 11702401554406811708UL) + ((uint64_t)op[4] * 15090489921311578711UL);
	tmp_q[4] = ((uint64_t)op[0] * 1118751384132657635UL) + ((uint64_t)op[1] * 8883501879418707700UL) + ((uint64_t)op[2] * 7264437317426734720UL) + ((uint64_t)op[3] * 11225405670929739780UL) + ((uint64_t)op[4] * 11702401554406811708UL);
