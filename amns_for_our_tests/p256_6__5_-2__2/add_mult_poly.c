...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 81582114544656335UL) + ((((uint64_t)op[1] * 12509319367620255923UL) + ((uint64_t)op[2] * 3316288636390050499UL) + ((uint64_t)op[3] * 7596186924194773562UL) + ((uint64_t)op[4] * 2625784154556275910UL)) * 18446744073709551614);
	tmp_q[1] = ((uint64_t)op[0] * 2625784154556275910UL) + ((uint64_t)op[1] * 81582114544656335UL) + ((((uint64_t)op[2] * 12509319367620255923UL) + ((uint64_t)op[3] * 3316288636390050499UL) + ((uint64_t)op[4] * 7596186924194773562UL)) * 18446744073709551614);
	tmp_q[2] = ((uint64_t)op[0] * 7596186924194773562UL) + ((uint64_t)op[1] * 2625784154556275910UL) + ((uint64_t)op[2] * 81582114544656335UL) + ((((uint64_t)op[3] * 12509319367620255923UL) + ((uint64_t)op[4] * 3316288636390050499UL)) * 18446744073709551614);
	tmp_q[3] = ((uint64_t)op[0] * 3316288636390050499UL) + ((uint64_t)op[1] * 7596186924194773562UL) + ((uint64_t)op[2] * 2625784154556275910UL) + ((uint64_t)op[3] * 81582114544656335UL) + ((uint64_t)op[4] * 11874849412178591386UL);
	tmp_q[4] = ((uint64_t)op[0] * 12509319367620255923UL) + ((uint64_t)op[1] * 3316288636390050499UL) + ((uint64_t)op[2] * 7596186924194773562UL) + ((uint64_t)op[3] * 2625784154556275910UL) + ((uint64_t)op[4] * 81582114544656335UL);
