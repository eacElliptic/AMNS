...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 18313103972657734961UL) + ((((uint64_t)op[1] * 12224908551704187103UL) + ((uint64_t)op[2] * 9406911395556286206UL) + ((uint64_t)op[3] * 11009378302419516115UL) + ((uint64_t)op[4] * 850502513279531558UL)) * 18446744073709551608);
	tmp_q[1] = ((uint64_t)op[0] * 850502513279531558UL) + ((uint64_t)op[1] * 18313103972657734961UL) + ((((uint64_t)op[2] * 12224908551704187103UL) + ((uint64_t)op[3] * 9406911395556286206UL) + ((uint64_t)op[4] * 11009378302419516115UL)) * 18446744073709551608);
	tmp_q[2] = ((uint64_t)op[0] * 11009378302419516115UL) + ((uint64_t)op[1] * 850502513279531558UL) + ((uint64_t)op[2] * 18313103972657734961UL) + ((((uint64_t)op[3] * 12224908551704187103UL) + ((uint64_t)op[4] * 9406911395556286206UL)) * 18446744073709551608);
	tmp_q[3] = ((uint64_t)op[0] * 9406911395556286206UL) + ((uint64_t)op[1] * 11009378302419516115UL) + ((uint64_t)op[2] * 850502513279531558UL) + ((uint64_t)op[3] * 18313103972657734961UL) + ((uint64_t)op[4] * 12881196028623812872UL);
	tmp_q[4] = ((uint64_t)op[0] * 12224908551704187103UL) + ((uint64_t)op[1] * 9406911395556286206UL) + ((uint64_t)op[2] * 11009378302419516115UL) + ((uint64_t)op[3] * 850502513279531558UL) + ((uint64_t)op[4] * 18313103972657734961UL);
