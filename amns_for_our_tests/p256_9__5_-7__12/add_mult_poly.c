...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 3250316095878753096UL) + ((((uint64_t)op[1] * 1244435394343568794UL) + ((uint64_t)op[2] * 9742490301912749052UL) + ((uint64_t)op[3] * 14982899716184299404UL) + ((uint64_t)op[4] * 4361407083183464983UL)) * 18446744073709551609);
	tmp_q[1] = ((uint64_t)op[0] * 4361407083183464983UL) + ((uint64_t)op[1] * 3250316095878753096UL) + ((((uint64_t)op[2] * 1244435394343568794UL) + ((uint64_t)op[3] * 9742490301912749052UL) + ((uint64_t)op[4] * 14982899716184299404UL)) * 18446744073709551609);
	tmp_q[2] = ((uint64_t)op[0] * 14982899716184299404UL) + ((uint64_t)op[1] * 4361407083183464983UL) + ((uint64_t)op[2] * 3250316095878753096UL) + ((((uint64_t)op[3] * 1244435394343568794UL) + ((uint64_t)op[4] * 9742490301912749052UL)) * 18446744073709551609);
	tmp_q[3] = ((uint64_t)op[0] * 9742490301912749052UL) + ((uint64_t)op[1] * 14982899716184299404UL) + ((uint64_t)op[2] * 4361407083183464983UL) + ((uint64_t)op[3] * 3250316095878753096UL) + ((uint64_t)op[4] * 9735696313304570058UL);
	tmp_q[4] = ((uint64_t)op[0] * 1244435394343568794UL) + ((uint64_t)op[1] * 9742490301912749052UL) + ((uint64_t)op[2] * 14982899716184299404UL) + ((uint64_t)op[3] * 4361407083183464983UL) + ((uint64_t)op[4] * 3250316095878753096UL);
