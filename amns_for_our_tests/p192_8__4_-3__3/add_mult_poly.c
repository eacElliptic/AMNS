...
void internal_reduction(int64_t *rop, int128 *op){
	...
	tmp_q[0] = ((uint64_t)op[0] * 17540045803519390407UL) + ((((uint64_t)op[1] * 12272592729443385593UL) + ((uint64_t)op[2] * 14693380158962934595UL) + ((uint64_t)op[3] * 17273717374092367578UL)) * 18446744073709551613);
	tmp_q[1] = ((uint64_t)op[0] * 17273717374092367578UL) + ((uint64_t)op[1] * 17540045803519390407UL) + ((((uint64_t)op[2] * 12272592729443385593UL) + ((uint64_t)op[3] * 14693380158962934595UL)) * 18446744073709551613);
	tmp_q[2] = ((uint64_t)op[0] * 14693380158962934595UL) + ((uint64_t)op[1] * 17273717374092367578UL) + ((uint64_t)op[2] * 17540045803519390407UL) + ((uint64_t)op[3] * 75709959088946453UL);
	tmp_q[3] = ((uint64_t)op[0] * 12272592729443385593UL) + ((uint64_t)op[1] * 14693380158962934595UL) + ((uint64_t)op[2] * 17273717374092367578UL) + ((uint64_t)op[3] * 17540045803519390407UL);
